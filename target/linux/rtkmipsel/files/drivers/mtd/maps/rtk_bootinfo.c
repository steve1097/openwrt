...
  void rtk_read_bootinfo_from_flash(unsigned int bootinfo_addr,
...
 void rtk_write_bootinfo_to_flash(unsigned int bootinfo_addr,
				    BOOTINFO_P bootinfo_ram_p,
				    void (*write_func) (unsigned int,
							 unsigned int,
							 unsigned char *)) 
{
