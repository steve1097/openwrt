...
static device_type_t nand_device[] = {
	{"MT29F2G08AAD", MT29F2G08AAD, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0x50, 0x00, 0x00, 0x00},
	{"MT29F2G08ABAE", MT29F2G08ABAE, 0x10000000, 0x10000000, 2048,
	 64 * 2048, 64, 1, 0, 0x03, 0x00, 0x00, 0x00},
	{"MT29F1G08ABADAWP", MT29F1G08ABADAWP, 0x8000000, 0x8000000, 2048,
	 64 * 2048, 64, 1, 0, 0x00, 0x00, 0x00, 0x00},
	{"NAND01GW3B2B", NAND01GW3B2B, 0x8000000, 0x8000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"NAND01GW3B2C", NAND01GW3B2C, 0x8000000, 0x8000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"NAND02GW3B2D", NAND02GW3B2D, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0x44, 0x00, 0x00, 0x00},
	{"NAND04GW3B2B", NAND04GW3B2B, 0x20000000, 0x20000000, 2048, 64 * 2048,
	 64, 1, 0, 0x20, 0x00, 0x00, 0x00},
	{"NAND04GW3B2D", NAND04GW3B2D, 0x20000000, 0x20000000, 2048, 64 * 2048,
	 64, 1, 0, 0x54, 0x00, 0x00, 0x00},
	{"NAND04GW3C2B", NAND04GW3C2B, 0x20000000, 0x20000000, 2048, 128 * 2048,
	 64, 1, 1, 0x24, 0x00, 0x00, 0x00},
	{"NAND08GW3C2B", NAND08GW3C2B, 0x40000000, 0x40000000, 2048, 128 * 2048,
	 64, 1, 1, 0x34, 0x00, 0x00, 0x00},
	{"HY27UF081G2A", HY27UF081G2A, 0x8000000, 0x8000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"HY27UF082G2A", HY27UF082G2A, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0x00, 0x00, 0x00, 0x00},
	{"HY27UF082G2B", HY27UF082G2B, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0x44, 0x00, 0x00, 0x00},
	{"HY27UF084G2B", HY27UF084G2B, 0x20000000, 0x20000000, 2048, 64 * 2048,
	 64, 1, 0, 0x54, 0x00, 0x00, 0x00},
	{"HY27UT084G2A", HY27UT084G2A, 0x20000000, 0x20000000, 2048, 128 * 2048,
	 64, 1, 1, 0x24, 0x00, 0x00, 0x00},
	{"H27U4G8T2B", H27U4G8T2B, 0x20000000, 0x20000000, 2048, 128 * 2048, 64,
	 1, 1, 0x24, 0x00, 0x00, 0x00},
	{"HY27UT088G2A", HY27UT088G2A, 0x40000000, 0x40000000, 2048, 128 * 2048,
	 64, 1, 1, 0x34, 0x00, 0x00, 0x00},
	{"HY27UF084G2M", HY27UF084G2M, 0x20000000, 0x20000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"HY27UT084G2M", HY27UT084G2M, 0x20000000, 0x20000000, 2048, 128 * 2048,
	 64, 1, 1, 0xff, 0x04, 0x04, 0x04},
	{"HY27UG088G5M", HY27UG088G5M, 0x40000000, 0x20000000, 2048, 64 * 2048,
	 64, 2, 0, 0xff, 0x00, 0x00, 0x00},
	{"HY27UG088G5B", HY27UG088G5B, 0x40000000, 0x20000000, 2048, 64 * 2048,
	 64, 2, 0, 0x54, 0x00, 0x00, 0x00},
	{"H27U8G8T2B", H27U8G8T2B, 0x40000000, 0x40000000, 4096, 128 * 4096,
	 128, 1, 1, 0x34, 0x00, 0x00, 0x00},
	{"H27UAG8T2A", H27UAG8T2A, 0x80000000, 0x80000000, 4096, 128 * 4096,
	 224, 1, 1, 0x44, 0x00, 0x00, 0x00},
	{"H27U2G8F2C", H27U2G8F2C, 0x10000000, 0x10000000, 2048, 64 * 2048, 64,
	 1, 1, 0x44, 0x00, 0x00, 0x00},
	{"K9F1G08U0B", K9F1G08U0B, 0x8000000, 0x8000000, 2048, 64 * 2048, 64, 1,
	 0, 0x40, 0x00, 0x00, 0x00},
	{"K9F2G08U0B", K9F2G08U0B, 0x10000000, 0x10000000, 2048, 64 * 2048, 64,
	 1, 0, 0x44, 0x00, 0x00, 0x00},
	{"K9G4G08U0A", K9G4G08U0A, 0x20000000, 0x20000000, 2048, 128 * 2048, 64,
	 1, 1, 0x54, 0x00, 0x00, 0x00},
	{"K9G4G08U0B", K9G4G08U0B, 0x20000000, 0x20000000, 2048, 128 * 2048, 64,
	 1, 1, 0x54, 0x00, 0x00, 0x00},
	{"K9F4G08U0B", K9F4G08U0B, 0x20000000, 0x20000000, 2048, 64 * 2048, 64,
	 1, 0, 0x54, 0x00, 0x00, 0x00},
	{"K9G8G08U0A", K9G8G08U0A, 0x40000000, 0x40000000, 2048, 128 * 2048, 64,
	 1, 1, 0x64, 0x00, 0x00, 0x00},
	{"K9G8G08U0M", K9G8G08U0M, 0x40000000, 0x40000000, 2048, 128 * 2048, 64,
	 1, 1, 0x64, 0x00, 0x00, 0x00},
	{"K9K8G08U0A", K9K8G08U0A, 0x40000000, 0x40000000, 2048, 64 * 2048, 64,
	 1, 0, 0x58, 0x00, 0x00, 0x00},
	{"K9F8G08U0M", K9F8G08U0M, 0x40000000, 0x40000000, 4096, 64 * 4096, 128,
	 1, 0, 0x64, 0x00, 0x00, 0x00},
	{"TC58NVG0S3C", TC58NVG0S3C, 0x8000000, 0x8000000, 2048, 64 * 2048, 64,
	 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"TC58NVG0S3E", TC58NVG0S3E, 0x8000000, 0x8000000, 2048, 64 * 2048, 64,
	 1, 0, 0x76, 0x00, 0x00, 0x00},
	{"TC58NVG1S3C", TC58NVG1S3C, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"TC58NVG1S3E", TC58NVG1S3E, 0x10000000, 0x10000000, 2048, 64 * 2048,
	 64, 1, 0, 0x76, 0x00, 0x00, 0x00},
	{"TC58NVG2S3E", TC58NVG2S3E, 0x20000000, 0x20000000, 2048, 64 * 2048,
	 64, 1, 0, 0x76, 0x00, 0x00, 0x00},
/*ccwei*/
	{"K9F1G08U0D", K9F1G08U0D, 0x8000000, 0x8000000, 2048, 64 * 2048, 64, 1,
	 0, 0x40, 0x00, 0x00, 0x00},
	{"MX30LF1G08AM", MX30LF1G08AM, 0x8000000, 0x8000000, 2048, 64 * 2048,
	 64, 1, 0, 0xff, 0x00, 0x00, 0x00},
	{"NAND256W3A", NAND256W3A, 0x2000000, 0x2000000, 512, 32 * 512, 16, 1,
	 0, 0xff, 0x00, 0x00, 0x00},
/*debug cl seems need change*/
	{"S34ML01G200TFI000", S34ML01G200TFI000, 0x8000000,
	 ((2048) * 64 * 1024), 2048, 64 * 2048, 64, 1, 0, 0x0, 0x00, 0x00,
	 0x00},
/*end-ccwei*/
/*winfred_wang*/
	{"F59L1G81A", F59L1G81A, 0x8000000, 0x8000000, 2048, 64 * 2048, 64, 1,
	 0, 0xff, 0x00, 0x00, 0x00},
	/* 256M 2048+128 */
	{"S34ML02G200TI00", S34ML02G200TFI00, 0x10000000, ((2048) * 64 * 2048),
	 2048, 64 * 2048, 64, 1, 0, 0x44, 0x00, 0x00, 0x00},
	{NULL,}
};
...
static int nand_read_oob(struct mtd_info *mtd, loff_t from, size_t len,
			 size_t * retlen, u_char * oob_buf);
#else
static int nand_read_oob_ext(struct mtd_info *mtd, loff_t from,
			     struct mtd_oob_ops *ops);
#endif
...
static int nand_read_oob(struct mtd_info *mtd, loff_t from, size_t len, size_t * retlen, u_char * oob_buf)	//czyao moves it
static int nand_write_oob(struct mtd_info *mtd, loff_t to, size_t len, size_t * retlen, const u_char * oob_buf)	//czyao moves it
static int nand_read(struct mtd_info *mtd, loff_t from, size_t len, size_t * retlen, u_char * buf)	//czyao moves it
static int nand_read_ecc(struct mtd_info *mtd, loff_t from, size_t len, size_t * retlen, u_char * buf, u_char * oob_buf, struct nand_oobinfo *oobsel)	//czyao moves it
static int nand_write(struct mtd_info *mtd, loff_t to, size_t len, size_t * retlen, const u_char * buf)	//czyao moves it
static int nand_write_ecc(struct mtd_info *mtd, loff_t to, size_t len, size_t * retlen, const u_char * buf, const u_char * oob_buf, struct nand_oobinfo *oobsel)	//czyao moves it
...
static void dump_BBT(struct mtd_info *mtd)
{
	...
	int BBs = 0;
	for (i = 0; i < RBA; i++) {
		if (i == 0 && this->bbt[i].BB_die == BB_DIE_INIT
...
static void nand_read_bbt_process(struct mtd_info *mtd, unsigned int page,
				  int chipnr, int chipnr_remap)
{
	int block, i;
	...
	if (check_BBT(mtd, page / ppb) == 0) {
		for (i = 0; i < RBA; i++) {
			if (this->bbt[i].bad_block == BB_INIT
			    && this->bbt[i].remap_block != RB_INIT) {
	...
	printk
	    ("%s: Un-correctable HW ECC Error at page=%d block %d oobbuf %p\n",
	     __FUNCTION__, page, block, this->g_oobbuf);
	memset(this->g_databuf, 0xff, page_size);
	if (isLastPage) {
		this->erase_block(mtd, this->active_chip, block * ppb);
		this->write_ecc_page(mtd, this->active_chip,
				     block * ppb + ppb - 1, this->g_databuf,
				     this->g_oobbuf, 1);
		this->write_ecc_page(mtd, this->active_chip,
				     block * ppb + ppb - 2, this->g_databuf,
				     this->g_oobbuf, 1);
	} else {
		this->erase_block(mtd, this->active_chip, block * ppb);
		this->write_ecc_page(mtd, this->active_chip, block * ppb,
				     this->g_databuf, this->g_oobbuf, 1);
		this->write_ecc_page(mtd, this->active_chip, (block * ppb) + 1,
				     this->g_databuf, this->g_oobbuf, 1);
	}
...
static int nand_write_bbt_process(struct mtd_info *mtd, unsigned int page,
				  int chipnr, int chipnr_remap,
				  const u_char * buf, int data_len,
				  const u_char * oob_buf, int oob_len)
{
	...
	for (i = 0; i < backup_offset; i++) {
		...
		this->read_ecc_page(mtd, this->active_chip, block * ppb + i,
		...
		this->write_ecc_page(mtd, this->active_chip,
				     block_remap * ppb + i, this->g_databuf,
				     this->g_oobbuf, 0);
	}

	this->write_ecc_page(mtd, this->active_chip,
			     block_remap * ppb + backup_offset, &buf[data_len],
			     &oob_buf[oob_len], 0);
	...
	if (oob_buf)
		this->write_ecc_page(mtd, this->active_chip,
				     ...
				     &buf[data_len], &oob_buf[oob_len], 0);
	else
		this->write_ecc_page(mtd, this->active_chip,
				     block_remap * ppb + backup_offset,
				     &buf[data_len], oob_area, 0);
#endif
...
static int nand_block_markbad(struct mtd_info *mtd, loff_t ofs)
{
...
#ifdef CONFIG_RTK_REMAP_BBT
	{
		...
		printk("%s: blockv:%d blockr:%d ofs:%lld\n\r", __FUNCTION__, i,
		       this->bbt_v2r[i].block_r, ofs);
	}
#endif
	page = ((int)ofs) >> this->page_shift;
	this->active_chip = chipnr = chipnr_remap =
	    (int)(ofs >> this->chip_shift);
	page_offset = page & (ppb - 1);
	block = page / ppb;
...
// : 120228
	...
	for (i = 0; i < RBA; i++) {
		if (this->bbt[i].bad_block != BB_INIT) {
			if (chipnr == this->bbt[i].BB_die
			    && block == this->bbt[i].bad_block) {
...
//      uint32 buffer[5];
	...
	for (index = 0; index < row; index++, line += 16) {
		...
		for (index2 = 0; index2 < max; index2++) {
			...
			ascii[index2] =
			    ((u8) buf[index2] < 32) ? empty : buf[index2];
		}
...
static int nand_read_oob_auto(struct mtd_info *mtd, loff_t from,
			      struct mtd_oob_ops *ops)
{
	struct nand_chip *this = mtd->priv;
	...
	if (NOTALIGNED(mtd, from)) {
		printk(KERN_NOTICE
		       "nand_read_oob: Attempt to read not page aligned data. %llx\n",
		       from);
		dump_stack();
		return -EINVAL;
	}
	...
	if (this->bbt[phy_block] >= 0xff) {
		printk
		    ("nand_read_oob_ext: logical_block beyond end of device\n");
		ops->retlen = 0;
		return -EINVAL;
	}
#endif
	...
	while (oob_len < ops->ooblen) {
...
#ifdef CONFIG_RTK_REMAP_BBT
		if (this->numchips == 1) {
			if ((chunk_id >= block * ppb)
			    && (chunk_id < (block + 1) * ppb)
		...
		for (i = 0; i < RBA; i++) {
			if (this->bbt[i].bad_block != BB_INIT) {
				if (this->active_chip == this->bbt[i].BB_die
				    && block == this->bbt[i].bad_block) {
					read_remap_block = block =
					    this->bbt[i].remap_block;
					if (this->bbt[i].BB_die !=
					    this->bbt[i].RB_die) {
						this->active_chip =
						    chipnr_remap =
						    this->bbt[i].RB_die;
...
SKIP_BBT_CHECK:
		if (this->numchips == 1 && read_has_check_bbt == 1) {
			if (read_remap_block == 0xFFFFFFFF)
				...
				chunk_id =
				    read_remap_block * ppb + chunk_offset;
		} else
			chunk_id = block * ppb + chunk_offset;
#else
		// : 120203
		...
		/*winfred_wang */
		rc = this->read_ecc_page(mtd, this->active_chip, chunk_id,
					 this->g_databuf, this->g_oobbuf);
...
// : 120203
...
#ifdef CONFIG_RTK_NORMAL_BBT
				for (i = 0; i < bbt_num; i++) {
					if (this->bbt_nor[i].bad_block ==
					    BB_INIT) {
						this->bbt_nor[i].BB_die =
						    chipnr;
						this->bbt_nor[i].RB_die =
						    chipnr;
						this->bbt_nor[i].bad_block =
						    chunk_id / ppb;
						this->bbt_nor[i].block_info =
						    0xba;
						break;
					}
				}
				...
				printk
				    ("%s: Un-correctable HW ECC Error at page=%d block %d oobbuf %p\n",
				     __FUNCTION__, chunk_id, block,
				     this->g_oobbuf);
				memset(this->g_databuf, 0xff, page_size);
				if (isLastPage) {
					this->erase_block(mtd,
							  this->active_chip,
							  block * ppb);
					this->write_ecc_page(mtd,
							     this->active_chip,
							     block * ppb + ppb -
							     1, this->g_databuf,
							     this->g_oobbuf, 1);
			 ...
			 struct mtd_oob_ops *ops)
{
	...
	if (ops->mode == MTD_OPS_AUTO_OOB) {
		...
		if ((ops->ooblen != 0) && (ops->len != 0)
		    && (ops->datbuf != NULL) && (ops->oobbuf != NULL)) {
			return nand_read_ecc(mtd, from, ops->len, &ops->retlen,
					     ops->datbuf, ops->oobbuf, ops);
		} else {
		...
		if (ops->datbuf == NULL) {
			...
			ret =
			    nand_read_ecc(mtd, from, ops->len, &ops->retlen,
					  ops->datbuf, ops->oobbuf, ops);
			nand_release_device(mtd);
			return ret;
		}
			     ...
			     struct mtd_oob_ops *ops)
{
...
#ifdef CONFIG_RTK_REMAP_BBT
	{
		...
		offset = from - aa;	//data offset
		from =
		    (this->bbt_v2r[i].block_r << this->phys_erase_shift) +
		    offset;
//              printk("%s: blockv:%d blockr:%d from:%lld\n\r",__FUNCTION__,i,this->bbt_v2r[i].block_r, from);
	}
#endif
...
// : 120203
		...
		rc = this->read_ecc_page(mtd, this->active_chip, page,
					 this->g_databuf,
					 oob_area /*ops->oobbuf */ );
...
// : 120203
				...
				printk
				    ("rtk_read_oob: Un-correctable HW ECC Error at page=%d\n",
				     page);
				rc = 0;
#ifdef CONFIG_RTK_NORMAL_BBT
				return -1;
		...
		if (ops->oobbuf) {
			...
			for (oob_shift = 0; oob_shift < 4; oob_shift++) {
				memcpy(ops->oobbuf + (oob_shift * 6),
				       oob_area + (oob_shift * 16), 6);
			}
			 ...
			 size_t * retlen, u_char * oob_buf)
{
	...
	if (NOTALIGNED(mtd, from)) {
		printk(KERN_NOTICE
		       "nand_read_oob: Attempt to read not page aligned data\n");
		return -EINVAL;
	}
	...
	while (oob_len < len) {
		...
		rc = this->read_oob(mtd, this->active_chip, page, thislen,
				    &oob_buf[oob_len]);
		if (rc < 0) {
			if (rc == -1) {
				printk("%s: read_oob: Un-correctable HW ECC\n",
				...
				if (rtk_update_bbt
				    (mtd, this->g_databuf, this->g_oobbuf,
				     this->bbt)) {
					printk("[%s] rtk_update_bbt() fails\n",
					       __FUNCTION__);
					return -1;
				...
				this->g_oobbuf[0] = 0x00;
				if (isLastPage) {
					this->write_oob(mtd, this->active_chip,
							block * ppb + ppb - 1,
							oob_size,
							this->g_oobbuf);
					this->write_oob(mtd, this->active_chip,
...
int rtk_PIO_write(int page, int offset, int length, unsigned char *buffer)
{
	...
	while (pio_length > 0) {
		...
		switch (4) {
		case 3:
			rtk_writel((AD2EN | AD1EN | AD0EN | flash_addr1),
				   NAADR);
			check_ready();
			break;
		case 4:
...
static int nand_pio_write_data(struct mtd_info *mtd, loff_t to,
			       struct mtd_oob_ops *ops)
{
	struct nand_chip *this = mtd->priv;
	unsigned int chunk_id, realchunk;
	...
	if (NOTALIGNED(mtd, to)) {
		printk(KERN_NOTICE
		       "nand_pio_write: Attempt to read not page aligned data. %llx\n",
		       to);
		return -EINVAL;
	}
	...
	if (this->bbt[phy_block] >= 0xff) {
		printk
		    ("nand_pio_write: Attempt read block beyond end of device,no block enough\n");
		return -EINVAL;
	}
#endif
...
**/
static int nand_pio_write_data_oob(struct mtd_info *mtd, loff_t to,
				   struct mtd_oob_ops *ops)
{
	struct nand_chip *this = mtd->priv;
	unsigned int chunk_id, realchunk;
...
SKIP_BBT_CHECK:
		...
		memcpy(&nand_buffer[thislen + page_size], &oob_buf[oob_len],
		       oob_size);

		rtk_PIO_write(chunk_id, 0, page_size + oob_size,
			      &nand_buffer[0]);
...
static int nand_write_oob_auto(struct mtd_info *mtd, loff_t to,
			       struct mtd_oob_ops *ops)
{
	struct nand_chip *this = mtd->priv;
	unsigned int chunk_id, realchunk;
	...
	if ((to + ops->ooblen) > mtd->size) {
		printk
		    ("nand_write_oob_auot: Attempt write beyond end of device\n");
		ops->oobretlen = 0;
		return -EINVAL;
	}
	if (NOTALIGNED(mtd, to)) {
		printk(KERN_NOTICE
		       "nand_write_oob_auot: Attempt to write not page aligned data. %llx\n",
		       to);
		dump_stack();
		return -EINVAL;
	}
	...
	if (ops->ooblen > mtd->oobavail) {
		printk(KERN_NOTICE
		       "nand_write_oob_auot: ops->ooblen size %d > oob area %d\n",
	...
	if (this->bbt[phy_block] >= 0xff) {
		printk
		    ("nand_write_oob_auot: logical_block beyond end of device\n");
		ops->oobretlen = 0;
		return -EINVAL;
	}
#endif
...
// : 120203
			...
			memset(this->g_databuf, 0xff, page_size);
			if (isLastPage) {
				this->erase_block(mtd, this->active_chip,
						  block * ppb);
				this->write_ecc_page(mtd, this->active_chip,
						     block * ppb + ppb - 1,
						     this->g_databuf,
	...
	/*winfred_wang */
	rc = this->write_ecc_page(mtd, this->active_chip, chunk_id,
	...
	if (rc < 0) {
		if (rc == -1) {
			...
			this->select_chip(mtd, err_chipnr_remap);
			this->erase_block(mtd, err_chipnr_remap,
					  block_remap * ppb);
			printk("[%s] Start to Backup old_page from %d to %d\n",
			       __FUNCTION__, block * ppb,
			       block * ppb + backup_offset - 1);
			for (i = 0; i < backup_offset; i++) {
				if (err_chipnr != err_chipnr_remap) {
					this->active_chip = err_chipnr;
					this->select_chip(mtd, err_chipnr);
				}
				this->read_ecc_page(mtd, this->active_chip,
						    block * ppb + i,
						    this->g_databuf,
						    this->g_oobbuf);
/*
			  ...
			  struct mtd_oob_ops *ops)
{
	...
	if (ops->mode == MTD_OPS_RAW) {
		...
		if (ops->datbuf != NULL) {
			ret =
			    nand_write_ecc(mtd, to, ops->len, &ops->retlen,
					   ops->datbuf, ops->oobbuf, NULL);
			nand_release_device(mtd);
			return ret;
		} else {
		...
		if ((ops->datbuf == NULL) && (ops->ooblen != 0)
		    && (ops->oobbuf != NULL)) {
			ret = nand_write_oob_auto(mtd, to, ops);
			nand_release_device(mtd);
			return ret;
		     ...
		     size_t * retlen, u_char * buf)
{
	if (len == 512 && !(NAND_ADDR_CYCLE))
		return nand_read_ecc_512(mtd, from, len, retlen, buf, NULL,
					 NULL);
	else
...
#define NANDSEG(x) (x & ~ADDR_MASK)	//read from align address
	...
	*retlen = 0;
	...
	if (NANDSEG(from) != NANDSEG(nand_offset)) {
		...
		ret =
		    nand_read_ecc(mtd, NANDSEG(from), 2048, &my_retlen,
				  nand_buffer, NULL, NULL);
		if (ret)
			return ret;
	...
	if (len <= firstsize) {
		...
		*retlen = len;
		...
		memcpy(&buf[buffer_offset], &nand_buffer[from - nand_offset],
		       firstsize);
		...
		*retlen += firstsize;
		...
		while (data_len > 0) {
			ret =
			    nand_read_ecc(mtd, NANDSEG(from), mtd->writesize,
					  &my_retlen, nand_buffer, NULL, NULL);

			nand_offset = NANDSEG(from);

			if (data_len > mtd->writesize) {
				/* copy one chunk to buf */
				memcpy(&buf[buffer_offset], &nand_buffer[0],
				       mtd->writesize);
		     ...
		     size_t * retlen, u_char * buf)
{
	...
	if (NOTALIGNED(mtd, len) || NOTALIGNED(mtd, from)) {
		ret =
		    nand_read_ecc_subpage(mtd, from, len, retlen, buf, NULL,
					  NULL);
		nand_release_device(mtd);
		return ret;
	} else {
			 ...
			 struct mtd_oob_ops *ops)
{
	...
	if (NOTALIGNED(mtd, from) || NOTALIGNED(mtd, len)) {
		...
		printk(KERN_NOTICE
		       "nand_read_ecc: Attempt to read not page aligned data\n");
		dump_stack();
		return -EINVAL;
	}
...
#ifdef CONFIG_RTK_REMAP_BBT
		if (this->numchips == 1) {
			if ((page >= block * ppb) && (page < (block + 1) * ppb)
			    && read_has_check_bbt == 1)
				goto SKIP_BBT_CHECK;
		}
...
SKIP_BBT_CHECK:
		...
		if (oob_buf != NULL) {
			...
			//need check
			if (ops) {
				memcpy(&oob_buf[oob_len], this->g_oobbuf,
				       ops->ooblen);
				oob_len += ops->ooblen;
			} else {
				memcpy(&oob_buf[oob_len], this->g_oobbuf,
		...
		if (rc < 0) {
			if (rc == -1) {
				printk
				    ("%s: Un-correctable HW ECC data_len %d\n",
				     __FUNCTION__, data_len);
				//update BBT
// : 120203
#ifdef CONFIG_RTK_REMAP_BBT
...
SKIP_BBT_CHECK:
		...
		if (oob_buf) {
			int oob_shift;
			for (oob_shift = 0; oob_shift < 4; oob_shift++) {
				memcpy(oob_area + (oob_shift * 16),
				       oob_buf + (oob_shift * 6), 6);
			}
		}
		__flush_cache_all();
		rc = this->write_ecc_page(mtd, this->active_chip, page,
					  &buf[data_len],
					  oob_buf ? oob_area : NULL
					  /*&oob_buf[oob_len] */ , 0);
#endif
		...
		if (page > NAND_LOADER_CHUNK) {
			if (oob_buf != NULL) {
				if ((memcmp
				     (this->g_databuf, &buf[data_len],
				      page_size) != 0)
				    ||
				    (memcmp
				     (oob_area, &oob_buf[oob_len],
				      oob_size) != 0)) {
					rc = this->write_ecc_page(mtd,
								  this->
								  active_chip,
								  page,
								  &buf
				...
				if (page % ppb == 0) {
					...
					if (rc) {
						printk
						    ("[%s]:%d.read ecc page error\n",
						     __func__, __LINE__);
						return rc;
					}
					memset(this->g_databuf, 0xff,
					       page_size);
					...
					for (i = 0; i < 6 * 4; i++) {
						if (oob_area[i] != 0xff) {
							...
							if (blocktmp == NULL) {
								printk
								    ("malloc blocktmp failed when write first page in block\n");
								return -1;
							}
							...
							if (oobtmp == NULL) {
								printk
								    ("malloc oobtmp failed when write first page in block\n");
								if (blocktmp) {
									kfree
									    (blocktmp);
									blocktmp
		...
		if (rc < 0) {
			if (rc == -1) {
				...
				this->erase_block(mtd, err_chipnr_remap,
						  block_remap * ppb);
				printk
				    ("[%s] Start to Backup old_page from %d to %d\n",
				     __FUNCTION__, block * ppb,
				     block * ppb + backup_offset - 1);
				for (i = 0; i < backup_offset; i++) {
					if (err_chipnr != err_chipnr_remap) {
...
*/
				...
				memset(this->g_databuf, 0xff, page_size);
				if (isLastPage) {
					this->erase_block(mtd, err_chipnr,
							  block * ppb);
					this->write_ecc_page(mtd,
							     this->active_chip,
							     block * ppb + ppb -
...
//printk ("%s: erase block %x at page =%x\n", __FUNCTION__,block, page);                
		...
		if (rc) {
			printk
			    ("%s: block erase failed at page address=0x%08x\n",
			     __FUNCTION__, addr);
...
// : 120203
#ifdef CONFIG_RTK_REMAP_BBT
			rc = this->erase_block(mtd, chipnr_remap,
					       block_remap * ppb);
#else
			instr->state = MTD_ERASE_FAILED;
#endif
...
*/
	...
	for (i = 0; i < (block_num - RBA); i++) {
		if (block_status[i] == 0xff) {
			...
			this->bbt[table_index].remap_block =
	...
	for (k = 0; k < numchips - 1; k++) {
		...
		for (addr = start_page; addr < chip_size; addr += block_size) {
			if (rtk_block_isbad(mtd, k, addr)) {
				for (j = 0; j < RBA; j++) {
					if (this->bbt[j].bad_block == BB_INIT
					    && this->bbt[j].remap_block !=
					    RB_INIT) {
						this->bbt[j].bad_block =
						    addr >>
...
static int rtk_create_bbt(struct mtd_info *mtd, int page)
{
	...
	if (this->erase_block(mtd, 0, page)) {
		...
		//mark as bad block;
		if (isLastPage) {
			this->write_ecc_page(mtd, 0, page + ppb - 1, temp_BBT,
					     this->g_oobbuf, 1);
			this->write_ecc_page(mtd, 0, page + ppb - 2, temp_BBT,
					     this->g_oobbuf, 1);
		} else {
			this->write_ecc_page(mtd, 0, page, temp_BBT,
					     this->g_oobbuf, 1);
			this->write_ecc_page(mtd, 0, page + 1, temp_BBT,
					     this->g_oobbuf, 1);
		}
		goto EXIT;
	}
	...
	while (mem_page_num > 0) {
		if (this->write_ecc_page(mtd, 0, page + page_counter,
			...
			//mark as bad block;
			if (isLastPage) {
				this->write_ecc_page(mtd, 0, page + ppb - 1,
						     temp_BBT, this->g_oobbuf,
						     1);
				this->write_ecc_page(mtd, 0, page + ppb - 2,
						     temp_BBT, this->g_oobbuf,
						     1);
			} else {
				this->write_ecc_page(mtd, 0, page, temp_BBT,
...
//new method
	for (i = 0; i < BACKUP_BBT; i++) {
		...
		while (mem_page_num_tmp > 0) {
			...
			if (this->write_ecc_page(mtd, numchips - 1,
						 bbt_page + (ppb * i) +
						 page_counter,
						 temp_BBT +
				...
				//rc =  -1;
				//goto EXIT;
				this->erase_block(mtd, numchips - 1,
						  bbt_page + (ppb * i));
				if (!NAND_ADDR_CYCLE) {
#ifdef SWAP_2K_DATA
					this->g_oobbuf[OOB_BBI_OFF] = 0x00;
...
#if 0				//test new method
	while (mem_page_num > 0) {
		if (this->write_ecc_page
		    (mtd, numchips - 1, bbt_page + page_counter,
		     temp_BBT + page_counter * page_size, this->g_oobbuf, 1)) {
			...
			printk("[%s] write BBT0 page %d failure!!\n\r",
			       __FUNCTION__, bbt_page + page_counter);
			rc = -1;
			//goto EXIT;
		}
		//printf("[%s, line %d] mem_page_num = %d page_counter %d\n\r",__FUNCTION__,__LINE__,mem_page_num, page_counter);
...
*/
	while (mem_page_num > 0) {
		if (this->write_ecc_page(mtd, numchips - 1,
					 bbt_page + ppb + page_counter,
					 temp_BBT + page_counter * page_size,
					 this->g_oobbuf, 1)) {
			//if(rtk_write_ecc_page(bbt_page+page_counter,temp_BBT+page_counter*page_size, &NfSpareBuf, page_size)) {
			printk("[%s] write BBT1 page %d failure!!\n\r",
			       __FUNCTION__, bbt_page + ppb + page_counter);
			rc = -1;
			goto EXIT;
		}
		//printf("[%s, line %d] mem_page_num = %d page_counter %d\n\r",__FUNCTION__,__LINE__,mem_page_num, page_counter);
...
int rtk_scan_v2r_bbt(struct mtd_info *mtd)
{
	...
	bbt_v2r_page =
	    ((BOOT_SIZE / block_size) - (2 * BACKUP_BBT)) * this->ppb;
	...
	printk
	    ("[%s, line %d] block_v2r_num %d bbt_v2r_page %x this->phys_erase_shift:%x\n\r",
	     __FUNCTION__, __LINE__, block_v2r_num, bbt_v2r_page,
	     this->phys_erase_shift);
...
#if 0
	this->bbt_v2r =
	    (unsigned char *)malloc(sizeof(struct BBT_v2r) * (block_v2r_num));
	if (!this->bbt_v2r) {
...
//test NEW method!
	for (i = 0; i < BACKUP_BBT; i++) {
		...
		rc = this->read_ecc_page(mtd, numchips - 1,
					 bbt_v2r_page + (i * ppb),
					 this->g_databuf, this->g_oobbuf);
		if (!NAND_ADDR_CYCLE) {
#ifdef SWAP_2K_DATA
		...
		if (!rc) {
			...
			if (!rc) {
				...
				if (!NAND_ADDR_CYCLE)
					...
					this->g_oobbuf[5] = 0x00;
				if (isLastPage) {
					this->write_ecc_page(mtd, numchips - 1,
							     bbt_v2r_page +
							     (ppb * i) + (ppb -
									  1),
							     temp_BBT,
...
CHECK_BBT_OK:
#if 0
	rc = this->read_ecc_page(mtd, 0, bbt_v2r_page, this->g_databuf,
				 this->g_oobbuf);
	...
	if (!rc) {
		if (isbbt == BBT_TAG) {
			printk
			    ("[%s] have created bbt_v2r B0 on block %d, just loads it !!\n\r",
			     __FUNCTION__, bbt_v2r_page / this->ppb);
...
//                              if( rtk_read_ecc_page((bbt_v2r_page+page_counter), this->g_databuf, this->g_oobbuf, page_size)){
				if (this->read_ecc_page(mtd, 0,
							bbt_v2r_page +
							page_counter,
							this->g_databuf,
							this->g_oobbuf)) {
					printk
					    ("[%s] load bbt_v2r B0 error!!\n\r",
					     __FUNCTION__);
					kfree(temp_BBT);
					return -1;
				}
				memcpy(temp_BBT + page_counter * page_size,
				       this->g_databuf, page_size);
				page_counter++;
				mem_page_num--;
			}
			memcpy(this->bbt_v2r, temp_BBT,
			       sizeof(BB_v2r) * (block_v2r_num));
		} else {
			printk
			    ("[%s] read bbt_v2r B0 tags fails, try to load bbt_v2r B1\n\r",
			     __FUNCTION__);
			//rc = rtk_read_ecc_page(bbt_v2r_page+ppb, this->g_databuf, this->g_oobbuf, page_size);
			rc = this->read_ecc_page(mtd, 0,
						 bbt_v2r_page + this->ppb,
						 this->g_databuf,
						 this->g_oobbuf);
			if (!NAND_ADDR_CYCLE)
				isbbt = this->g_oobbuf[0];
			...
			if (!rc) {
				if (isbbt == BBT_TAG) {
					printk
					    ("[%s] have created bbt_v2r B1 on block %d, just loads it !!\n",
					     __FUNCTION__,
					     (bbt_v2r_page / this->ppb) + 1);
					memcpy(temp_BBT, this->g_databuf,
					       page_size);
					page_counter++;
					mem_page_num--;
					...
					printk
					    ("[%s] read bbt_v2r B1 tags fails, nand driver will creat bbt_v2r B0 and B1\n\r",
					     __FUNCTION__);
				...
				printk
				    ("[%s] read bbt_v2r B1 with HW ECC fails, nand driver will creat BBT B0\n",
				     __FUNCTION__);
				create_v2r_remapping(mtd, bbt_v2r_page,
						     block_v2r_num);
			}
		}		// if BBT_TAG
	} else {
		printk
		    ("[%s] read bbt_v2r B0 with HW ECC error, try to load BBT B1\n\r",
		     __FUNCTION__);
		//rc = rtk_read_ecc_page(bbt_v2r_page+ppb, this->g_databuf, this->g_oobbuf, page_size);
		if (!NAND_ADDR_CYCLE)
			isbbt = this->g_oobbuf[0];
		...
		if (!rc) {
			if (isbbt == BBT_TAG) {
				...
				printk
				    ("[%s] read bbt_v2r B1 tags fails, nand driver will creat BBT B1\n\r",
				     __FUNCTION__);
				create_v2r_remapping(mtd, bbt_v2r_page + this->ppb, block_v2r_num);	//fix me! later
			}
		} else {
			printk
			    ("[%s-%d:] read bbt_v2r B0 and B1 with HW ECC fails\n\r",
			     __FUNCTION__, __LINE__);
			kfree(temp_BBT);
			return -1;
		}
...
CHECK_BBT_OK:
#if 0
	rc = this->read_ecc_page(mtd, 0, bbt_page, this->g_databuf,
				 this->g_oobbuf);
//  111116
...
*/
	...
	if (!rc) {
		if (isbbt_b0 == BBT_TAG) {
			...
			printk
			    ("[%s] read BBT B0 tags fails, try to load BBT B1\n",
			     __FUNCTION__);
			rc = this->read_ecc_page(mtd, 0, bbt1_block_num,
						 this->g_databuf,
						 this->g_oobbuf);
			...
			if (!rc) {
				if (isbbt_b1 == BBT_TAG) {
					printk
					    ("[%s] have created bbt B1, just loads it !!\n",
					     __FUNCTION__);
					memcpy(temp_BBT, this->g_databuf,
					       page_size);
					page_counter++;
					...
					printk
					    ("[%s] read BBT B1 tags fails, nand driver will creat BBT B0 and B1\n",
					     __FUNCTION__);
				...
				printk
				    ("[%s] read BBT B1 with HW ECC fails, nand driver will creat BBT B0\n",
				     __FUNCTION__);
				rtk_create_bbt(mtd, bbt_page);
			}
		}
		...
		printk
		    ("[%s] read BBT B0 with HW ECC error, try to load BBT B1\n",
		     __FUNCTION__);
		rc = this->read_ecc_page(mtd, 0, bbt1_block_num,
					 this->g_databuf, this->g_oobbuf);
		...
		if (!rc) {
			if (isbbt_b1 == BBT_TAG) {
				...
				printk
				    ("[%s] read BBT B1 tags fails, nand driver will creat BBT B1\n",
				     __FUNCTION__);
...
int rtk_update_normal_bbt(struct mtd_info *mtd, BBT_normal * bbt_nor)
{
	...
	u8 *temp_BBT = 0;
	bbt_page =
	    ((NORMAL_BBT_POSITION >> this->phys_erase_shift) -
	     BACKUP_BBT) * ppb;
	mem_page_num =
	    (sizeof(BBT_normal) * this->bbt_num + page_size - 1) / page_size;
	printk("[%s] mem_page_num %d bbt_page %d\n\r", __FUNCTION__,
	       mem_page_num, bbt_page);
	temp_BBT = kmalloc(mem_page_num * page_size, GFP_KERNEL);
	if (!(temp_BBT)) {
...
static void dump_normal_BBT(struct mtd_info *mtd)
{
	...
	int BBs = 0;
	for (i = 0; i < bbt_num; i++) {
		if (i == 0 && this->bbt_nor[i].BB_die == BB_DIE_INIT
		    && this->bbt_nor[i].bad_block == BB_INIT) {
			printk("Congratulation!! No BBs in this Nand.\n");
			break;
		}
		if (this->bbt_nor[i].bad_block != BB_INIT) {
...
static int nand_scan_normal_bbt(struct mtd_info *mtd)
{
	...
	bbt_page =
	    ((NORMAL_BBT_POSITION / this->block_size) - BACKUP_BBT) * ppb;
	mem_page_num =
	    (sizeof(BBT_normal) * bbt_num + page_size - 1) / page_size;
	printk("[%s, line %d] mem_page_num=%d bbt_page %d\n", __FUNCTION__,
	       __LINE__, mem_page_num, bbt_page);
...
int rtk_nand_scan(struct mtd_info *mtd, int maxchips)
{
	...
	while (1) {
		...
		nand_type_id =
		    maker_code << 24 | device_code << 16 | id[2] << 8 | id[3];
		B5th = id[4];
		B6th = id[5];
		...
		if (i > 1) {
			num_chips_probe = i;
			printk(KERN_INFO
			       "NAND Flash Controller detects %d dies\n",
			       num_chips_probe);
		}
		//test code
		num_chips_probe = 1;
		...
		for (i = 0; nand_device[i].name; i++) {
			if (nand_device[i].id == nand_type_id) {
				 ...
				 */
				if (nand_device[i].size ==
				    num_chips_probe * nand_device[i].chipsize) {
					if (num_chips_probe ==
					    nand_device[i].num_chips) {
						printk
						    ("One %s chip has %d die(s) on board\n",
						     nand_device[i].name,
						     nand_device[i].num_chips);
						...
						device_size =
						    nand_device[i].size;
						chip_size =
						    nand_device[i].chipsize;
						page_size =
						    nand_device[i].PageSize;
						block_size =
						    nand_device[i].BlockSize;
						oob_size =
						    nand_device[i].OobSize;
						num_chips =
						    nand_device[i].num_chips;
						isLastPage =
						    nand_device[i].isLastPage;
						rtk_lookup_table_flag = 1;
						printk
						    ("nand part=%s, id=%x, device_size=%u, chip_size=%u, num_chips=%d, isLastPage=%d\n",
						     nand_device[i].name,
						     nand_device[i].id,
						     nand_device[i].size,
						     nand_device[i].chipsize,
					...
					if (!strcmp
						...
						printk
						    ("We have %d the same %s chips on board\n",
						     num_chips_probe /
						     nand_device[i].num_chips,
						     nand_device[i].name);
						//mtd->PartNum = nand_device[i].name;
						...
						rtk_lookup_table_flag = 1;
						printk
						    ("nand part=%s, id=%x, device_size=%d, chip_size=%d,\nnum_chips=%d, isLastPage=%d\n",
						     nand_device[i].name,
						     nand_device[i].id,
						     nand_device[i].size,
						     nand_device[i].chipsize,
		...
		printk
		    ("[%s, line %d] page_shift=%d, phy_erase_shift=%d, oob_shift=%d, chip_shift=%d\n",
		     __FUNCTION__, __LINE__, this->page_shift,
		     this->phys_erase_shift, this->oob_shift, this->chip_shift);

		printk("%s(%d): pagesize=%x,oob=%x mtd=%p(%p)\n", __FUNCTION__,
		       __LINE__, page_size, oob_size, mtd, &mtd->writesize);
...
//end 111116
...
#ifdef CONFIG_RTK_REMAP_BBT
	RBA = this->RBA =
	    ((u32) mtd->size / block_size) * this->RBA_PERCENT / 100;
	printk("[%s, line %d], RBA=%d, this->RBA_PERCENT = %d\n", __func__,
	       __LINE__, RBA, this->RBA_PERCENT);
...
#endif
#ifdef CONFIG_RTK_NORMAL_BBT
	bbt_num = this->bbt_num =
	    ((u32) mtd->size / block_size) * this->BBT_PERCENT / 100;
	printk("[%s, line %d], bbt_num=%d, this->BBT_PERCENT = %d\n", __func__,
	       __LINE__, bbt_num, this->BBT_PERCENT);
	...
	this->erase_page_flag =
	    (void *)__get_free_pages(GFP_KERNEL, mempage_order);
	...
	/* =========================== for MP usage ======================= */
	mp_time_para =
	    (char *)parse_token(platform_info.system_parameters,
				"mp_time_para");
	if (mp_time_para && strlen(mp_time_para))
		mp_time_para_value =
		    simple_strtoul(mp_time_para, &mp_time_para, 10);
	...
	nf_clock =
	    (char *)parse_token(platform_info.system_parameters, "nf_clock");
	...
	if (mp_erase_nand && strlen(mp_erase_nand))
		mp_erase_flag =
		    simple_strtoul(mp_erase_nand, &mp_erase_nand, 10);
