...
//MXIC
    SECTION_RO plr_nand_spi_info_t MXIC_MX35LF1GE4AB_info = {
	    ...
	    MXIC_DEVICE_ID_MX35LF1GE4AB,.num_block =
...
//esmt
    SECTION_RO plr_nand_spi_info_t ESMT_F50L1G41A_info = {
	    ...
	    ESMT_DEVICE_ID_F50L1G41A,.num_block =
	    1024,.num_chunk_per_block = 64,.chunk_size = 2048,._probe =
...
//winbond
    SECTION_RO plr_nand_spi_info_t winbond_W25N01GV_info = {
	    ...
	    WINBOND_DEVICE_ID_W25N01GV,.num_block =
	    1024,.num_chunk_per_block = 64,.chunk_size = 2048,._probe =
	    ...
	    WINBOND_DEVICE_ID_W25N02GV,.num_block =
	    1024,.num_chunk_per_block = 64,.chunk_size = 2048,._probe =
...
  SECTION_NAND_SPI unsigned int winbond_get_feature_register(unsigned int
								 feature_addr
...
#define BBT_NUM 20
	...
	 PIO_WRITE_READ_DATA(WINBOND_READ_BBM_TBL, dummy, SNF_DONT_CARE,
