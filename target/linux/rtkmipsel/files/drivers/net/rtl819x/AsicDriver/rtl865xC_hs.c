...
static int32 convertHsbToSoftware(hsb_t * rawHsb, hsb_param_t * hsb)
{
	...
	hsb->sipv6_31_0 =
	    ((rawHsb->sipv6_50_19 & 0x1FFF) << 19) | rawHsb->sipv6_18_0;
	hsb->sipv6_63_32 =
	    ((rawHsb->
	      sipv6_82_51 & 0x1FFF) << 19) | (rawHsb->sipv6_50_19 >> 13);
	hsb->sipv6_95_64 =
	    ((rawHsb->
	      sipv6_114_83 & 0x1FFF) << 19) | (rawHsb->sipv6_82_51 >> 13);
	hsb->sipv6_127_96 =
	    ((rawHsb->
	      sipv6_127_115 & 0x1FFF) << 19) | (rawHsb->sipv6_114_83 >> 13);

	hsb->dipv6_31_0 =
	    ((rawHsb->dipv6_50_19 & 0x1FFF) << 19) | rawHsb->dipv6_18_0;
	hsb->dipv6_63_32 =
	    ((rawHsb->
	      dipv6_82_51 & 0x1FFF) << 19) | (rawHsb->dipv6_50_19 >> 13);
	hsb->dipv6_95_64 =
	    ((rawHsb->
	      dipv6_114_83 & 0x1FFF) << 19) | (rawHsb->dipv6_82_51 >> 13);
	hsb->dipv6_127_96 =
	    ((rawHsb->
	      dipv6_127_115 & 0x1FFF) << 19) | (rawHsb->dipv6_114_83 >> 13);
...
int32 virtualMacGetHsb(hsb_param_t * hsb)
{
	...
	{			/* Word-Access */
		...
		if ((sizeof(rawHsb) % 4) != 0)
			RTL_BUG("sizeof(rawHsb) is not the times of 4-bytes.");
...
int32 convertHsaToSoftware(hsa_t * rawHsa, hsa_param_t * hsa)
{
...
#endif
	hsa->ttl_1if =
	    rawHsa->ttl_1if4_0 | (rawHsa->
				  ttl_1if5_5 << 5) | (rawHsa->ttl_1if8_6 << 6);
	hsa->dpc = rawHsa->dpc;
	...
	hsa->sipv6_31_0 =
	    ((rawHsa->sipv6_43_12 & 0xFFFFF) << 12) | rawHsa->sipv6_11_0;
	hsa->sipv6_63_32 =
	    ((rawHsa->
	      sipv6_75_44 & 0xFFFFF) << 12) | (rawHsa->sipv6_43_12 >> 20);
	hsa->sipv6_95_64 =
	    ((rawHsa->
	      sipv6_107_76 & 0xFFFFF) << 12) | (rawHsa->sipv6_75_44 >> 20);
	hsa->sipv6_127_96 =
	    ((rawHsa->
	      sipv6_127_108 & 0xFFFFF) << 12) | (rawHsa->sipv6_107_76 >> 20);

	hsa->dipv6_31_0 =
	    ((rawHsa->dipv6_43_12 & 0xFFFFF) << 12) | rawHsa->dipv6_11_0;
	hsa->dipv6_63_32 =
	    ((rawHsa->
	      dipv6_75_44 & 0xFFFFF) << 12) | (rawHsa->dipv6_43_12 >> 20);
	hsa->dipv6_95_64 =
	    ((rawHsa->
	      dipv6_107_76 & 0xFFFFF) << 12) | (rawHsa->dipv6_75_44 >> 20);
	hsa->dipv6_127_96 =
	    ((rawHsa->
	      dipv6_127_108 & 0xFFFFF) << 12) | (rawHsa->dipv6_107_76 >> 20);
...
int32 virtualMacGetHsa(hsa_param_t * hsa)
{
	...
	{			/* Word-Access */
		...
		/* We must assert structure size is the times of 4-bytes. */
		if ((sizeof(rawHsa) % 4) != 0)
			RTL_BUG("sizeof(rawHsa) is not the times of 4-bytes.");
