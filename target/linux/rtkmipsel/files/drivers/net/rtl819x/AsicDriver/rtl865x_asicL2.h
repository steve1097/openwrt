...
typedef struct rtl865x_tblAsicDrv_l2Param_s {
	...
	uint32 ageSec;
	uint32 cpu:1, srcBlk:1, isStatic:1, nhFlag:1, fid:2, auth:1;

} rtl865x_tblAsicDrv_l2Param_t;

typedef struct rtl8651_tblAsic_ethernet_s {
	uint8 linkUp:1, phyId:5, isGPHY:1;
...
int32 rtl8651_getAsicPortIngressBandwidth(enum PORTID port,
					  uint32 * pBandwidth);
...
int32 rtl8651_setPortFlowControlConfigureRegister(enum PORTID port,
						  uint32 enable);
int32 rtl8651_setAsicPortPriority(enum PORTID port,
				  enum PRIORITYVALUE priority);
...
extern int rtk_stat_port_getAll(uint32 port,
