...
 static int32 _rtl865x_setAsicVlan(uint16 vid,
...
 static int32 _rtl865x_addVlanPortMember2(uint16 vid, uint32 portMask,
...
 int32 rtl865x_addVlanPortMember2(uint16 vid, uint32 portMask,
				    uint32 untagPortMask) 
{
...
  static int32 _rtl865x_setVlanPortTag(uint16 vid, uint32 portMask,
					  uint8 tag) 
{
...
 int32 rtl865x_modVlanPortMember(uint16 vid, uint32 portMask,
				   uint32 untagset) 
{
