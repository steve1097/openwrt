...
{
	TBL_MEM_ALLOC(rtl865x_ipv6_DsLiteTable, rtl865x_dslite_s,
		       IPV6_DSLT_ENTRY_NUM);
	memset(rtl865x_ipv6_DsLiteTable, 0,
...
 int32 _rtl865x_getIpv6DsLiteEntryByAfterAddr(inv6_addr_t aftr_ipv6_addr,
						uint32 aftr_ipv6_mask) 
{
			 ...
			 aftr_ipv6_addr.
			 v6_addr32[0])  &&(entry->aftr_ipv6_addr.v6_addr32[1]
					    ==
					    aftr_ipv6_addr.v6_addr32[1]) 
			&&(entry->aftr_ipv6_addr.v6_addr32[2] ==
			   aftr_ipv6_addr.
			   v6_addr32[2])  &&(entry->aftr_ipv6_addr.v6_addr32[3]
					      ==
...
int32 _rtl865x_getIpv6DsLiteEntrybyIndex(uint32 entryIdx,
...
 static int32 _rtl865x_synIpv6DsLiteToAsic(rtl865x_dslite_s * entry_t) 
{
	...
	 asic_entry.host_ipv6_addr.v6_addr32[0] =
	    entry_t->host_ipv6_addr.v6_addr32[0];
	asic_entry.host_ipv6_addr.v6_addr32[1] =
	    entry_t->host_ipv6_addr.v6_addr32[1];
	asic_entry.host_ipv6_addr.v6_addr32[2] =
	    entry_t->host_ipv6_addr.v6_addr32[2];
	asic_entry.host_ipv6_addr.v6_addr32[3] =
	    entry_t->host_ipv6_addr.v6_addr32[3];
	asic_entry.host_ipv6_mask = entry_t->host_ipv6_mask;
	 asic_entry.aftr_ipv6_addr.v6_addr32[0] =
	    entry_t->aftr_ipv6_addr.v6_addr32[0];
	asic_entry.aftr_ipv6_addr.v6_addr32[1] =
	    entry_t->aftr_ipv6_addr.v6_addr32[1];
	asic_entry.aftr_ipv6_addr.v6_addr32[2] =
	    entry_t->aftr_ipv6_addr.v6_addr32[2];
	asic_entry.aftr_ipv6_addr.v6_addr32[3] =
...
 int32 _rtl865x_addIpv6DsLiteEntry(inv6_addr_t host_ipv6_addr,
				     ...
				     unsigned int mtu)
{
	...
	entry->host_ipv6_addr.v6_addr32[1] =
	    htonl(host_ipv6_addr.v6_addr32[1]);
	entry->host_ipv6_addr.v6_addr32[2] =
	    htonl(host_ipv6_addr.v6_addr32[2]);
	entry->host_ipv6_addr.v6_addr32[3] =
