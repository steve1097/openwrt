...
{
	TBL_MEM_ALLOC(rtl865x_nxtHopTable, rtl865x_nextHopEntry_t,
		       NXTHOP_ENTRY_NUM);
	memset(rtl865x_nxtHopTable, 0,
...
 static int32 _rtl865x_addNxtHop(uint32 attr, void *ref_ptr,
...
 int32 _rtl865x_eventHandle_delIpv6Arp(rtl8198c_ipv6_arpMapping_entry_t *
					 arp) 
{
...
flag:			    3;	/* bit0:referenced by l3, bit2:referenced by acl */
		    ...
		    sw_nxthop = &rtl865x_nxtHopTable[idx];
			    ...
			    idx, sw_nxthop->entryIndex, sw_nxthop->nextHopType,
			  ...
			  int *eof, void *data)
{
		    ...
		    sprintf(page + len,
			    ...
			    idx, sw_nxthop->nextHopType, sw_nxthop->entryIndex,
			    sw_nxthop->dstNetif->name, sw_nxthop->srcIp,
			    sw_nxthop->nexthop);
...
#endif /*  */
    int32 sw_nexthop_write(struct file * filp, const char *buff,
