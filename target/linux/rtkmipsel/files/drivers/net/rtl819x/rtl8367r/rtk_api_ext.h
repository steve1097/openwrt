 ...
 *      configuration.
 */
extern rtk_api_ret_t rtk_switch_portMaxPktLen_set(rtk_port_t port,
						  rtk_uint32 length);
 ...
 */
extern rtk_api_ret_t rtk_switch_portMaxPktLen_get(rtk_port_t port,
						  rtk_uint32 * pLength);
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeter_set(rtk_meter_id_t index,
					     rtk_rate_t rate,
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeter_get(rtk_meter_id_t index,
					     rtk_rate_t * pRate,
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeterBucket_set(rtk_meter_id_t index,
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeterBucket_get(rtk_meter_id_t index,
 ...
 *      The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_igrBandwidthCtrlRate_set(rtk_port_t port,
						       rtk_rate_t rate,
						       rtk_enable_t ifg_include,
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_igrBandwidthCtrlRate_get(rtk_port_t port,
						       rtk_rate_t * pRate,
						       rtk_enable_t *
						       pIfg_include,
						       rtk_enable_t *
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_egrBandwidthCtrlRate_set(rtk_port_t port,
						       rtk_rate_t rate,
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_egrBandwidthCtrlRate_get(rtk_port_t port,
						       rtk_rate_t * pRate,
						       rtk_enable_t *
						       pIfg_include);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlEnable_set(rtk_port_t port,
						       rtk_qid_t queue,
						       rtk_enable_t enable);
 ...
 *    None.
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlEnable_get(rtk_port_t port,
						       rtk_qid_t queue,
 ...
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlRate_set(rtk_port_t port,
						     rtk_qid_t queue,
 ...
 *    The unit of granularity is 8Kbps.
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlRate_get(rtk_port_t port,
						     rtk_qid_t queue,
						     rtk_meter_id_t * pIndex);

/*Storm Control Rate*/
#if defined(EMBEDDED_SUPPORT)
extern rtk_api_ret_t rtk_storm_controlRate_set(rtk_port_t port,
					       rtk_rate_storm_group_t
					       storm_type, rtk_rate_t rate,
					       rtk_enable_t ifg_include,
					       rtk_uint32 mode) reentrant;
extern rtk_api_ret_t rtk_storm_controlRate_get(rtk_port_t port,
					       rtk_rate_storm_group_t
					       storm_type, rtk_rate_t * pRate,
					       rtk_enable_t * pIfg_include,
					       rtk_uint32 mode) reentrant;
#else
/* Function Name:
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t rtk_storm_bypass_set(rtk_storm_bypass_t type,
					  rtk_enable_t enable);
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t rtk_storm_bypass_get(rtk_storm_bypass_t type,
					  rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_qos_1pPriRemap_set(rtk_pri_t dot1p_pri,
					    rtk_pri_t int_pri);
 ...
 */
extern rtk_api_ret_t rtk_qos_1pPriRemap_get(rtk_pri_t dot1p_pri,
					    rtk_pri_t * pInt_pri);
 ...
 */
extern rtk_api_ret_t rtk_qos_dscpPriRemap_set(rtk_dscp_t dscp,
					      rtk_pri_t int_pri);
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
extern rtk_api_ret_t rtk_qos_dscpPriRemap_get(rtk_dscp_t dscp,
					      rtk_pri_t * pInt_pri);
 ...
 */
extern rtk_api_ret_t rtk_qos_queueNum_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_qos_queueNum_get(rtk_port_t port,
					  rtk_queue_num_t * pQueue_num);
 ...
 */
extern rtk_api_ret_t rtk_qos_priMap_set(rtk_queue_num_t queue_num,
 ...
 *      The queue number is from 1 to 8.
 */
extern rtk_api_ret_t rtk_qos_priMap_get(rtk_queue_num_t queue_num,
					rtk_qos_pri2queue_t * pPri2qid);
 ...
 */
extern rtk_api_ret_t rtk_qos_schedulingQueue_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_qos_schedulingQueue_get(rtk_port_t port,
						 rtk_qos_queue_weights_t *
						 pQweights);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_qos_1pRemarkEnable_set(rtk_port_t port,
						rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_qos_1pRemarkEnable_get(rtk_port_t port,
						rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_qos_1pRemark_set(rtk_pri_t int_pri,
					  rtk_pri_t dot1p_pri);
 ...
 */
extern rtk_api_ret_t rtk_qos_1pRemark_get(rtk_pri_t int_pri,
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_qos_dscpRemarkEnable_set(rtk_port_t port,
						  rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_qos_dscpRemarkEnable_get(rtk_port_t port,
						  rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_qos_dscpRemark_get(rtk_pri_t int_pri,
					    rtk_dscp_t * pDscp);
 ...
 */
extern rtk_api_ret_t rtk_trap_unknownUnicastPktAction_set(rtk_trap_ucast_type_t
							  type,
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unknownUnicastPktAction_get(rtk_trap_ucast_type_t
							  type,
							  rtk_trap_ucast_action_t
							  * pUcast_action);
 ...
 */
extern rtk_api_ret_t rtk_trap_unknownMcastPktAction_set(rtk_port_t port,
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unknownMcastPktAction_get(rtk_port_t port,
							rtk_mcast_type_t type,
							rtk_trap_mcast_action_t
							* pMcast_action);
 ...
 */
extern rtk_api_ret_t rtk_trap_igmpCtrlPktAction_set(rtk_igmp_type_t type,
 ...
 *          - IGMP_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtk_api_ret_t rtk_trap_igmpCtrlPktAction_get(rtk_igmp_type_t type,
						    rtk_trap_igmp_action_t *
						    pIgmp_action);
 ...
 */
extern rtk_api_ret_t rtk_trap_rmaAction_set(rtk_mac_t * pRma_frame,
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtk_api_ret_t rtk_trap_rmaAction_get(rtk_mac_t * pRma_frame,
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern rtk_api_ret_t rtk_leaky_vlan_set(rtk_leaky_type_t type,
					rtk_enable_t enable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern rtk_api_ret_t rtk_leaky_vlan_get(rtk_leaky_type_t type,
					rtk_enable_t * pEnable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern rtk_api_ret_t rtk_leaky_portIsolation_set(rtk_leaky_type_t type,
						 rtk_enable_t enable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern rtk_api_ret_t rtk_leaky_portIsolation_get(rtk_leaky_type_t type,
						 rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_phyAutoNegoAbility_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_phyAutoNegoAbility_get(rtk_port_t port,
						     rtk_port_phy_ability_t *
						     pAbility);
 ...
 *      be set as following 100F > 100H > 10F > 10H priority sequence.
 */
extern rtk_api_ret_t rtk_port_phyForceModeAbility_set(rtk_port_t port,
						      rtk_port_phy_ability_t *
						      pAbility);
 ...
 *      Get the capablity of specified PHY.
 */
extern rtk_api_ret_t rtk_port_phyForceModeAbility_get(rtk_port_t port,
						      rtk_port_phy_ability_t *
						      pAbility);
 ...
 */
extern rtk_api_ret_t rtk_port_phyStatus_get(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_phy1000BaseTMasterSlave_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLink_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLink_get(rtk_port_t port,
					       rtk_port_mac_ability_t *
					       pPortability);
 ...
 *      - MODE_EXT_RMII_MAC,
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt0_set(rtk_mode_ext_t mode,
						   rtk_port_mac_ability_t *
						   pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt0_get(rtk_mode_ext_t * pMode,
						   rtk_port_mac_ability_t *
						   pPortability);
 ...
 *      - MODE_EXT_RMII_MAC,
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt1_set(rtk_mode_ext_t mode,
						   rtk_port_mac_ability_t *
						   pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt1_get(rtk_mode_ext_t * pMode,
						   rtk_port_mac_ability_t *
						   pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macStatus_get(rtk_port_t port,
					    rtk_port_mac_ability_t *
					    pPortstatus);
 ...
 */
extern rtk_api_ret_t rtk_port_macLocalLoopbackEnable_set(rtk_port_t port,
							 rtk_enable_t enable);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_port_macLocalLoopbackEnable_get(rtk_port_t port,
							 rtk_enable_t *
							 pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_phyReg_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_phyReg_get(rtk_port_t port,
					 rtk_port_phy_reg_t reg,
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_backpressureEnable_set(rtk_port_t port,
						     rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_backpressureEnable_get(rtk_port_t port,
						     rtk_enable_t * pEnable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_adminEnable_set(rtk_port_t port,
					      rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_adminEnable_get(rtk_port_t port,
					      rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_isolation_set(rtk_port_t port,
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
extern rtk_api_ret_t rtk_port_isolation_get(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt0_set(rtk_data_t txDelay,
						 rtk_data_t rxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt0_get(rtk_data_t * pTxDelay,
						 rtk_data_t * pRxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt1_set(rtk_data_t txDelay,
						 rtk_data_t rxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt1_get(rtk_data_t * pTxDelay,
						 rtk_data_t * pRxDelay);
 ...
 */
extern rtk_api_ret_t rtk_port_phyComboPortMedia_set(rtk_port_t port,
 ...
 *      The API can Set Combo port media type.
 */
extern rtk_api_ret_t rtk_port_phyComboPortMedia_get(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_port_rtctResult_get(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_vlan_set(rtk_vlan_t vid, rtk_portmask_t mbrmsk,
				  rtk_portmask_t untagmsk, rtk_fid_t fid);
 ...
 */
extern rtk_api_ret_t rtk_vlan_get(rtk_vlan_t vid, rtk_portmask_t * pMbrmsk,
 ...
 *     Set a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_set(rtk_uint32 idx,
					 rtk_vlan_mbrcfg_t * pMbrcfg);
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_get(rtk_uint32 idx,
					 rtk_vlan_mbrcfg_t * pMbrcfg);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portIgrFilterEnable_set(rtk_port_t port,
 ...
 *     - ENABLED
 */
extern rtk_api_ret_t rtk_vlan_portIgrFilterEnable_get(rtk_port_t port,
						      rtk_enable_t *
						      pIgr_filter);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portAcceptFrameType_set(rtk_port_t port,
 ...
 *     - ACCEPT_FRAME_TYPE_UNTAG_ONLY
 */
extern rtk_api_ret_t rtk_vlan_portAcceptFrameType_get(rtk_port_t port,
						      rtk_vlan_acceptFrameType_t
						      * pAccept_frame_type);
 ...
 */
extern rtk_api_ret_t rtk_vlan_vlanBasedPriority_set(rtk_vlan_t vid,
						    rtk_pri_t priority);
 ...
 *     This API is used to set priority per VLAN.
 */
extern rtk_api_ret_t rtk_vlan_vlanBasedPriority_get(rtk_vlan_t vid,
						    rtk_pri_t * pPriority);
 ...
 */
extern rtk_api_ret_t rtk_vlan_tagMode_set(rtk_port_t port,
 ...
 *      - VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
extern rtk_api_ret_t rtk_vlan_tagMode_get(rtk_port_t port,
					  rtk_vlan_tagMode_t * pTag_mode);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_transparent_set(rtk_port_t egr_port,
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_transparent_get(rtk_port_t egr_port,
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_add(rtk_port_t port,
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_get(rtk_port_t port,
							rtk_vlan_proto_type_t
							proto_type,
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_del(rtk_port_t port,
							rtk_vlan_proto_type_t
							proto_type,
							rtk_vlan_protoVlan_frameType_t
							frame_type);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portFid_set(rtk_port_t port, rtk_enable_t enable,
					  rtk_fid_t fid);
 ...
 *      packets will be assigned to the port-based fid regardless vlan tag.
 */
extern rtk_api_ret_t rtk_vlan_portFid_get(rtk_port_t port,
					  rtk_enable_t * pEnable,
					  rtk_fid_t * pFid);
 ...
 */
extern rtk_api_ret_t rtk_stp_mstpState_set(rtk_stp_msti_id_t msti,
					   rtk_port_t port,
 ...
 *      - STP_STATE_FORWARDING
 */
extern rtk_api_ret_t rtk_stp_mstpState_get(rtk_stp_msti_id_t msti,
					   rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_add(rtk_mac_t * pMac,
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_get(rtk_mac_t * pMac,
				     rtk_l2_ucastAddr_t * pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_next_get(rtk_l2_read_method_t read_method,
					  rtk_port_t port,
					  rtk_uint32 * pAddress,
					  rtk_l2_ucastAddr_t * pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_del(rtk_mac_t * pMac,
				     rtk_l2_ucastAddr_t * pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_add(rtk_mac_t * pMac, rtk_data_t ivl,
					  rtk_data_t cvid_fid,
					  rtk_portmask_t portmask);
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_get(rtk_mac_t * pMac, rtk_data_t ivl,
					  rtk_data_t cvid_fid,
					  rtk_portmask_t * pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_next_get(rtk_uint32 * pAddress,
					       rtk_mac_t * pMac,
					       rtk_data_t * pIvl,
					       rtk_data_t * pCvid_fid,
					       rtk_portmask_t * pPortmask);
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_del(rtk_mac_t * pMac, rtk_data_t ivl,
					  rtk_data_t cvid_fid);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_add(ipaddr_t sip, ipaddr_t dip,
					    rtk_portmask_t portmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_get(ipaddr_t sip, ipaddr_t dip,
					    rtk_portmask_t * pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_next_get(rtk_uint32 * pAddress,
						 ipaddr_t * pSip,
						 ipaddr_t * pDip,
						 rtk_portmask_t * pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_flushType_set(rtk_l2_flushType_t type,
					  rtk_vlan_t vid, rtk_uint32 portOrTid);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_set(rtk_port_t port,
							    rtk_enable_t
							    enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_get(rtk_port_t port,
							    rtk_enable_t *
							    pEnable);
 ...
 */
extern rtk_api_ret_t rtk_l2_agingEnable_set(rtk_port_t port,
					    rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_l2_agingEnable_get(rtk_port_t port,
					    rtk_enable_t * pEnable);
 ...
 *      to 8k.
 */
extern rtk_api_ret_t rtk_l2_limitLearningCnt_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_l2_limitLearningCnt_get(rtk_port_t port,
						 rtk_mac_cnt_t * pMac_cnt);
 ...
 */
extern rtk_api_ret_t rtk_l2_limitLearningCntAction_set(rtk_port_t port,
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtk_api_ret_t rtk_l2_limitLearningCntAction_get(rtk_port_t port,
						       rtk_l2_limitLearnCntAction_t
						       * pAction);
 ...
 */
extern rtk_api_ret_t rtk_l2_learningCnt_get(rtk_port_t port,
					    rtk_mac_cnt_t * pMac_cnt);
 ...
 *      - FLOOD_BC
 */
extern rtk_api_ret_t rtk_l2_floodPortMask_set(rtk_l2_flood_type_t floood_type,
 ...
 *      - FLOOD_BC
 */
extern rtk_api_ret_t rtk_l2_floodPortMask_get(rtk_l2_flood_type_t floood_type,
 ...
 */
extern rtk_api_ret_t rtk_l2_localPktPermit_set(rtk_port_t port,
					       rtk_enable_t permit);
 ...
 */
extern rtk_api_ret_t rtk_l2_localPktPermit_get(rtk_port_t port,
					       rtk_enable_t * pPermit);
 ...
 *      contain accept SVID in S-tag field.
 */
extern rtk_api_ret_t rtk_svlan_servicePort_get(rtk_portmask_t *
					       pSvlan_portmask);
 ...
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_set(rtk_uint32 svid_idx,
 ...
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_get(rtk_uint32 svid_idx,
						   rtk_svlan_memberCfg_t *
						   pSvlan_cfg);
 ...
 *      - rtk_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_adv_set(rtk_uint32 idx,
						       rtk_svlan_memberCfg_t *
						       pSvlan_cfg);
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_adv_get(rtk_uint32 idx,
						       rtk_svlan_memberCfg_t *
						       pSvlan_cfg);
 ...
 */
extern rtk_api_ret_t rtk_svlan_defaultSvlan_set(rtk_port_t port,
						rtk_vlan_t svid);
 ...
 *      is transmit through uplink port with s-tag field
 */
extern rtk_api_ret_t rtk_svlan_defaultSvlan_get(rtk_port_t port,
						rtk_vlan_t * pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_c2s_add(rtk_vlan_t vid, rtk_port_t src_port,
				       rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_c2s_get(rtk_vlan_t vid, rtk_port_t src_port,
				       rtk_vlan_t * pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_untag_action_set(rtk_svlan_untag_action_t action,
						rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_untag_action_get(rtk_svlan_untag_action_t *
						pAction, rtk_vlan_t * pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_unmatch_action_set(rtk_svlan_unmatch_action_t
						  action, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_unmatch_action_get(rtk_svlan_unmatch_action_t *
						  pAction, rtk_vlan_t * pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_dmac_vidsel_set(rtk_port_t port,
					       rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_svlan_dmac_vidsel_get(rtk_port_t port,
					       rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_svlan_sp2c_add(rtk_vlan_t svid, rtk_port_t dst_port,
					rtk_vlan_t cvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_sp2c_get(rtk_vlan_t svid, rtk_port_t dst_port,
					rtk_vlan_t * pCvid);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtk_api_ret_t rtk_cpu_tagPort_set(rtk_port_t port,
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtk_api_ret_t rtk_cpu_tagPort_get(rtk_port_t * pPort,
					 rtk_cpu_insert_t * pMode);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_unauthPacketOper_set(rtk_port_t port,
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtk_api_ret_t rtk_dot1x_unauthPacketOper_get(rtk_port_t port,
						    rtk_dot1x_unauth_action_t *
						    pUnauth_action);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_portBasedEnable_set(rtk_port_t port,
						   rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedEnable_get(rtk_port_t port,
						   rtk_enable_t * pEnable);
 ...
 *      - AUTH
 */
extern rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_get(rtk_port_t port,
						       rtk_dot1x_auth_status_t *
						       pPort_auth);
 ...
 *      - IN
 */
extern rtk_api_ret_t rtk_dot1x_portBasedDirection_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedDirection_get(rtk_port_t port,
						      rtk_dot1x_direction_t *
						      pPort_direction);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_macBasedEnable_set(rtk_port_t port,
						  rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_macBasedEnable_get(rtk_port_t port,
						  rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedAuthMac_add(rtk_port_t port,
						   rtk_mac_t * pAuth_mac,
						   rtk_fid_t fid);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedAuthMac_del(rtk_port_t port,
						   rtk_mac_t * pAuth_mac,
						   rtk_fid_t fid);
 ...
 *      - IN
 */
extern rtk_api_ret_t rtk_dot1x_macBasedDirection_set(rtk_dot1x_direction_t
						     mac_direction);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedDirection_get(rtk_dot1x_direction_t *
						     pMac_direction);
 ...
 */
extern rtk_api_ret_t rtk_trunk_port_set(rtk_trunk_group_t trk_gid,
 ...
 *      - TRUNK_GROUP1: port 4 to port 7.
 */
extern rtk_api_ret_t rtk_trunk_port_get(rtk_trunk_group_t trk_gid,
					rtk_portmask_t *
 ...
 */
extern rtk_api_ret_t rtk_trunk_distributionAlgorithm_set(rtk_trunk_group_t
							 trk_gid,
 ...
 */
extern rtk_api_ret_t rtk_trunk_distributionAlgorithm_get(rtk_trunk_group_t
							 trk_gid,
							 rtk_trunk_hashVal2Port_t
							 * pAlgo_bitmask);
 ...
 *      should be identical.
 */
extern rtk_api_ret_t rtk_mirror_portBased_set(rtk_port_t mirroring_port,
					      rtk_portmask_t *
 ...
 */
extern rtk_api_ret_t rtk_mirror_portBased_get(rtk_port_t * pMirroring_port,
					      rtk_portmask_t *
					      pMirrored_rx_portmask,
					      rtk_portmask_t *
					      pMirrored_tx_portmask);
...
extern rtk_api_ret_t rtk_stat_port_get(rtk_port_t port,
				       rtk_stat_port_type_t cntr_idx,
				       rtk_stat_counter_t * pCntrH,
				       rtk_stat_counter_t * pCntrL);
extern rtk_api_ret_t rtk_stat_global_get(rtk_stat_global_type_t cntr_idx,
					 rtk_stat_counter_t * pCntrH,
					 rtk_stat_counter_t * pCntrL);
#else
 ...
 */
extern rtk_api_ret_t rtk_stat_global_getAll(rtk_stat_global_cntr_t *
					    pGlobal_cntrs);
 ...
 */
extern rtk_api_ret_t rtk_stat_port_getAll(rtk_port_t port,
 ...
 *      Set the type and mode of Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counterCfg_set(rtk_uint32 idx,
 ...
 *      Get the type and mode of Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counterCfg_get(rtk_uint32 idx,
						     rtk_logging_counter_mode_t
						     * pMode,
						     rtk_logging_counter_type_t
						     * pType);
 ...
 *      Get Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counter_get(rtk_uint32 idx,
						  rtk_uint32 * pCnt);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtk_api_ret_t rtk_int_control_set(rtk_int_type_t type,
					 rtk_enable_t enable);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtk_api_ret_t rtk_int_control_get(rtk_int_type_t type,
					 rtk_enable_t * pEnable);
 ...
 *      The status will be cleared after execute this API.
 */
extern rtk_api_ret_t rtk_int_advanceInfo_get(rtk_int_advType_t adv_type,
					     rtk_int_info_t * info);
 ...
 */
extern rtk_api_ret_t rtk_led_enable_set(rtk_led_group_t group,
					rtk_portmask_t portmask);
 ...
 */
extern rtk_api_ret_t rtk_led_enable_get(rtk_led_group_t group,
					rtk_portmask_t * pPortmask);
 ...
 *      - LED_FORCE_ON.
 */
extern rtk_api_ret_t rtk_led_modeForce_set(rtk_led_group_t group,
 ...
 *      - LED_FORCE_ON.
 */
extern rtk_api_ret_t rtk_led_modeForce_get(rtk_led_group_t group,
 ...
 */
extern rtk_api_ret_t rtk_led_groupConfig_get(rtk_led_group_t group,
					     rtk_led_congig_t * pConfig);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_add(rtk_filter_cfg_t * pFilter_cfg,
						 rtk_filter_field_t *
						 pFilter_field);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_add(rtk_filter_id_t filter_id,
 ...
 *      This function delete all ACL configuration from ASIC.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_get(rtk_filter_id_t filter_id,
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_unmatchAction_set(rtk_port_t port,
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_unmatchAction_get(rtk_port_t port,
							 rtk_filter_unmatch_action_t
							 * action);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_state_set(rtk_port_t port,
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_state_get(rtk_port_t port,
						 rtk_filter_state_t * state);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_template_set(rtk_filter_template_t *
						    aclTemplate);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_template_get(rtk_filter_template_t *
						    aclTemplate);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_sel_set(rtk_uint32 index,
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_sel_get(rtk_uint32 index,
						     rtk_field_sel_t * pFormat,
						     rtk_uint32 * pOffset);
 ...
 */
extern rtk_api_ret_t rtk_filter_iprange_set(rtk_uint32 index,
					    rtk_filter_iprange_t type,
					    ipaddr_t upperIp, ipaddr_t lowerIp);
 ...
 *      upperIp must be larger or equal than lowerIp.
 */
extern rtk_api_ret_t rtk_filter_iprange_get(rtk_uint32 index,
 ...
 */
extern rtk_api_ret_t rtk_filter_vidrange_set(rtk_uint32 index,
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_vidrange_get(rtk_uint32 index,
					     rtk_filter_vidrange_t * pType,
					     rtk_uint32 * pUpperVid,
					     rtk_uint32 * pLowerVid);
 ...
 */
extern rtk_api_ret_t rtk_filter_portrange_set(rtk_uint32 index,
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_portrange_get(rtk_uint32 index,
					      rtk_filter_portrange_t * pType,
					      rtk_uint32 * pUpperPort,
					      rtk_uint32 * pLowerPort);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_eee_portEnable_set(rtk_port_t port,
					    rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_eee_portEnable_get(rtk_port_t port,
					    rtk_enable_t * pEnable);
 ...
 */
extern rtk_api_ret_t rtk_igmp_static_router_port_get(rtk_portmask_t *
						     pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_igmp_protocol_set(rtk_port_t port,
 ...
 *      This API set IGMP/MLD protocol action
 */
extern rtk_api_ret_t rtk_igmp_protocol_get(rtk_port_t port,
					   rtk_igmp_protocol_t protocol,
 ...
 */
extern rtk_api_ret_t rtk_igmp_maxGroup_get(rtk_port_t port,
					   rtk_uint32 * pGroup);
 ...
 */
extern rtk_api_ret_t rtk_igmp_currentGroup_get(rtk_port_t port,
					       rtk_uint32 * pGroup);
