...
extern "C" {
	...
	extern ret_t rtl8367b_setAsicRegBit(rtk_uint32 reg, rtk_uint32 bit,
					    rtk_uint32 value);
	extern ret_t rtl8367b_getAsicRegBit(rtk_uint32 reg, rtk_uint32 bit,
					    rtk_uint32 * pValue);

	extern ret_t rtl8367b_setAsicRegBits(rtk_uint32 reg, rtk_uint32 bits,
					     rtk_uint32 value);
	extern ret_t rtl8367b_getAsicRegBits(rtk_uint32 reg, rtk_uint32 bits,
					     rtk_uint32 * pValue);
