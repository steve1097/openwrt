...
extern ret_t rtl8367b_setAsicAclUnmatchedPermit(rtk_uint32 port,
						rtk_uint32 enabled);
extern ret_t rtl8367b_getAsicAclUnmatchedPermit(rtk_uint32 port,
						rtk_uint32 * pEnabled);
extern ret_t rtl8367b_setAsicAclRule(rtk_uint32 index,
				     rtl8367b_aclrule * pAclRule);
extern ret_t rtl8367b_getAsicAclRule(rtk_uint32 index,
				     rtl8367b_aclrule * pAclRule);
...
extern ret_t rtl8367b_setAsicAclTemplate(rtk_uint32 index,
					 rtl8367b_acltemplate_t * pAclType);
extern ret_t rtl8367b_getAsicAclTemplate(rtk_uint32 index,
					 rtl8367b_acltemplate_t * pAclType);
extern ret_t rtl8367b_setAsicAclAct(rtk_uint32 index,
				    rtl8367b_acl_act_t * pAclAct);
extern ret_t rtl8367b_getAsicAclAct(rtk_uint32 index,
				    rtl8367b_acl_act_t * pAclAct);
extern ret_t rtl8367b_setAsicAclActCtrl(rtk_uint32 index,
					rtk_uint32 aclActCtrl);
extern ret_t rtl8367b_getAsicAclActCtrl(rtk_uint32 index,
					rtk_uint32 * aclActCtrl);
extern ret_t rtl8367b_setAsicAclPortRange(rtk_uint32 index, rtk_uint32 type,
					  rtk_uint32 upperPort,
					  rtk_uint32 lowerPort);
extern ret_t rtl8367b_getAsicAclPortRange(rtk_uint32 index, rtk_uint32 * pType,
					  rtk_uint32 * pUpperPort,
					  rtk_uint32 * pLowerPort);
extern ret_t rtl8367b_setAsicAclVidRange(rtk_uint32 index, rtk_uint32 type,
					 rtk_uint32 upperVid,
					 rtk_uint32 lowerVid);
extern ret_t rtl8367b_getAsicAclVidRange(rtk_uint32 index, rtk_uint32 * pType,
					 rtk_uint32 * pUpperVid,
					 rtk_uint32 * pLowerVid);
extern ret_t rtl8367b_setAsicAclIpRange(rtk_uint32 index, rtk_uint32 type,
					ipaddr_t upperIp, ipaddr_t lowerIp);
extern ret_t rtl8367b_getAsicAclIpRange(rtk_uint32 index, rtk_uint32 * pType,
					ipaddr_t * pUpperIp,
					ipaddr_t * pLowerIp);
