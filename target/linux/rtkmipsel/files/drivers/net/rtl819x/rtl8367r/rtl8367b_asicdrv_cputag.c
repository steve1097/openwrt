...
ret_t rtl8367b_setAsicCputagEnable(rtk_uint32 enabled)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_EN_OFFSET, enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_EN_OFFSET, pEnabled);
}
...
ret_t rtl8367b_setAsicCputagTrapPort(rtk_uint32 port)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_CPU_CTRL,
				       RTL8367B_CPU_TRAP_PORT_MASK, port);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_CPU_CTRL,
				       RTL8367B_CPU_TRAP_PORT_MASK, pPort);
}
...
ret_t rtl8367b_setAsicCputagInsertMode(rtk_uint32 mode)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_CPU_CTRL,
				       RTL8367B_CPU_INSERTMODE_MASK, mode);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_CPU_CTRL,
				       RTL8367B_CPU_INSERTMODE_MASK, pMode);
}
 ...
 *     None
 */
ret_t rtl8367b_setAsicCputagPriorityRemapping(rtk_uint32 srcPri,
					      rtk_uint32 newPri)
{
	...
	return
	    rtl8367b_setAsicRegBits(RTL8367B_QOS_PRIPORITY_REMAPPING_IN_CPU_REG
				    (srcPri),
				    RTL8367B_QOS_PRIPORITY_REMAPPING_IN_CPU_MASK
				    (srcPri), newPri);
}
 ...
 *     None
 */
ret_t rtl8367b_getAsicCputagPriorityRemapping(rtk_uint32 srcPri,
					      rtk_uint32 * pNewPri)
{
	...
	return
	    rtl8367b_getAsicRegBits(RTL8367B_QOS_PRIPORITY_REMAPPING_IN_CPU_REG
				    (srcPri),
				    RTL8367B_QOS_PRIPORITY_REMAPPING_IN_CPU_MASK
				    (srcPri), pNewPri);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_TAG_POSITION_OFFSET,
				      postion);
}
...
ret_t rtl8367b_setAsicCputagMode(rtk_uint32 mode)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_TAG_FORMAT_OFFSET, mode);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_TAG_FORMAT_OFFSET, pMode);
}
...
ret_t rtl8367b_setAsicCputagRxMinLength(rtk_uint32 mode)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_REG_CPU_CTRL,
				      RTL8367B_CPU_TAG_RXBYTECOUNT_OFFSET,
				      mode);
}
