...
ret_t rtl8367b_setAsic1xPBEnConfig(rtk_uint32 port, rtk_uint32 enabled)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_DOT1X_PORT_ENABLE_REG, port,
				      enabled);
}
...
ret_t rtl8367b_getAsic1xPBEnConfig(rtk_uint32 port, rtk_uint32 * pEnabled)
{
	...
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_PORT_ENABLE_REG, port,
				      pEnabled);
}
...
ret_t rtl8367b_getAsic1xPBAuthConfig(rtk_uint32 port, rtk_uint32 * pAuth)
{
	...
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_PORT_AUTH_REG, port,
				      pAuth);
}
...
ret_t rtl8367b_setAsic1xPBOpdirConfig(rtk_uint32 port, rtk_uint32 opdir)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_DOT1X_PORT_OPDIR_REG, port,
				      opdir);
}
...
ret_t rtl8367b_getAsic1xPBOpdirConfig(rtk_uint32 port, rtk_uint32 * pOpdir)
{
	...
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_PORT_OPDIR_REG, port,
				      pOpdir);
}
...
ret_t rtl8367b_setAsic1xMBEnConfig(rtk_uint32 port, rtk_uint32 enabled)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_DOT1X_MAC_ENABLE_REG, port,
				      enabled);
}
...
ret_t rtl8367b_getAsic1xMBEnConfig(rtk_uint32 port, rtk_uint32 * pEnabled)
{
	...
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_MAC_ENABLE_REG, port,
				      pEnabled);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_DOT1X_CFG_REG,
				      RTL8367B_DOT1X_MAC_OPDIR_OFFSET, opdir);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_CFG_REG,
				      RTL8367B_DOT1X_MAC_OPDIR_OFFSET, pOpdir);
}
...
ret_t rtl8367b_setAsic1xProcConfig(rtk_uint32 port, rtk_uint32 proc)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_DOT1X_UNAUTH_ACT_BASE,
				       RTL8367B_DOT1X_UNAUTH_ACT_MASK(port),
				       proc);
}
...
ret_t rtl8367b_setAsic1xGuestVidx(rtk_uint32 index)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_DOT1X_CFG_REG,
				       RTL8367B_DOT1X_GVIDX_MASK, index);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_DOT1X_CFG_REG,
				       RTL8367B_DOT1X_GVIDX_MASK, pIndex);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_DOT1X_CFG_REG,
				      RTL8367B_DOT1X_GVOPDIR_OFFSET, enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_DOT1X_CFG_REG,
				      RTL8367B_DOT1X_GVOPDIR_OFFSET, pEnabled);
}
...
ret_t rtl8367b_setAsic1xTrapPriority(rtk_uint32 priority)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_QOS_TRAP_PRIORITY0,
				       RTL8367B_DOT1X_PRIORTY_MASK, priority);
}
...
ret_t rtl8367b_getAsic1xTrapPriority(rtk_uint32 * pPriority)
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_QOS_TRAP_PRIORITY0,
				       RTL8367B_DOT1X_PRIORTY_MASK, pPriority);
}
