...
extern ret_t rtl8367b_setAsicEavPriRemapping(rtk_uint32 srcpriority,
					     rtk_uint32 priority);
extern ret_t rtl8367b_getAsicEavPriRemapping(rtk_uint32 srcpriority,
...
extern ret_t rtl8367b_getAsicEavTimeSyncEn(rtk_uint32 port,
					   rtk_uint32 * pEnabled);
extern ret_t rtl8367b_setAsicEavTimeStampFillEn(rtk_uint32 port,
						rtk_uint32 enabled);
extern ret_t rtl8367b_getAsicEavTimeStampFillEn(rtk_uint32 port,
						rtk_uint32 * pEnabled);
extern ret_t rtl8367b_getAsicEavTimeSyncValid(rtk_uint32 port,
					      rtk_uint32 * pValid);
extern ret_t rtl8367b_getAsicEavEgressTimestampSeccond(rtk_uint32 port,
						       rtk_uint32 * pSecond);
extern ret_t rtl8367b_getAsicEavEgressTimestamp512ns(rtk_uint32 port,
						     rtk_uint32 * pNs);
