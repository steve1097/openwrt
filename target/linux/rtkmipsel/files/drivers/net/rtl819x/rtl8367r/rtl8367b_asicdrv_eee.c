    ...
    ret_t rtl8367b_setAsicEee100M(rtk_uint32 port, rtk_uint32 enable) 
{
	...
	 return rtl8367b_setAsicRegBit(RTL8367B_PORT_EEE_CFG_REG(port),
					 RTL8367B_PORT_EEE_100M_OFFSET, enable);
    ...
    ret_t rtl8367b_getAsicEee100M(rtk_uint32 port, rtk_uint32 * enable) 
{
	...
	 return rtl8367b_getAsicRegBit(RTL8367B_PORT_EEE_CFG_REG(port),
					 RTL8367B_PORT_EEE_100M_OFFSET, enable);
    ...
    ret_t rtl8367b_setAsicEeeGiga(rtk_uint32 port, rtk_uint32 enable) 
{
					 ...
					 RTL8367B_PORT_EEE_GIGA_OFFSET, enable);
