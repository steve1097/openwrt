...
extern ret_t rtl8367b_setAsicGreenTrafficType(rtk_uint32 priority,
					      rtk_uint32 traffictype);
extern ret_t rtl8367b_getAsicGreenTrafficType(rtk_uint32 priority,
					      rtk_uint32 * pTraffictype);
extern ret_t rtl8367b_getAsicGreenPortPage(rtk_uint32 port, rtk_uint32 * pPage);
extern ret_t rtl8367b_getAsicGreenHighPriorityTraffic(rtk_uint32 port,
