...
ret_t rtl8367b_setAsicIgmp(rtk_uint32 enabled)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_EN_OFFSET, enabled);
...
ret_t rtl8367b_getAsicIgmp(rtk_uint32 * ptr_enabled)
{
	...
	retVal =
	    rtl8367b_getAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_EN_OFFSET, ptr_enabled);
	return retVal;
}
...
ret_t rtl8367b_setAsicIpMulticastVlanLeaky(rtk_uint32 port, rtk_uint32 enabled)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IPMCAST_VLAN_LEAKY, port,
				   enabled);
 ...
 *      None
 */
ret_t rtl8367b_getAsicIpMulticastVlanLeaky(rtk_uint32 port,
					   rtk_uint32 * ptr_enabled)
{
	ret_t retVal;
	...
	retVal =
	    rtl8367b_getAsicRegBit(RTL8367B_REG_IPMCAST_VLAN_LEAKY, port,
				   ptr_enabled);
...
ret_t rtl8367b_setAsicIGMPTableFullOP(rtk_uint32 operation)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG1,
				    RTL8367B_TABLE_FULL_OP_MASK, operation);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPTableFullOP(rtk_uint32 * poperation)
{
	...
	/* Table full Operation */
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG1,
				    RTL8367B_TABLE_FULL_OP_MASK, &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPCRCErrOP(rtk_uint32 operation)
{
	...
	/* CRC Error Operation */
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_CKS_ERR_OP_MASK, operation);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPCRCErrOP(rtk_uint32 * poperation)
{
	...
	/* CRC Error Operation */
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_CKS_ERR_OP_MASK, &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPFastLeaveEn(rtk_uint32 * penabled)
{
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_FAST_LEAVE_EN_MASK, &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPLeaveTimer(rtk_uint32 leave_timer)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_LEAVE_TIMER_MASK, leave_timer);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPLeaveTimer(rtk_uint32 * pleave_timer)
{
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_LEAVE_TIMER_MASK, &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPRobVar(rtk_uint32 rob_var)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_ROBURSTNESS_VAR_MASK, rob_var);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPRobVar(rtk_uint32 * prob_var)
{
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_ROBURSTNESS_VAR_MASK, &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPStaticRouterPort(rtk_uint32 pmsk)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_STATIC_ROUTER_PORT,
				       RTL8367B_IGMP_STATIC_ROUTER_PORT_MASK,
				       pmsk);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_STATIC_ROUTER_PORT,
				       RTL8367B_IGMP_STATIC_ROUTER_PORT_MASK,
				       pmsk);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicIGMPdynamicRouterPort1(rtk_uint32 * port,
					     rtk_uint32 * timer)
{
	ret_t retVal;

	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_DYNAMIC_ROUTER_PORT,
				    RTL8367B_D_ROUTER_PORT_1_MASK, port);
	if (retVal != RT_ERR_OK)
		return retVal;

	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_DYNAMIC_ROUTER_PORT,
				    RTL8367B_D_ROUTER_PORT_TMR_1_MASK, timer);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_getAsicIGMPdynamicRouterPort2(rtk_uint32 * port,
					     rtk_uint32 * timer)
{
	ret_t retVal;
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_DYNAMIC_ROUTER_PORT,
				    RTL8367B_D_ROUTER_PORT_2_MASK, port);
	if (retVal != RT_ERR_OK)
		return retVal;

	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_DYNAMIC_ROUTER_PORT,
				    RTL8367B_D_ROUTER_PORT_TMR_2_MASK, timer);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_setAsicIGMPSuppression(rtk_uint32 report_supp_enabled,
				      rtk_uint32 leave_supp_enabled)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_REPORT_SUPPRESSION_MASK,
				    report_supp_enabled);
	if (retVal != RT_ERR_OK)
		return retVal;
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_MLD_CFG0,
				    RTL8367B_LEAVE_SUPPRESSION_MASK,
				    leave_supp_enabled);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_getAsicIGMPSuppression(rtk_uint32 * report_supp_enabled,
				      rtk_uint32 * leave_supp_enabled)
{
	ret_t retVal;
...
ret_t rtl8367b_setAsicIGMPQueryRX(rtk_uint32 port, rtk_uint32 allow_query)
{
	...
	/* Allow Query */
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_QUERY_MASK,
				    allow_query);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPQueryRX(rtk_uint32 port, rtk_uint32 * allow_query)
{
	...
	/* Allow Query */
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_QUERY_MASK,
				    &value);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPReportRX(rtk_uint32 port, rtk_uint32 allow_report)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_REPORT_MASK,
				    allow_report);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPLeaveRX(rtk_uint32 port, rtk_uint32 allow_leave)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_LEAVE_MASK,
				    allow_leave);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPMRPRX(rtk_uint32 port, rtk_uint32 allow_mrp)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_MRP_MASK,
				    allow_mrp);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPMcDataRX(rtk_uint32 port, rtk_uint32 allow_mcdata)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_ALLOW_MC_DATA_MASK,
				    allow_mcdata);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPv1Opeartion(rtk_uint32 port, rtk_uint32 igmpv1_op)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_IGMPV1_OP_MASK,
				    igmpv1_op);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPv2Opeartion(rtk_uint32 port, rtk_uint32 igmpv2_op)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_IGMPV2_OP_MASK,
				    igmpv2_op);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPv3Opeartion(rtk_uint32 port, rtk_uint32 igmpv3_op)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_IGMPV3_OP_MASK,
				    igmpv3_op);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicMLDv1Opeartion(rtk_uint32 port, rtk_uint32 mldv1_op)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_MLDv1_OP_MASK,
				    mldv1_op);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicMLDv2Opeartion(rtk_uint32 port, rtk_uint32 mldv2_op)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT0_CONTROL + port,
				    RTL8367B_IGMP_PORT0_CONTROL_MLDv2_OP_MASK,
				    mldv2_op);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPPortMAXGroup(rtk_uint32 port, rtk_uint32 max_group)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_IGMP_PORT01_MAX_GROUP +
				       (port / 2),
				       RTL8367B_PORT0_MAX_GROUP_MASK <<
				       (RTL8367B_PORT1_MAX_GROUP_OFFSET *
					(port % 2)), max_group);
}
...
ret_t rtl8367b_getAsicIGMPPortMAXGroup(rtk_uint32 port, rtk_uint32 * max_group)
{
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_PORT01_MAX_GROUP +
				    (port / 2),
				    RTL8367B_PORT0_MAX_GROUP_MASK <<
				    (RTL8367B_PORT1_MAX_GROUP_OFFSET *
				     (port % 2)), &value);
 ...
 *      None
 */
ret_t rtl8367b_getAsicIGMPPortCurrentGroup(rtk_uint32 port,
					   rtk_uint32 * current_group)
{
	ret_t retVal;
	rtk_uint32 value;
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_REG_IGMP_PORT01_CURRENT_GROUP +
				    (port / 2),
				    RTL8367B_PORT0_CURRENT_GROUP_MASK <<
				    (RTL8367B_PORT1_CURRENT_GROUP_OFFSET *
				     (port % 2)), &value);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_getAsicIGMPGroup(rtk_uint32 idx, rtk_uint32 * valid,
				rtl8367b_igmpgroup * grp)
{
	ret_t retVal;
	...
	regData =
	    RTL8367B_TABLE_ACCESS_REG_DATA(TB_OP_READ, TB_TARGET_IGMP_GROUP);
	retVal =
	...
	/* Valid bit */
	retVal =
	    rtl8367b_getAsicReg(RTL8367B_IGMP_GROUP_USAGE_REG(idx), &regData);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_setAsicIpMulticastPortIsoLeaky(rtk_uint32 port,
					      rtk_uint32 enabled)
{
	ret_t retVal;
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_IPMCAST_PORTISO_LEAKY_REG,
				    (0x0001 << port), enabled);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_getAsicIpMulticastPortIsoLeaky(rtk_uint32 port,
					      rtk_uint32 * enabled)
{
	ret_t retVal;
	rtk_uint32 regData;
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_IPMCAST_PORTISO_LEAKY_REG,
				    (0x0001 << port), &regData);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPReportFlood(rtk_uint32 flood)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_REPORT_FORWARD_OFFSET, flood);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPReportFlood(rtk_uint32 * pFlood)
{
	...
	retVal =
	    rtl8367b_getAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_REPORT_FORWARD_OFFSET, &regData);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPDropLeaveZero(rtk_uint32 drop)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG1,
				   RTL8367B_DROP_LEAVE_ZERO_OFFSET, drop);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPDropLeaveZero(rtk_uint32 * pDrop)
{
	...
	retVal =
	    rtl8367b_getAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG1,
				   RTL8367B_DROP_LEAVE_ZERO_OFFSET, &regData);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPBypassStormCTRL(rtk_uint32 bypass)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_DISCARD_STORM_FILTER_OFFSET,
				   bypass);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPIsoLeaky(rtk_uint32 leaky)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_PORTISO_LEAKY_OFFSET,
				   leaky);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_setAsicIGMPVLANLeaky(rtk_uint32 leaky)
{
	...
	retVal =
	    rtl8367b_setAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_VLAN_LEAKY_OFFSET, leaky);
	if (retVal != RT_ERR_OK)
		return retVal;
...
ret_t rtl8367b_getAsicIGMPVLANLeaky(rtk_uint32 * pLeaky)
{
	...
	retVal =
	    rtl8367b_getAsicRegBit(RTL8367B_REG_IGMP_MLD_CFG0,
				   RTL8367B_IGMP_MLD_VLAN_LEAKY_OFFSET,
				   &regData);
	if (retVal != RT_ERR_OK)
		return retVal;
