...
ret_t rtl8367b_getAsicIGMPdynamicRouterPort1(rtk_uint32 * pPort,
					     rtk_uint32 * pTimer);
ret_t rtl8367b_getAsicIGMPdynamicRouterPort2(rtk_uint32 * pPort,
					     rtk_uint32 * pTimer);
ret_t rtl8367b_setAsicIGMPSuppression(rtk_uint32 report_supp_enabled,
				      rtk_uint32 leave_supp_enabled);
ret_t rtl8367b_getAsicIGMPSuppression(rtk_uint32 * pReport_supp_enabled,
				      rtk_uint32 * pLeave_supp_enabled);
...
ret_t rtl8367b_getAsicIGMPPortMAXGroup(rtk_uint32 port,
				       rtk_uint32 * pMax_group);
ret_t rtl8367b_getAsicIGMPPortCurrentGroup(rtk_uint32 port,
					   rtk_uint32 * pCurrent_group);
ret_t rtl8367b_getAsicIGMPGroup(rtk_uint32 idx, rtk_uint32 * pValid,
				rtl8367b_igmpgroup * pGrp);
