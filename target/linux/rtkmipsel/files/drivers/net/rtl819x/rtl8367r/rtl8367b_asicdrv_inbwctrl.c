 ...
 *      None
 */
ret_t rtl8367b_setAsicPortIngressBandwidth(rtk_uint32 port,
					   rtk_uint32 bandwidth,
					   rtk_uint32 preifg,
					   rtk_uint32 enableFC)
{
	ret_t retVal;
	...
	regAddr += 1;
	regData =
	    (bandwidth & RTL8367B_QOS_GRANULARTY_MSB_MASK) >>
	...
	retVal =
	    rtl8367b_setAsicRegBit(regAddr,
				   RTL8367B_PORT0_MISC_CFG_INGRESSBW_IFG_OFFSET,
				   preifg);
	if (retVal != RT_ERR_OK)
		return retVal;
	...
	retVal =
	    rtl8367b_setAsicRegBit(regAddr,
				   RTL8367B_PORT0_MISC_CFG_INGRESSBW_FLOWCTRL_OFFSET,
				   enableFC);
	if (retVal != RT_ERR_OK)
		return retVal;
 ...
 *      None
 */
ret_t rtl8367b_getAsicPortIngressBandwidth(rtk_uint32 port,
					   rtk_uint32 * pBandwidth,
					   rtk_uint32 * pPreifg,
					   rtk_uint32 * pEnableFC)
{
	ret_t retVal;
	rtk_uint32 regData;
	rtk_uint32 regAddr;
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_SW_DUMMY0,
				      RTL8367B_INGRESSBW_BYPASS_EN_OFFSET,
				      enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_SW_DUMMY0,
				      RTL8367B_INGRESSBW_BYPASS_EN_OFFSET,
				      pEnabled);
}
