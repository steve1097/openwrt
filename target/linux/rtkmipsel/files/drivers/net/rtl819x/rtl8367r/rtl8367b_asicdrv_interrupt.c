...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_INTR_CTRL,
				      RTL8367B_INTR_CTRL_OFFSET, polarity);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_INTR_CTRL,
				      RTL8367B_INTR_CTRL_OFFSET, pPolarity);
}
...
{
	CONST rtk_uint32 indicatorAddress[INTRST_END] =
	    { RTL8367B_REG_LEARN_OVER_INDICATOR,
 ...
 *   	None
 */
ret_t rtl8367b_getAsicInterruptRelatedStatus(rtk_uint32 type,
					     rtk_uint32 * pStatus)
{
	CONST rtk_uint32 indicatorAddress[INTRST_END] =
	    { RTL8367B_REG_LEARN_OVER_INDICATOR,
