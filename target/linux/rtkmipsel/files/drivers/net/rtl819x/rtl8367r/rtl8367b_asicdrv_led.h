...
extern ret_t rtl8367b_setAsicLedIndicateInfoConfig(rtk_uint32 ledno,
						   rtk_uint32 config);
extern ret_t rtl8367b_getAsicLedIndicateInfoConfig(rtk_uint32 ledno,
						   rtk_uint32 * pConfig);
extern ret_t rtl8367b_setAsicForceLed(rtk_uint32 port, rtk_uint32 group,
				      rtk_uint32 mode);
extern ret_t rtl8367b_getAsicForceLed(rtk_uint32 port, rtk_uint32 group,
				      rtk_uint32 * pMode);
extern ret_t rtl8367b_setAsicForceGroupLed(rtk_uint32 groupmask,
					   rtk_uint32 mode);
extern ret_t rtl8367b_getAsicForceGroupLed(rtk_uint32 * groupmask,
					   rtk_uint32 * pMode);
...
extern ret_t rtl8367b_setAsicLedGroupEnable(rtk_uint32 group,
					    rtk_uint32 portmask);
extern ret_t rtl8367b_getAsicLedGroupEnable(rtk_uint32 group,
					    rtk_uint32 * portmask);
...
extern ret_t rtl8367b_setAsicLedSerialModeConfig(rtk_uint32 active,
						 rtk_uint32 serimode);
extern ret_t rtl8367b_getAsicLedSerialModeConfig(rtk_uint32 * active,
						 rtk_uint32 * serimode);
