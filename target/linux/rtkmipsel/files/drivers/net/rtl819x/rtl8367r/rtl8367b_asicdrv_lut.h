...
extern ret_t rtl8367b_setAsicLutAgeTimerSpeed(rtk_uint32 timer,
					      rtk_uint32 speed);
extern ret_t rtl8367b_getAsicLutAgeTimerSpeed(rtk_uint32 * pTimer,
					      rtk_uint32 * pSpeed);
...
extern ret_t rtl8367b_setAsicLutLearnLimitNo(rtk_uint32 port,
					     rtk_uint32 number);
extern ret_t rtl8367b_getAsicLutLearnLimitNo(rtk_uint32 port,
					     rtk_uint32 * pNumber);
...
extern ret_t rtl8367b_getAsicL2LookupTb(rtk_uint32 method,
					rtl8367b_luttb * pL2Table);
...
extern ret_t rtl8367b_setAsicLutDisableAging(rtk_uint32 port,
					     rtk_uint32 disabled);
extern ret_t rtl8367b_getAsicLutDisableAging(rtk_uint32 port,
					     rtk_uint32 * pDisabled);
extern ret_t rtl8367b_setAsicLutIPMCGroup(rtk_uint32 index,
					  rtk_uint32 group_addr);
extern ret_t rtl8367b_getAsicLutIPMCGroup(rtk_uint32 index,
					  rtk_uint32 * pGroup_addr);
