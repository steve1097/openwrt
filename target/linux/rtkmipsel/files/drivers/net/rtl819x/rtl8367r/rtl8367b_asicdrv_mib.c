 ...
 *      None
 */
ret_t rtl8367b_setAsicMIBsCounterReset(rtk_uint32 greset, rtk_uint32 qmreset,
				       rtk_uint32 portmask)
{
	ret_t retVal;
	rtk_uint32 regData;
	...
	regBits = RTL8367B_GLOBAL_RESET_MASK |
	    RTL8367B_QM_RESET_MASK | RTL8367B_MIB_PORT07_MASK;
	regData =
	    ((greset << RTL8367B_GLOBAL_RESET_OFFSET) &
	     RTL8367B_GLOBAL_RESET_MASK) | ((qmreset <<
					     RTL8367B_QM_RESET_OFFSET) &
					    RTL8367B_QM_RESET_MASK) |
	    (((portmask & 0xFF) << RTL8367B_PORT0_RESET_OFFSET) &
	     RTL8367B_MIB_PORT07_MASK);

	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_REG_MIB_CTRL0, regBits,
				    (regData >> RTL8367B_PORT0_RESET_OFFSET));
 ...
 */
ret_t rtl8367b_getAsicMIBsCounter(rtk_uint32 port, RTL8367B_MIBCOUNTER mibIdx,
				  rtk_uint64 * pCounter)
{
	ret_t retVal;
	rtk_uint32 regAddr;
...
ret_t rtl8367b_getAsicMIBsControl(rtk_uint32 * pMask)
{
	...
	*pMask =
	    regData & (RTL8367B_MIB_CTRL0_BUSY_FLAG_MASK |
		       RTL8367B_RESET_FLAG_MASK);
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_MIB_CTRL0,
				      RTL8367B_RESET_VALUE_OFFSET, value);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_MIB_CTRL0,
				      RTL8367B_RESET_VALUE_OFFSET, value);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_MIB_CTRL4,
				      RTL8367B_MIB_USAGE_MODE_OFFSET, mode);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_MIB_CTRL4,
				      RTL8367B_MIB_USAGE_MODE_OFFSET, pMode);
}
...
{
	return rtl8367b_setAsicRegBits(RTL8367B_REG_MIB_CTRL4,
				       RTL8367B_MIB_TIMER_MASK, timer);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_MIB_CTRL4,
				       RTL8367B_MIB_TIMER_MASK, pTimer);
}
...
ret_t rtl8367b_setAsicMIBsResetLoggingCounter(rtk_uint32 index)
{
	...
	if (index < 16)
		retVal =
		    rtl8367b_setAsicReg(RTL8367B_REG_MIB_CTRL1, 1 << index);
	else
		retVal =
		    rtl8367b_setAsicReg(RTL8367B_REG_MIB_CTRL2,
					1 << (index - 16));
