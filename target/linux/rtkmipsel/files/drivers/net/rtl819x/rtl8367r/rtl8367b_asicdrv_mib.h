...
extern ret_t rtl8367b_setAsicMIBsCounterReset(rtk_uint32 greset,
					      rtk_uint32 qmreset,
					      rtk_uint32 pmask);
extern ret_t rtl8367b_getAsicMIBsCounter(rtk_uint32 port,
					 RTL8367B_MIBCOUNTER mibIdx,
					 rtk_uint64 * pCounter);
extern ret_t rtl8367b_getAsicMIBsLogCounter(rtk_uint32 index,
					    rtk_uint32 * pCounter);
...
extern ret_t rtl8367b_getAsicMIBsLoggingMode(rtk_uint32 index,
					     rtk_uint32 * pMode);
extern ret_t rtl8367b_setAsicMIBsLoggingType(rtk_uint32 index, rtk_uint32 type);
extern ret_t rtl8367b_getAsicMIBsLoggingType(rtk_uint32 index,
					     rtk_uint32 * pType);
