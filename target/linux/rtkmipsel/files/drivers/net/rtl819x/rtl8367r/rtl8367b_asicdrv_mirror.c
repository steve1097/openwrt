...
ret_t rtl8367b_setAsicPortMirror(rtk_uint32 source, rtk_uint32 monitor)
{
	...
	retVal =
	    rtl8367b_setAsicRegBits(RTL8367B_MIRROR_CTRL_REG,
				    RTL8367B_MIRROR_SOURCE_PORT_MASK, source);
	if (retVal != RT_ERR_OK)
		return retVal;

	return rtl8367b_setAsicRegBits(RTL8367B_MIRROR_CTRL_REG,
				       RTL8367B_MIRROR_MONITOR_PORT_MASK,
				       monitor);
}
...
ret_t rtl8367b_getAsicPortMirror(rtk_uint32 * pSource, rtk_uint32 * pMonitor)
{
	...
	retVal =
	    rtl8367b_getAsicRegBits(RTL8367B_MIRROR_CTRL_REG,
				    RTL8367B_MIRROR_SOURCE_PORT_MASK, pSource);
	if (retVal != RT_ERR_OK)
		return retVal;

	return rtl8367b_getAsicRegBits(RTL8367B_MIRROR_CTRL_REG,
				       RTL8367B_MIRROR_MONITOR_PORT_MASK,
				       pMonitor);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_RX_OFFSET, enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_RX_OFFSET, pEnabled);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_TX_OFFSET, enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_TX_OFFSET, pEnabled);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_ISO_OFFSET, enabled);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_MIRROR_CTRL_REG,
				      RTL8367B_MIRROR_ISO_OFFSET, pEnabled);
}
...
ret_t rtl8367b_setAsicPortMirrorMask(rtk_uint32 SourcePortmask)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_MIRROR_SRC_PMSK,
				       RTL8367B_MIRROR_SRC_PMSK_MASK,
				       SourcePortmask);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_MIRROR_SRC_PMSK,
				       RTL8367B_MIRROR_SRC_PMSK_MASK,
				       pSourcePortmask);
}
