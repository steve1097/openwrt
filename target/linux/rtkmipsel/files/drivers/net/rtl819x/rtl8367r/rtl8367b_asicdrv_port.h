...
extern ret_t rtl8367b_getAsicPortUnknownDaFloodingPortmask(rtk_uint32 *
							   pPortmask);
extern ret_t rtl8367b_setAsicPortUnknownMulticastFloodingPortmask(rtk_uint32
								  portmask);
extern ret_t rtl8367b_getAsicPortUnknownMulticastFloodingPortmask(rtk_uint32 *
								  pPortmask);
...
extern ret_t rtl8367b_setAsicPortForceLink(rtk_uint32 port,
					   rtl8367b_port_ability_t *
					   pPortAbility);
extern ret_t rtl8367b_getAsicPortForceLink(rtk_uint32 port,
					   rtl8367b_port_ability_t *
					   pPortAbility);
extern ret_t rtl8367b_getAsicPortStatus(rtk_uint32 port,
					rtl8367b_port_status_t * pPortStatus);
extern ret_t rtl8367b_setAsicPortForceLinkExt(rtk_uint32 id,
					      rtl8367b_port_ability_t *
					      pPortAbility);
extern ret_t rtl8367b_getAsicPortForceLinkExt(rtk_uint32 id,
					      rtl8367b_port_ability_t *
					      pPortAbility);
...
extern ret_t rtl8367b_getAsicPortSmallIpg(rtk_uint32 port,
					  rtk_uint32 * pEnable);
extern ret_t rtl8367b_setAsicPortLoopback(rtk_uint32 port, rtk_uint32 enable);
extern ret_t rtl8367b_getAsicPortLoopback(rtk_uint32 port,
					  rtk_uint32 * pEnable);
extern ret_t rtl8367b_setAsicPortRTCT(rtk_uint32 portmask);
extern ret_t rtl8367b_getAsicPortRTCTResult(rtk_uint32 port,
					    rtl8367b_port_rtct_result_t *
					    pResult);
