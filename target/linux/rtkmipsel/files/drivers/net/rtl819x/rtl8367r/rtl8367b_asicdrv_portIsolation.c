 ...
 *      None
 */
ret_t rtl8367b_setAsicPortIsolationPermittedPortmask(rtk_uint32 port,
						     rtk_uint32 permitPortmask)
{
	...
	return rtl8367b_setAsicReg(RTL8367B_PORT_ISOLATION_PORT_MASK_REG(port),
				   permitPortmask);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicPortIsolationPermittedPortmask(rtk_uint32 port,
						     rtk_uint32 *
						     pPermitPortmask)
{
	if (port >= RTL8367B_PORTNO)
	...
	return rtl8367b_getAsicReg(RTL8367B_PORT_ISOLATION_PORT_MASK_REG(port),
				   pPermitPortmask);
}
...
ret_t rtl8367b_setAsicPortIsolationEfid(rtk_uint32 port, rtk_uint32 efid)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_PORT_EFID_REG(port),
				       RTL8367B_PORT_EFID_MASK(port), efid);
}
...
ret_t rtl8367b_getAsicPortIsolationEfid(rtk_uint32 port, rtk_uint32 * pEfid)
{
	...
	return rtl8367b_getAsicRegBits(RTL8367B_PORT_EFID_REG(port),
				       RTL8367B_PORT_EFID_MASK(port), pEfid);
}
