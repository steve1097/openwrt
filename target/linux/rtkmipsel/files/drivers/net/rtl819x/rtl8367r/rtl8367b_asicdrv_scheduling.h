...
extern ret_t rtl8367b_setAsicLeakyBucketParameter(rtk_uint32 tick,
						  rtk_uint32 token);
extern ret_t rtl8367b_getAsicLeakyBucketParameter(rtk_uint32 * tick,
						  rtk_uint32 * token);
extern ret_t rtl8367b_setAsicAprMeter(rtk_uint32 port, rtk_uint32 qid,
				      rtk_uint32 apridx);
extern ret_t rtl8367b_getAsicAprMeter(rtk_uint32 port, rtk_uint32 qid,
				      rtk_uint32 * apridx);
extern ret_t rtl8367b_setAsicPprMeter(rtk_uint32 port, rtk_uint32 qid,
				      rtk_uint32 ppridx);
extern ret_t rtl8367b_getAsicPprMeter(rtk_uint32 port, rtk_uint32 qid,
				      rtk_uint32 * ppridx);
...
extern ret_t rtl8367b_setAsicWFQWeight(rtk_uint32, rtk_uint32 queueid,
				       rtk_uint32 weight);
extern ret_t rtl8367b_getAsicWFQWeight(rtk_uint32, rtk_uint32 queueid,
				       rtk_uint32 * weight);
...
extern ret_t rtl8367b_setAsicQueueType(rtk_uint32 port, rtk_uint32 qid,
				       rtk_uint32 queueType);
extern ret_t rtl8367b_getAsicQueueType(rtk_uint32 port, rtk_uint32 qid,
				       rtk_uint32 * queueType);
extern ret_t rtl8367b_setAsicQueueRate(rtk_uint32 port, rtk_uint32 qid,
				       rtk_uint32 ppridx, rtk_uint32 apridx);
extern ret_t rtl8367b_getAsicQueueRate(rtk_uint32 port, rtk_uint32 qid,
				       rtk_uint32 * ppridx,
				       rtk_uint32 * apridx);
