 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterBroadcastEnable(rtk_uint32 port,
						 rtk_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterBroadcastEnable(rtk_uint32 port,
						 rtk_uint32 * pEnabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterBroadcastMeter(rtk_uint32 port,
						rtk_uint32 meter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_setAsicRegBits(RTL8367B_STORM_BCAST_METER_CTRL_REG(port),
				    RTL8367B_STORM_BCAST_METER_CTRL_MASK(port),
				    meter);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterBroadcastMeter(rtk_uint32 port,
						rtk_uint32 * pMeter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_getAsicRegBits(RTL8367B_STORM_BCAST_METER_CTRL_REG(port),
				    RTL8367B_STORM_BCAST_METER_CTRL_MASK(port),
				    pMeter);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterMulticastEnable(rtk_uint32 port,
						 rtk_uint32 enabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterMulticastEnable(rtk_uint32 port,
						 rtk_uint32 * pEnabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterMulticastMeter(rtk_uint32 port,
						rtk_uint32 meter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_setAsicRegBits(RTL8367B_STORM_MCAST_METER_CTRL_REG(port),
				    RTL8367B_STORM_MCAST_METER_CTRL_MASK(port),
				    meter);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterMulticastMeter(rtk_uint32 port,
						rtk_uint32 * pMeter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_getAsicRegBits(RTL8367B_STORM_MCAST_METER_CTRL_REG(port),
				    RTL8367B_STORM_MCAST_METER_CTRL_MASK(port),
				    pMeter);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterUnknownMulticastEnable(rtk_uint32 port,
							rtk_uint32 enabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_setAsicRegBit(RTL8367B_STORM_UNKNOWN_MCAST_REG, port,
				      enabled);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterUnknownMulticastEnable(rtk_uint32 port,
							rtk_uint32 * pEnabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_getAsicRegBit(RTL8367B_STORM_UNKNOWN_MCAST_REG, port,
				      pEnabled);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterUnknownMulticastMeter(rtk_uint32 port,
						       rtk_uint32 meter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return rtl8367b_setAsicRegBits(RTL8367B_STORM_UNMC_METER_CTRL_REG(port),
				       RTL8367B_STORM_UNMC_METER_CTRL_MASK
				       (port), meter);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterUnknownMulticastMeter(rtk_uint32 port,
						       rtk_uint32 * pMeter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_getAsicRegBits(RTL8367B_STORM_UNMC_METER_CTRL_REG(port),
				       RTL8367B_STORM_UNMC_METER_CTRL_MASK
				       (port), pMeter);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterUnknownUnicastEnable(rtk_uint32 port,
						      rtk_uint32 enabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_setAsicRegBit(RTL8367B_STORM_UNKNOWN_UCAST_REG, port,
				      enabled);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterUnknownUnicastEnable(rtk_uint32 port,
						      rtk_uint32 * pEnabled)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_getAsicRegBit(RTL8367B_STORM_UNKNOWN_UCAST_REG, port,
				      pEnabled);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicStormFilterUnknownUnicastMeter(rtk_uint32 port,
						     rtk_uint32 meter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
	...
	return rtl8367b_setAsicRegBits(RTL8367B_STORM_UNDA_METER_CTRL_REG(port),
				       RTL8367B_STORM_UNDA_METER_CTRL_MASK
				       (port), meter);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicStormFilterUnknownUnicastMeter(rtk_uint32 port,
						     rtk_uint32 * pMeter)
{
	if (port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;

	return rtl8367b_getAsicRegBits(RTL8367B_STORM_UNDA_METER_CTRL_REG(port),
				       RTL8367B_STORM_UNDA_METER_CTRL_MASK
				       (port), pMeter);
}
