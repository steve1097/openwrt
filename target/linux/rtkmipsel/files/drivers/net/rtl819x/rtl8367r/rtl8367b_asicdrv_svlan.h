...
extern ret_t rtl8367b_setAsicSvlanDefaultVlan(rtk_uint32 port,
					      rtk_uint32 index);
extern ret_t rtl8367b_getAsicSvlanDefaultVlan(rtk_uint32 port,
					      rtk_uint32 * pIndex);

extern ret_t rtl8367b_setAsicSvlanMemberConfiguration(rtk_uint32 index,
						      rtl8367b_svlan_memconf_t *
						      pSvlanMemCfg);
extern ret_t rtl8367b_getAsicSvlanMemberConfiguration(rtk_uint32 index,
						      rtl8367b_svlan_memconf_t *
						      pSvlanMemCfg);
...
extern ret_t rtl8367b_setAsicSvlanC2SConf(rtk_uint32 index, rtk_uint32 evid,
					  rtk_uint32 portmask,
					  rtk_uint32 svidx);
extern ret_t rtl8367b_getAsicSvlanC2SConf(rtk_uint32 index, rtk_uint32 * pEvid,
					  rtk_uint32 * pPortmask,
					  rtk_uint32 * pSvidx);
extern ret_t rtl8367b_setAsicSvlanMC2SConf(rtk_uint32 index,
					   rtl8367b_svlan_mc2s_t *
					   pSvlanMc2sCfg);
extern ret_t rtl8367b_getAsicSvlanMC2SConf(rtk_uint32 index,
					   rtl8367b_svlan_mc2s_t *
					   pSvlanMc2sCfg);
extern ret_t rtl8367b_setAsicSvlanSP2CConf(rtk_uint32 index,
					   rtl8367b_svlan_s2c_t *
					   pSvlanSp2cCfg);
extern ret_t rtl8367b_getAsicSvlanSP2CConf(rtk_uint32 index,
					   rtl8367b_svlan_s2c_t *
					   pSvlanSp2cCfg);
extern ret_t rtl8367b_setAsicSvlanDmacCvidSel(rtk_uint32 port,
					      rtk_uint32 enabled);
extern ret_t rtl8367b_getAsicSvlanDmacCvidSel(rtk_uint32 port,
					      rtk_uint32 * pEnabled);
