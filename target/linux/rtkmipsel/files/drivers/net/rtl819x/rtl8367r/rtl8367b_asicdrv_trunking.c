...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_PORT_TRUNK_CTRL,
				      RTL8367B_PORT_TRUNK_DUMB_OFFSET, mode);
}
...
{
	return rtl8367b_getAsicRegBit(RTL8367B_REG_PORT_TRUNK_CTRL,
				      RTL8367B_PORT_TRUNK_DUMB_OFFSET, pMode);
}
...
ret_t rtl8367b_setAsicTrunkingFc(rtk_uint32 group, rtk_uint32 enabled)
{
	...
	return rtl8367b_setAsicRegBit(RTL8367B_REG_PORT_TRUNK_FLOWCTRL,
				      (RTL8367B_EN_FLOWCTRL_TG0_OFFSET + group),
				      enabled);
}
...
ret_t rtl8367b_getAsicTrunkingFc(rtk_uint32 group, rtk_uint32 * pEnabled)
{
	...
	return rtl8367b_getAsicRegBit(RTL8367B_REG_PORT_TRUNK_FLOWCTRL,
				      (RTL8367B_EN_FLOWCTRL_TG0_OFFSET + group),
				      pEnabled);
}
...
ret_t rtl8367b_setAsicTrunkingGroup(rtk_uint32 group, rtk_uint32 portmask)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_REG_PORT_TRUNK_GROUP_MASK,
				       RTL8367B_PORT_TRUNK_GROUP0_MASK_MASK <<
				       (group * 4), portmask);
}
...
ret_t rtl8367b_getAsicTrunkingGroup(rtk_uint32 group, rtk_uint32 * pPortmask)
{
	...
	return rtl8367b_getAsicRegBits(RTL8367B_REG_PORT_TRUNK_GROUP_MASK,
				       RTL8367B_PORT_TRUNK_GROUP0_MASK_MASK <<
				       (group * 4), pPortmask);
}
...
{
	return rtl8367b_setAsicRegBit(RTL8367B_REG_PORT_TRUNK_CTRL,
				      RTL8367B_PORT_TRUNK_FLOOD_OFFSET,
				      enabled);
}
...
{
	return rtl8367b_setAsicRegBits(RTL8367B_REG_PORT_TRUNK_CTRL,
				       RTL8367B_PORT_TRUNK_HASH_MASK, hashsel);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367B_REG_PORT_TRUNK_CTRL,
				       RTL8367B_PORT_TRUNK_HASH_MASK, pHashsel);
}
...
ret_t rtl8367b_setAsicTrunkingHashTable(rtk_uint32 hashval, rtk_uint32 portId)
{
	...
	if (hashval >= 8)
		return
		    ...
		    (RTL8367B_REG_PORT_TRUNK_HASH_MAPPING_CTRL1,
		     RTL8367B_HASH8_MASK << ((hashval - 8) * 2), portId);
	else
		return
		    rtl8367b_setAsicRegBits
		    (RTL8367B_REG_PORT_TRUNK_HASH_MAPPING_CTRL0,
		     RTL8367B_HASH0_MASK << (hashval * 2), portId);
}
 ...
 *    	None
 */
ret_t rtl8367b_getAsicTrunkingHashTable(rtk_uint32 hashval,
					rtk_uint32 * pPortId)
{
	if (hashval > RTL8367B_TRUNKING_HASHVALUE_MAX)
		return RT_ERR_OUT_OF_RANGE;
	...
	if (hashval >= 8)
		return
		    ...
		    (RTL8367B_REG_PORT_TRUNK_HASH_MAPPING_CTRL1,
		     RTL8367B_HASH8_MASK << ((hashval - 8) * 2), pPortId);
	else
		return
		    rtl8367b_getAsicRegBits
		    (RTL8367B_REG_PORT_TRUNK_HASH_MAPPING_CTRL0,
		     RTL8367B_HASH0_MASK << (hashval * 2), pPortId);
}
