...
extern ret_t rtl8367b_setAsicTrunkingGroup(rtk_uint32 group,
					   rtk_uint32 portmask);
extern ret_t rtl8367b_getAsicTrunkingGroup(rtk_uint32 group,
...
extern ret_t rtl8367b_getAsicTrunkingFc(rtk_uint32 group,
					rtk_uint32 * pEnabled);
extern ret_t rtl8367b_setAsicTrunkingHashTable(rtk_uint32 hashval,
					       rtk_uint32 portId);
extern ret_t rtl8367b_getAsicTrunkingHashTable(rtk_uint32 hashval,
					       rtk_uint32 * pPortId);
