 ...
 *      None
 */
ret_t rtl8367b_setAsicUnknownL2MulticastBehavior(rtk_uint32 port,
						 rtk_uint32 behave)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367B_UNKNOWN_L2_MULTICAST_REG(port),
				       RTL8367B_UNKNOWN_L2_MULTICAST_MASK(port),
				       behave);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicUnknownL2MulticastBehavior(rtk_uint32 port,
						 rtk_uint32 * pBehave)
{
	if (port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;

	return rtl8367b_getAsicRegBits(RTL8367B_UNKNOWN_L2_MULTICAST_REG(port),
				       RTL8367B_UNKNOWN_L2_MULTICAST_MASK(port),
				       pBehave);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicUnknownIPv4MulticastBehavior(rtk_uint32 port,
						   rtk_uint32 behave)
{
	if (port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_setAsicRegBits(RTL8367B_UNKNOWN_IPV4_MULTICAST_REG(port),
				    RTL8367B_UNKNOWN_IPV4_MULTICAST_MASK(port),
				    behave);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicUnknownIPv4MulticastBehavior(rtk_uint32 port,
						   rtk_uint32 * pBehave)
{
	if (port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_getAsicRegBits(RTL8367B_UNKNOWN_IPV4_MULTICAST_REG(port),
				    RTL8367B_UNKNOWN_IPV4_MULTICAST_MASK(port),
				    pBehave);
}
 ...
 *      None
 */
ret_t rtl8367b_setAsicUnknownIPv6MulticastBehavior(rtk_uint32 port,
						   rtk_uint32 behave)
{
	if (port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_setAsicRegBits(RTL8367B_UNKNOWN_IPV6_MULTICAST_REG(port),
				    RTL8367B_UNKNOWN_IPV6_MULTICAST_MASK(port),
				    behave);
}
 ...
 *      None
 */
ret_t rtl8367b_getAsicUnknownIPv6MulticastBehavior(rtk_uint32 port,
						   rtk_uint32 * pBehave)
{
	if (port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
	...
	return
	    rtl8367b_getAsicRegBits(RTL8367B_UNKNOWN_IPV6_MULTICAST_REG(port),
				    RTL8367B_UNKNOWN_IPV6_MULTICAST_MASK(port),
				    pBehave);
}
...
ret_t rtl8367b_setAsicUnknownMulticastTrapPriority(rtk_uint32 priority)
{
	...
	return rtl8367b_setAsicRegBits(RTL8367BG_QOS_TRAP_PRIORITY_CTRL0_REG,
				       RTL8367B_UNKNOWN_MC_PRIORTY_MASK,
				       priority);
}
...
{
	return rtl8367b_getAsicRegBits(RTL8367BG_QOS_TRAP_PRIORITY_CTRL0_REG,
				       RTL8367B_UNKNOWN_MC_PRIORTY_MASK,
				       pPriority);
}
