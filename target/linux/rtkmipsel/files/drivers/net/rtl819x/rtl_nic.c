...
#include <linux/rtc.h>
#if defined(CONFIG_SOC_RTL8197F) && defined(CONFIG_OPENWRT_SDK)
...
static int ethernet_rtnl_fill_ifinfo(struct sk_buff *skb,
				     struct net_device *dev, int type, u32 pid,
...
struct rtl_fastvpn_ops *rtl_fastvpn_hook = NULL;
EXPORT_SYMBOL(rtl_fastvpn_hook);
#endif
...
/* LAN interface */
	...
	{RTL_DRV_LAN_P0_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_4, RTL_LANPORT_MASK_4, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0, 0},
	{RTL_DRV_LAN_P4_NETIF_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_LAN_P1_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_3, RTL_LANPORT_MASK_3, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0, 0},
	{RTL_DRV_LAN_P2_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_2, RTL_LANPORT_MASK_2, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0, 0},
	{RTL_DRV_LAN_P3_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_1, RTL_LANPORT_MASK_1, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0, 0},
#else
	{RTL_DRV_LAN_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK, RTL_LANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0, 0},
#endif
...
*/
	...
	{RTL_DRV_WAN0_NETIF_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
#endif
	{RTL_DRV_ETHWAN1_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN2_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN3_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN4_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN5_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN6_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN7_NETIF_NAME, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},

	{RTL_DRV_ETHWAN1_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN2_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN3_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN4_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN5_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN6_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
	{RTL_DRV_ETHWAN7_NETIF_NAME_EXTEND, 1, IF_ETHER, 0, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0, 0},
...
/* PPP interface , please use rtl_add_ppp_netif() to create sw_netif (just data structure, not the actual net_device) in driver layer */
	{RTL_DRV_PPP0_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP1_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP2_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP3_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP4_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP5_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP6_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
	{RTL_DRV_PPP7_NETIF_NAME, 1, IF_PPPOE, 0, RTL_WAN_FID, RTL_WANPORT_MASK,
	 RTL_WANPORT_MASK, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1, 0},
...
/*		=====  ===   =======	===	 ===   =========   =======	====	====================================	*/
	...
	{RTL_DRV_LAN_P0_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_4, RTL_LANPORT_MASK_4, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0},
	{RTL_DRV_LAN_P4_NETIF_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0},
	{RTL_DRV_LAN_P1_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_3, RTL_LANPORT_MASK_3, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x90}}, 0},
	{RTL_DRV_LAN_P2_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	...
	{RTL_DRV_LAN_P5_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_5, RTL_LANPORT_MASK_5, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x95}}, 0},
#endif //CONFIG_8198_PORT5_GMII
#if defined(CONFIG_RTK_VLAN_SUPPORT)&&defined(CONFIG_RTK_BRIDGE_VLAN_SUPPORT)
	{RTL_DRV_LAN_P7_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID, 0,
	 0, 1500, {{0x00, 0x12, 0x34, 0x56, 0x78, 0x97}}, 0},
#endif
	...
	{RTL_GW_WAN_DEVICE_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 0},
#else
	{RTL_DRV_WAN0_NETIF_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	...
	{RTL_DRV_LAN_P1_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_3, RTL_LANPORT_MASK_3, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x92}}, 0},
	{RTL_DRV_LAN_P2_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_2, RTL_LANPORT_MASK_2, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x93}}, 0},
	{RTL_DRV_LAN_P3_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_1, RTL_LANPORT_MASK_1, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x94}}, 0},
#ifdef CONFIG_8198_PORT5_GMII
	{RTL_DRV_LAN_P5_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK_5, RTL_LANPORT_MASK_5, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x95}}, 0},
...
#endif
#endif
	{RTL_DRV_PPP_NETIF_NAME, 1, IF_PPPOE, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x91}}, 1},
#if defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8197F)
#if defined(CONFIG_RTL_HW_DSLITE_SUPPORT)
	{RTL_DRV_DSLT_NETIF_NAME, 1, IF_DSLT, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x99}}, 1},
#endif
#if defined(CONFIG_RTL_HW_6RD_SUPPORT)
	{RTL_DRV_6RD_NETIF_NAME, 1, IF_6RD, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x98}}, 1},
#endif
#endif
	RTL865X_CONFIG_END,
};
...
static struct rtl865x_vlanConfig vlanconfig[] = {
	{RTL_DRV_LAN_NETIF_NAME, 0, IF_ETHER, RTL_LANVLANID, RTL_LAN_FID,
	 RTL_LANPORT_MASK, RTL_LANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x96}}, 0},
	{RTL_DRV_WAN0_NETIF_NAME, 1, IF_ETHER, RTL_WANVLANID, RTL_WAN_FID,
	 RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	 {{0x00, 0x12, 0x34, 0x56, 0x78, 0x99}}, 0},
...
#if defined(CONFIG_RTL_MULTIPLE_WAN)
static struct rtl865x_vlanConfig rtl_multiWan_config =
    { RTL_DRV_WAN1_NETIF_NAME, 1, IF_ETHER, RTL_WAN_1_VLANID, RTL_WAN_FID,
	RTL_WANPORT_MASK, RTL_WANPORT_MASK, 1500,
	{{0x00, 0x12, 0x34, 0x56, 0x78, 0x99}}, 0
};
#endif
...
int8 STP_PortDev_Mapping[MAX_RE865X_STP_PORT] =
    { NO_MAPPING, NO_MAPPING, NO_MAPPING, NO_MAPPING, NO_MAPPING,
	WLAN_PSEUDO_IF_INDEX, WLAN_MESH_PSEUDO_IF_INDEX
};
#else
int8 STP_PortDev_Mapping[MAX_RE865X_STP_PORT] =
    { NO_MAPPING, NO_MAPPING, NO_MAPPING, NO_MAPPING, NO_MAPPING,
	WLAN_PSEUDO_IF_INDEX
};
#endif
...
static inline void rtk_insert_vlan_tag(uint16 vid, struct sk_buff *skb)
{
	if (skb_headroom(skb) < VLAN_HLEN && skb_cow(skb, VLAN_HLEN) != 0) {
		panic_printk
		    ("%s-%d: error! (skb_headroom(skb) == %d < 4). Enlarge it!\n",
...
static void rtl_update_manage_vlan(int enable, int vid, int wan_tag)
{
	...
	if (manage_vlan_dev != NULL) {
		...
		rtl_update_wan_cp_vinfo((struct dev_priv *)
					NETDRV_PRIV(manage_vlan_dev), enable,
					vid, wan_tag);
		//update cp vid  
...
int is_multicast_pkt_towan(struct sk_buff *skb)
{
	...
	if (*(int16 *) (ptr) == (int16) htons(ETH_P_IP)) {
		...
		if (((skb->data[0] & 0x01) && (skb->data[0] != 0xFF)) && (skb->tag.f.tpid == 0) && (!memcmp(skb->dev->dev_addr, skb->data + 6, 6)))	//from protocol stack
		{
...
uint32 rtk_getTagPortmaskByVid(uint16 vid, void *data_p)
{
	...
	if (tag_portmask) {
		...
		if (((data[0] & 0x01) && (data[0] != 0xFF))
		    && (RTK_MC_VLANID != 0) && (!is_rtl_mc_vlan_tagged(&vid)))
...
{
	int32 totalVlans =
	    ((sizeof(vlanconfig)) / (sizeof(struct rtl865x_vlanConfig))) - 1;
	int i, vlan_num = 0;
...
void rtk_8367_vlan_mapping(void)
{
	...
	int32 totalVlans =
	    ((sizeof(vlanconfig)) / (sizeof(struct rtl865x_vlanConfig))) - 2;
	...
	for (i = 0; i < totalVlans; i++) {
		...
		if (dp->id != 0) {
			...
			if ((vlan.memberPortMask & vlan.untagPortMask &
			     RTL_WANPORT_MASK) == RTL_WANPORT_MASK)
				vlan.untagPortMask =
				    (vlan.untagPortMask & 0x3f) |
				    BIT(r8367_cpu_port);
			else if ((vlan.memberPortMask & vlan.untagPortMask &
				  RTL_CPUPORT_MASK) == RTL_CPUPORT_MASK)
				vlan.untagPortMask =
				    (vlan.untagPortMask & 0x3f) |
				    BIT(r8367_cpu_port);
			else
			...
			vlan.memberPortMask =
			    (vlan.memberPortMask & 0x3f) | BIT(r8367_cpu_port);
			//mark_mcdebug
			...
			retVal =
			    rtk_vlan_set(vlan.vid, vlan.memberPortMask,
...
void rtl_setPortMask(uint32 reg_data)
{
	if ((reg_data != 0) && (reg_data != 0xFFFF)) {
		...
		REG32(MACCR) =
		    (REG32(MACCR) & ~CF_FCDSC_MASK) | (0x20 << CF_FCDSC_OFFSET);
	} else {
		/*8211ds is not found */
		lanPortMask = 0x10f;
		wanPortMask = 0x10;
	...
	for (i = 0; i < NETIF_NUMBER; i++) {
		DEBUG_ERR
		    ("valid(%d),linux netif name(%s) <---->drv netif name(%s)\n",
		     ...
		     ps_netif ? ps_drv_netif_mapping[i].ps_netif->name : NULL,
					       ...
					       char *netifName)
{
	...
	for (i = 0; i < NETIF_NUMBER; i++) {
		if (ps_drv_netif_mapping[i].valid == 1
		    && memcmp(ps_drv_netif_mapping[i].ps_netif->name, psname,
			      strlen(psname)) == 0) {
	...
	if (memcmp(psname, RTL_PS_BR0_DEV_NAME, strlen(RTL_PS_BR0_DEV_NAME)) ==
	    0) {
		for (i = 0; i < NETIF_NUMBER; i++) {
			if (ps_drv_netif_mapping[i].valid == 1 &&
							      ...
							      * dev)
{
	...
	//back compatible,user use br0 to get lan netif
	if (memcmp(dev->name, RTL_PS_BR0_DEV_NAME, strlen(RTL_PS_BR0_DEV_NAME))
	    == 0) {
		for (i = 0; i < NETIF_NUMBER; i++) {
			if (ps_drv_netif_mapping[i].valid == 1 &&
			    memcmp(ps_drv_netif_mapping[i].drvName,
...
int rtl_del_ps_drv_netif_mapping_by_name(const char *name)
{
	...
	for (i = 0; i < NETIF_NUMBER; i++) {
		if ((ps_drv_netif_mapping[i].valid == 1)
		    &&
		    (strncmp
		     (ps_drv_netif_mapping[i].drvName, name,
		      MAX_IFNAMESIZE) == 0)) {
				  ...
				  struct net_device_stats *net_stats)
{
	...
	net_stats->rx_bytes +=
	    (rtl8651_returnAsicCounter
	     (OFFSET_IFINOCTETS_P0 + 4 + addrOffset_fromP0) << 22);
	net_stats->tx_bytes +=
	    rtl8651_returnAsicCounter(OFFSET_IFOUTOCTETS_P0 +
				      addrOffset_fromP0);
	net_stats->tx_bytes +=
	    (rtl8651_returnAsicCounter
	     (OFFSET_IFOUTOCTETS_P0 + 4 + addrOffset_fromP0) << 22);
#if defined (CONFIG_RTL_INBAND_CTL_API)
	...
	net_stats->tx_dropped +=
	    rtl8651_returnAsicCounter(OFFSET_IFOUTDISCARDS + addrOffset_fromP0);
	net_stats->multicast +=
	    rtl8651_returnAsicCounter(OFFSET_ETHERSTATSMULTICASTPKTS_P0 +
				      addrOffset_fromP0);
		...
		for (j = 0; j < vlanCnt; j++) {
			if (vlanConfig1[i].if_type != vlanConfig2[j].if_type) {
				...
				if (vlanConfig1[i].if_type == IF_ETHER) {
					...
					/*PPP interface */
					if (strcmp
					    (vlanConfig1[i].ifname,
					     vlanConfig2[j].ifname)) {
						continue;
					} else {
						found = TRUE;
						break;
...
static void rtk_queue_init(struct ring_que *que)
{
	...
	que->ring = (struct sk_buff **)kmalloc((sizeof(struct skb_buff *) *
						(rtl865x_maxPreAllocRxSkb + 1))
					       , GFP_ATOMIC);
	memset(que->ring, 0,
...
__IRAM_FWD static void refill_rx_skb(void)
{
	...
	while (rx_skb_queue.qlen < rtl865x_maxPreAllocRxSkb
	       || ((idx >= 0) && (SUCCESS == check_rx_pkthdr_ring(idx, &idx))))
#else
	while (rx_skb_queue.qlen < rtl865x_maxPreAllocRxSkb)
#endif
	{
		...
		if (idx >= 0) {
			if (SUCCESS ==
			    check_and_return_to_rx_pkthdr_ring(skb, idx)) {
				continue;
			}
		}
#endif
...
#define RTL_PRIV_DATA_SIZE	128
	...
	if (((struct sk_buff *)skb)->fast_br_forwarding_flags == 1
		...
		if (!(skb_cloned(skb))) {
			...
			SMP_LOCK_ETH_BUF(flags);
			if (rtk_queue_tail
			    (&rx_skb_queue, (struct sk_buff *)skb)) {
				unsigned char *data;
				...
				memset(skb, 0,
				       offsetof(struct sk_buff, truesize));
	...
	if (iph) {
		if (iph->protocol == IPPROTO_IPV6) {
			...
			if (ipv6h && (ipv6h->version == IP_VERSION6)
			    && (IN6_IS_ADDR_MULTICAST(ipv6h->daddr.s6_addr32))) {
					    ...
					    unsigned int keepOrigSkb)
{
	...
	if (skb2 != NULL) {
		...
		if (vlan_bridge_tag && vlan_bridge_multicast_tag
			...
			if (skb_wan != NULL) {
				...
				RTL_CACHE_WBACK((unsigned long)skb_wan->data,
						skb_wan->len);
				if (RTL_swNic_send
				    ((void *)skb_wan, skb_wan->data,
				     skb_wan->len, &nicTx_wan) < 0) {
		...
		nicTx.portlist =
		    mcastFwdPortMask &
		    ((struct dev_priv *)(NETDRV_PRIV(skb->dev)))->portmask;
#else
		...
		if ((vlan_tag && vid == vlan_tag)
		    || (vlan_bridge_tag && (vid == vlan_bridge_tag))) {
		...
		if (linux_vlan_enable) {
			if (*((uint16 *) (skb2->data + (ETH_ALEN << 1))) ==
			    __constant_htons(ETH_P_8021Q)) {
				vid =
				    *(uint16 *) (skb2->data + (ETH_ALEN << 1) +
						 2);
				portMask =
				    nicTx.portlist & vlan_ctl_p->
				    group[vid].memberMask & 0xff;
				if (portMask) {
					tagMask =
					    portMask & vlan_ctl_p->
					    group[vid].tagMemberMask & 0xff;
		...
		if (RTL_swNic_send((void *)skb2, skb2->data, skb2->len, &nicTx)
		    < 0) {
			dev_kfree_skb_any(skb2);
		}
	}
...
static bool rtl_MulticastRxFilterOff(struct sk_buff *skb, int ipversion)
{
	...
	if (ipversion == 4) {
		...
		if (type == PPPOE_IGMP) {
			...
			skb->network_header =
			    (sk_buff_data_t) rtl_get_pppoe_ipv4_hdr(skb->data,
								    1, 0);
		} else
#endif
			skb->network_header =
			    (sk_buff_data_t) re865x_getIpv4Header(skb->data);
	}
#if defined (CONFIG_RTL_MLD_SNOOPING)
	else if (ipversion == 6)
		skb->network_header =
	...
	if (type == PPPOE_IGMP)
		skb->data =
		    (unsigned char *)rtl_get_pppoe_ipv4_hdr(skb->data, 1, 0);
	else
#endif
...
//#ifndef CONFIG_RTL_8198C // modified by lynn_pu, 2014-10-22
		...
		ret =
		    ((IgmpRxFilter_Hook
		      (skb, NF_INET_LOCAL_IN, skb->dev, NULL,
		       dev_net(skb->dev)->ipv4.iptable_filter)) != NF_ACCEPT);
		skb->dev = origDev;
	} else if (ipversion == 6)
			     ...
			     int mCastFlag)
{
	...
	vlanRelayPortMask =
	    rtl865x_getVlanPortMask(pvid) & (~(1 << pid)) &
	    ((1 << RTL8651_MAC_NUMBER) - 1);
#else
	vlanRelayPortMask =
	    rtl865x_getVlanPortMask(vid) & (~(1 << pid)) &
	    ((1 << RTL8651_MAC_NUMBER) - 1);
#endif
#if defined(CONFIG_RTL_LINK_AGGREGATION)
	...
	if ((mCastFlag == IPV4_MCAST_PACKET)
	    || (mCastFlag == DSLITE_MCAST_PACKET) || (pppoe_type == PPPOE_IGMP))
#else
	if ((mCastFlag == IPV4_MCAST_PACKET)
...
#endif
	{
		...
		if (*(uint16 *) skb->vlan_passthrough_saved_tag ==
		    __constant_htons(ETH_P_8021Q)) {
			vid =
			    *((unsigned short *)(skb->vlan_passthrough_saved_tag
						 + 2));
		...
		if (pppoe_type != 0)
			iph =
			    rtl_get_pppoe_ipv4_hdr(skb->data, 1, skb->protocol);
		else
#endif
			iph = re865x_getIpv4Header(skb->data);
			...
			if ((l4Protocol == IPPROTO_UDP)
				...
				if (vlan_bridge_tag
					...
					if (igmpsnoopenabled
						...
						vlanRelayPortMask =
						    ...
						    (pvid) & (~(1 << pid)) &
						    nicMCastFwdInfo.fwdPortMask
						    & cp_this->portmask &
						    ((1 << RTL8651_MAC_NUMBER) -
						     1);
#else
						vlanRelayPortMask =
				...
				if (igmpsnoopenabled
					...
					memcpy(&multicastDataInfo.groupAddr,
					       &iph->daddr, 4);
					multicastDataInfo.sourceIp[0] =
					    ntohl(multicastDataInfo.sourceIp
						  [0]);
					multicastDataInfo.groupAddr[0] =
					    ntohl(multicastDataInfo.groupAddr
						  [0]);
#else
					multicastDataInfo.sourceIp[0] =
					    (uint32) (iph->saddr);
...
#if 0
				vlanportmask =
				    (~(1 << pid)) & nicMCastFwdInfo.fwdPortMask
				    & cp_this->portmask &
				    ((1 << RTL8651_MAC_NUMBER) - 1);
				if (linux_vlan_enable)
		...
		if (oldStatus & IP6_PASSTHRU_MASK) {
			if ((*((uint16 *) (data + (ETH_ALEN << 1))) ==
			    ...
			    ((*((uint16 *) (data + (ETH_ALEN << 1))) ==
			      __constant_htons(ETH_P_8021Q))
			     &&
			     (*((uint16 *) (data + (ETH_ALEN << 1) + VLAN_HLEN))
			      == __constant_htons(ETH_P_IPV6)))) {
				ret = SUCCESS;
			}
		}
...
__MIPS16
    __IRAM_FWD static inline int32 rtl_decideRxDevice(rtl_nicRx_info * info)
{
	struct dev_priv *cp;
	int32 pid, i, ret;
	struct sk_buff *skb;
...
#endif
	{
		...
		if (rtl865x_curOpMode == GATEWAY_MODE) {
			if (0 == (skb->data[0] & 0x01)) {
				if (rtl865x_decideUcDevice(skb->data, pid, info)
				    == SUCCESS) {
					ret = SUCCESS;
					goto out;
				}
				...
				if (skb->data[0] != 0xff) {
					if (rtl865x_decideMcDevice(pid, info) ==
					    SUCCESS) {
						ret = SUCCESS;
						goto out;
					}
				} else {
					if (rtl865x_decideBcDevice
					    (skb, pid, info) == SUCCESS) {
						ret = SUCCESS;
						goto out;
					}
				}
		...
		if (ETH_INTF_NUM == i) {
			...
			ret = FAILED;
			 ...
			 && (ether_addr_equal((char *)cp->dev->dev_addr, (char *)dest_mac)))	//mark_cc
#else
			 &&
			 (compare_ether_addr
			  ((char *)cp->dev->dev_addr, (char *)dest_mac)))
#endif
	{
#if defined(CONFIG_IPV6)
...
int rtl_add_Acl_for_dns_trap(struct rtl865x_vlanConfig *vlanConfig)
{
	...
	for (i = 0; pVlanConfig[i].vid != 0; i++) {
		...
		if (pVlanConfig[i].isWan == 0) {	/*lan config */
			...
			ret =
			    rtl865x_add_acl(&rule, pVlanConfig[i].ifname,
					    RTL865X_ACL_DNSTRAP_USED);
						  ...
						  rtl_nicRx_info * info)
{
	...
	if (
...
#endif /* #if defined(CONFIG_RTL_ULINKER_BRSC) */
		{
			...
			if (memcmp
			    (&skb->data[ETH_ALEN], cp_this->dev->dev_addr,
			     ETH_ALEN))
#endif
			{
				if (memcmp
				    (cached_eth_addr, &skb->data[ETH_ALEN],
				     ETH_ALEN) == 0) {
				    ...
				    if (memcmp
					(cached_eth_addr2, &skb->data[ETH_ALEN],
					 ETH_ALEN) == 0) {
				    ...
				    if (memcmp
					(cached_eth_addr3, &skb->data[ETH_ALEN],
					 ETH_ALEN) == 0) {
					cached_dev3 = cp_this->dev;
					last_used = 2;
				} else
				    if (memcmp
					(cached_eth_addr4, &skb->data[ETH_ALEN],
					 ETH_ALEN) == 0) {
...
__MIPS16
    __IRAM_FWD
    static inline int32 rtl_processExtensionPortShortCut(struct sk_buff *skb,
							 struct dev_priv
							 *cp_this,
							 rtl_nicRx_info * info)
{
...
__MIPS16 __IRAM_FWD static inline void rtl_processRxFrame(rtl_nicRx_info * info)
{
...
#endif
	{
		...
		int vlan_check;
		vlan_check =
		    rx_vlan_process(cp_this->dev, &cp_this->vlan_setting, skb,
				    &new_skb);
		...
		if (rtk_vlan_support_enable == 2) {
			DEBUG_ERR
			    ("====%s(%d),cp(%s),cp->vlan.id(%d),skb->tag.vid(%d)\n",
			     ...
			     cp_this->vlan_setting.id, skb->tag.f.pci & 0xfff);
			if (cp_this->vlan_setting.vlan
				...
				if (cp_this->vlan_setting.is_lan == 0) {
					...
					/*      look up vap     */
					vap =
					    get_dev_by_vid(skb->tag.
							   f.pci & 0xfff);
					if (vap) {

						skb->dev = vap;
						vap->netdev_ops->ndo_start_xmit
						    (skb, vap);
						return;
					}
				}
	...
	if (*((uint16 *) (skb->data + (ETH_ALEN << 1))) ==
	    __constant_htons(ETH_P_8021Q)) {
		vid =
		    ntohs(*(uint16 *) (skb->data + (ETH_ALEN << 1) + 2)) &
		    0x0fff;
#if	defined(CONFIG_RTL_QOS_8021P_SUPPORT)
		skb->srcVlanPriority =
			...
			if (skb1) {
...
#endif
				{
					memcpy((void *)&info1, info,
					       sizeof(rtl_nicRx_info));
					info1.vid = ntohs(*(uint16 *)
							  (skb1->
							   linux_vlan_src_tag +
							   2));
					info1.priv =
					    NETDRV_PRIV(_rtl86xx_dev.dev[1]);
					info1.isPdev = FALSE;
		...
		if (*((uint16 *) (skb->data + (ETH_ALEN << 1))) !=
			...
			if ((info->srcvid != RTL_LANVLANID)
				...
				if ((vlan_ctl_p->pvid[info->pid] !=
					...
					*((uint16 *) (skb->data +
						      (ETH_ALEN << 1) + 2)) =
					    __constant_htons(vlan_ctl_p->pvid
							     [info->pid]);
#endif
					data = skb->data;
				}
		...
		if (port_id < RTL8651_PHY_NUMBER) {
			...
			for (i = 0; i < RTL8651_PHY_NUMBER; i++) {
				if ((i != port_id)
				    &&
				    (memcmp
				     (port_mac_table[i].client_mac, client_mac,
				      ETH_ALEN) == 0))
...
#endif /*      unicast pkt only        */
	{
		...
		if (rtl_fastvpn_hook) {
			...
			if (vpn_port > 0 && vpn_port < 65536) {
				...
				if (skb->len > 43
				    && *((uint8 *) (skb->data + 23)) == 17
				    && *((uint16 *) (skb->data + 36)) ==
				    vpn_port
				    && (*((uint16 *) (skb->data + 20)) &
					ntohs(0x3fff)) == 0)
					dec_ret = rtl_fastvpn_hook->vpn_hw_decrypto(skb, 1);	//static/dhcp
				else if (skb->len > 51
					 ...
					 && (*((uint16 *) (skb->data + 28)) &
					     ntohs(0x3fff)) == 0)
					dec_ret = rtl_fastvpn_hook->vpn_hw_decrypto(skb, 2);	//pppoe                      
			}
			if (dec_ret < 1) {
				if (dec_ret < 0) {
					cp_this->net_stats.rx_dropped++;
...
#if defined(BR_SHORTCUT)
				if (SUCCESS ==
				    rtl_processBridgeShortCut(skb, cp_this,
							      info)) {
					return;
				}
#elif defined(CONFIG_RTL_HARDWARE_NAT)&&(defined(CONFIG_RTL8192SE)||defined(CONFIG_RTL8192CD))
...
#if defined(CONFIG_RTL_FASTBRIDGE)
				if (RTL_FB_RETURN_SUCCESS ==
				    rtl_fb_process_in_nic(skb, cp_this->dev))
					return;
#endif
...
#ifdef RX_TASKLET
		// avoid cp  change!
		tasklet_schedule(&((struct dev_priv *)
				   task_priv)->rx_dsr_tasklet);
#endif
	...
	for (port = 0; port < RTL8651_PHY_NUMBER; port++) {
		if ((1 << port) & (newLinkPortMask & (~curLinkPortMask))) {
			...
			if (snr > SNR_THRESHOLD) {
				...
				if (re865x_restartNWayCtrl[port].restartNWayTime
				    == 0) {
					/*last time snr is good */
					re865x_restartNWayCtrl
					    [port].restartNWayTime = jiffies;
					re865x_restartNWayCtrl
					    [port].restartNWayCnt = 1;
				    ...
				    if (re865x_restartNWayCtrl
					[port].restartNWayCnt >
					MAX_RESTART_NWAY_CNT) {
...
void rtl819x_port0_force_refined(void)
{
	...
	if (newLinkPortMask & 0x01) {
		...
		rtl8651_getAsicEthernetPHYReg
		    (rtl8651_tblAsicDrvPara.externalPHYId[0], 6, &regData);
		if ((regData & 0x01) == 0) {
			rtl8651_getAsicEthernetPHYReg
			    (rtl8651_tblAsicDrvPara.externalPHYId[0], 5,
			     &regData);
			if (regData & 0x080) {	//if spd = 100M(reg5[7])
				...
				regData = REG32(PCRP0);
				regData |=
				    (EnForceMode | PollLinkStatus | ForceDuplex
...
static int long_cable_check_with_linked(uint32 port)
{
	...
	if (snr >= SNR_DOWN_SPEED_THRESHOLD) {
		REG32(PCRP0 + (port * 4)) &=
		    ~(NwayAbility1000MF | NwayAbility100MF | NwayAbility100MH);
		local_bh_disable();
		fe_ads[port].down_speed_renway = 1;
		...
		if (((REG32(PSRP0 + (port * 4))) & PortStatusLinkUp) == FALSE) {
			...
			if ((1 << port) & curLinkPortMask) {
				...
				if (fe_ads[port].down_speed_renway == 0) {
					...
					fe_ads[port].cb_snr_cache_lpi_down_speed
					    = 0;
				} else {
...
static void one_sec_timer(unsigned long task_priv)
{
	...
	if ((REG32(REVR) == RTL8196C_REVISION_A) && (eee_enabled)) {
		...
		for (i = 0; i < MAX_PORT_NUMBER; i++) {
			curr_sts =
			    (REG32(PSRP0 + (i * 4)) & PortStatusLinkUp) >> 4;

			if ((prev_port_sts[i] == 1) && (curr_sts == 0)) {
				// disable EEE MAC
				REG32(EEECR) =
				    (REG32(EEECR) & ~(0x1f << (i * 5))) |
				    ((EN_P0_FRC_EEE | FRC_P0_EEE_100) <<
				     (i * 5));
...
#define panic_printk         printk
	...
	for (i = 0; i < ETH_INTF_NUM; i++) {
		...
		if (_rtl86xx_dev.dev[i] && tmp_cp && tmp_cp->portmask
		    && tmp_cp->opened) {
			...
			if ((RTL_R32(PCRP0 + portnum * 4) & EnablePHYIf) == 0) {
				...
				case STATE_NO_ERROR:
					if ((REG32(SYS_CLK_MAG) &
					     SYS_SW_CLK_ENABLE) == 0) {
						rtl865x_reInitState =
						    STATE_SW_CLK_ENABLE_WAITING;
...
static int re865x_open(struct net_device *dev)
{
...
#if defined(CONFIG_RTL_ETH_NAPI_SUPPORT)
		netif_napi_add(dev, &cp->napi, rtl865x_poll,
			       RTL865X_NAPI_WEIGHT);
		napi_enable(&cp->napi);
#else
#if defined(RX_TASKLET)
	...
	if (rtl_get_ps_drv_netif_mapping_by_psdev_name(dev->name, drvNetif_name)
	    == SUCCESS)
				      ...
				      uint32 * portlist)
{
	...
	found =
	    rtl865x_Lookup_fdb_entry(0, macAddr, FDB_DYNAMIC, &column,
				     &fdbEntry);
	if (found == SUCCESS) {
		if (portlist)
		...
		if ((rtl865x_curOpMode == GATEWAY_MODE
			...
			if (*((unsigned short *)(skb->data + ETH_ALEN * 2)) !=
				...
				if (skb_headroom(skb) < VLAN_HLEN
					...
					printk
					    ("%s-%d: error! (skb_headroom(skb) == %d < %d). Enlarge it!\n",
					     __FUNCTION__, __LINE__,
...
uint16 rtl_get_linux_vlan_src_tag_vid(struct sk_buff * skb)
{
	...
	if (*(uint16 *) skb->linux_vlan_src_tag ==
	    __constant_htons(ETH_P_8021Q)) {
...
int rtl_process_linux_vlan_tx_check(rtl_nicTx_info * txInfo)
{
	...
	if (cp->id != rtk_vlan_wan_vid)	//LAN tx.
	{
		...
		if (*(unsigned short *)(skb->data + (ETH_ALEN << 1)) ==
		    __constant_htons(ETH_P_8021Q)) {
			vid = ntohs(*(unsigned short *)
				    (skb->data + (ETH_ALEN << 1) + 2));
...
#endif
#if defined(CONFIG_RTL_VLAN_PASSTHROUGH_SUPPORT)
	retval = rtl_process_vlan_passthrough_tx((struct sk_buff **)
						 &txInfo->out_skb);
	if (FAILED == retval)
		return retval;
#endif
...
#endif
{
	...
	txInfo->flags =
	    (PKTHDR_USED | PKTHDR_HWLOOKUP | PKTHDR_BRIDGING | PKT_OUTGOING);
}
...
//#if defined (CONFIG_RTL_MULTI_LAN_DEV) ||defined (CONFIG_POCKET_ROUTER_SUPPORT)
	...
	if (linux_vlan_enable) {
		...
		if ((!rtl_isWanDev(cp)) || ((rtl_isWanDev(cp))
					    &&
					    (*
					     ((uint16 *) (skb->data +
							  (ETH_ALEN << 1))) ==
...
static inline int rtl_fill_txInfo(rtl_nicTx_info * txInfo)
{
    ...
    %02x:%02x:%02x:%02x %02x:%02x:%02x:%02x %02x:%02x:%02x:%02x\n",
					     __FUNCTION__, __LINE__, skb->dev->name, skb->data[0], skb->data[1], skb->data[2], skb->data[3], skb->data[4], skb->data[5]
					     ...
					     skb->data[18], skb->data[19],
					     skb->data[20], skb->data[21],
					     skb->data[22], skb->data[23]);
				txInfo->portlist &=
				    vlan_ctl_p->group[txInfo->vid].memberMask;
				portMask = txInfo->portlist;
				if (portMask) {
					tagMask =
					    portMask &
					    vlan_ctl_p->group[txInfo->vid].
					    tagMemberMask;
					untagMask = portMask & (~tagMask);
					if (untagMask) {
						if (tagMask) {
...
#endif
			{
				if (rtl_isWanDev(cp)
				    ...
				    (*((uint16 *) (skb->data + (ETH_ALEN << 1)))
				     != __constant_htons(ETH_P_8021Q))) {
					rtl_direct_txInfo(txInfo->portlist,
							  txInfo);
				} else {
					rtl_hwLookup_txInfo(txInfo);
				}
			       ...
			       unsigned int priority)
{
	...
	if ((*skb)->mark & (1 << 16)) {	// marked by IPQoS                                
		insert[0] =
		    (((*skb)->mark & 0x7) << 5) | (priority << 5) | (vid >> 8);
    ...
    static int re865x_start_xmit(struct sk_buff *skb, struct net_device *dev)
{
		...
		if (vpn_port > 0 && vpn_port < 65536) {
			...
			//else if(skb->len>51 && *((uint8*)(skb->data+31))==17  && *((uint16*)(skb->data+42))==vpn_port  && (*((uint16*)(skb->data+28)) & 0x3fff)==0)
				 ...
				 && (*((uint16 *) (skb->data + 28)) &
				     ntohs(0x3fff)) == 0) {
				//printk("\n%s calling rtk_openvpn_hw_encrypto()!\n",__FUNCTION__);
				encrypt_ret = rtl_fastvpn_hook->vpn_hw_encrypto(skb, 2);	//pppoe
			}
			if (encrypt_ret < 0) {
				printk("\n%s free skb!\n", __FUNCTION__);
				dev_kfree_skb_any(skb);
	...
	if (
		   ...
		   (cp->id == 0) ||
#else
		   ((tx_skb->dev->priv_flags & IFF_DOMAIN_ELAN)
		    && (cp->id == 0)) ||
#endif
		   (cp->portmask == 0)) {
	...
	if (((struct sk_buff *)tx_skb)->srcPhyPort ==
		...
		if (strncmp
		    (tx_skb->dev->name, RTL_DRV_WAN0_NETIF_NAME,
		     IFNAMSIZ) == 0) {
			nicTx.priority =
		...
		if ((tx_skb->from_dev && (tx_skb->from_dev->priv_flags & (IFF_DOMAIN_ELAN | IFF_DOMAIN_WLAN))) && (tx_skb->dev->priv_flags & IFF_DOMAIN_WAN)) {	//upstream
			...
			if (tx_skb->from_dev->priv_flags & IFF_DOMAIN_ELAN) {
				...
				if (port > 1)
				   ...
				   from_dev->priv_flags & IFF_DOMAIN_WLAN) {
				TOKEN_NUM(tx_skb->from_dev->name, &port);
			}
#else
			port_mask =
			    rtl_get_bind_port_mask_by_dev_name
			    (tx_skb->from_dev->name);
#endif

			if (!(tx_skb->vlan_member & port_mask)) {
				if (net_ratelimit())
					printk
					    ("upstream packet[%s -> %s] block by port mapping rule (member 0x%x).\n",
					     tx_skb->from_dev->name,
					     tx_skb->dev->name,
					     tx_skb->vlan_member);
				dev_kfree_skb_any(tx_skb);
			...
			if (!rtl_smux_downstream_port_mapping_check(tx_skb)) {
				if (net_ratelimit())
					printk
					    ("downstream packet[%s -> %s] block by port mapping rule (member 0x%x).\n",
					     tx_skb->from_dev->name,
					     tx_skb->dev->name,
					     tx_skb->vlan_member);
				dev_kfree_skb_any(tx_skb);
	...
	if ((RTL_WANVLANID != nicTx.vid) && (RTL_LANVLANID != nicTx.vid)
		...
		if (!rtl_insert_vlan_tag
		    (&tx_skb, nicTx.vid, tx_skb->vlan_tci >> 13)) {
#if defined(CONFIG_SMP)
			SMP_UNLOCK_ETH_XMIT(flags);
#endif
			return 0;
		...
		if (!rtl_insert_vlan_tag
		    (&tx_skb, tx_skb->mark >> 20, tx_skb->mark & 0x7)) {
#if defined(CONFIG_SMP)
			SMP_UNLOCK_ETH_XMIT(flags);
#endif
			return 0;
	...
	while (1) {
		...
		if ((skb_shinfo(tx_skb)->nr_frags > 0)
			...
			retval =
			    New_swNic_send_tso_sg(tx_skb, tx_skb->data,
						  tx_skb->len, &nicTx);
		} else {
			retval =
			    New_swNic_send((void *)tx_skb, tx_skb->data,
					   tx_skb->len, &nicTx);
		}
#else
		retval =
		    New_swNic_send((void *)tx_skb, tx_skb->data, tx_skb->len,
				   &nicTx);
#endif
#else
#if defined(CONFIG_SMP)
		retval =
		    _swNic_send((void *)tx_skb, tx_skb->data, tx_skb->len,
				&nicTx);
#else
		retval =
		    swNic_send((void *)tx_skb, tx_skb->data, tx_skb->len,
			       &nicTx);
#endif
#endif
...
int rtl819x_get_port_status(int portnum, struct lan_port_status *port_status)
{
	...
	data0 =
	    (regData & PortStatusLinkSpeed_MASK) >> PortStatusLinkSpeed_OFFSET;
...
int rtl819x_get_port_stats(int portnum, struct port_statistics *port_stats)
{
	...
	port_stats->rx_error =
	    (rtl8651_returnAsicCounter
	     (OFFSET_DOT3STATSFCSERRORS_P0 + addrOffset_fromP0) +
	     rtl8651_returnAsicCounter(OFFSET_ETHERSTATSJABBERS_P0 +
				       addrOffset_fromP0));
	...
	port_stats->tx_error =
	    (rtl8651_returnAsicCounter
	     (OFFSET_ETHERSTATSCOLLISIONS_P0 + addrOffset_fromP0) +
	     rtl8651_returnAsicCounter(OFFSET_DOT3STATSDEFERREDTRANSMISSIONS_P0
				       + addrOffset_fromP0));
...
int re865x_priv_ioctl(struct net_device *dev, struct ifreq *rq, int cmd)
{
	...
	case RTL819X_IOCTL_READ_PORT_STATUS:
		...
		if (copy_to_user
		    ((void *)rq->ifr_data, (void *)&port_status,
	...
	case RTL819X_IOCTL_READ_PORT_STATS:
		...
		if (rc != 0)
			return -EFAULT;
		if (copy_to_user
		    ((void *)rq->ifr_data, (void *)&port_stats,
...
static int rtl865x_addAclForIPV6ReadyLogo(struct rtl865x_vlanConfig *vlanConfig)
{
	...
	for (i = 0; pVlanConfig[i].vid != 0; i++) {
		...
		if (pVlanConfig[i].isWan == 0) {	/*lan config */
			...
			ntohl_array((u32 *) & rule.un_ty.L3V6.
				    _dstIpV6Addr.v6_addr32[0],
				    (u32 *) & rule.un_ty.L3V6.
				    _dstIpV6Addr.v6_addr32[0], 4);
...
{
	return (single_open
		(file, rtk_link_status_read, (void *)PDE_DATA(inode)));
}
...
{
	return (single_open
		(file, rtl_hw_vlan_tagged_bridge_multicast_read, NULL));
}
...
void re865x_shutdown(struct device *dev)
{
	printk("%s %d\n", __FUNCTION__, __LINE__);
	rtl83XX_reset();
}

int rtl83XX_shutdown(struct notifier_block *nb,
...
static struct notifier_block rtw_reboot_notifier = {
	.notifier_call = rtl83XX_shutdown,
};
#endif
...
#if defined(CONFIG_RTL_SWITCH_NEW_DESCRIPTOR)
	REG32(CPUICR1) =
	    (REG32(CPUICR1) & ~CF_PKT_HDR_TYPE_MASK) | TX_PKTHDR_SHORTCUT_LSO;
#endif
...
//      rtlglue_printf("        creating eth0~eth%d...\n",totalVlans-1 );
	...
	for (i = 0; i < totalVlans; i++) {
		...
		if (vlanconfig[i].isWan
		    &&
		    (strncmp
		     ((vlanconfig[i].ifname), RTL_DRV_WAN0_NETIF_NAME,
		      IFNAMSIZ)))
			continue;
#endif
...
#if defined(CONFIG_RTL_MULTI_LAN_DEV)
			if (strncmp
			    ((vlanconfig[i].ifname), RTL_DRV_LAN_P0_NETIF_NAME,
			     IFNAMSIZ) == 0)
...
#if defined(CONFIG_RTK_BRIDGE_VLAN_SUPPORT)
		if (memcmp((vlanconfig[i].ifname), RTL_DRV_LAN_P7_NETIF_NAME, 4)
		    == 0) {
...
#else
		if ((res_stats =
		     create_proc_read_entry("mib_vlan", 0644, res_stats_root,
					    read_proc_vlan,
					    (void *)dev)) == NULL) {
		...
		if ((rtk_link_status_entry =
		     create_proc_read_entry("link_status", 0644, res_stats_root,
					    rtk_link_status_read,
					    (void *)dev)) == NULL) {
			printk("create_proc_read_entry failed!\n");
		}
...
#if 0				//def CONFIG_RTL_STP
	printk
	    ("Configuration ether driver to process port 0 ~ port %d for Spanning tree process\n",
...
//#if defined(CONFIG_RTK_VLAN_FOR_CABLE_MODEM)
...
#if defined(CONFIG_TR181_ETH)
	{
...
#else
		tr181_eth_link =
		    create_proc_entry("tr181_eth_link", 0, rtl865x_proc_dir);
		if (tr181_eth_link) {
		...
		tr181_eth_stats =
		    create_proc_entry("tr181_eth_stats", 0, rtl865x_proc_dir);
		if (tr181_eth_stats) {
...
#endif
#if defined(CONFIG_NET_SCHED)
#if defined(CONFIG_RTK_IPTABLES_FAST_PATH)	//mark_cc
	rtl_qos_init();
#endif
#endif
#endif
...
static __inline__ unsigned char *get_buf_from_poll(struct list_head *phead,
						   unsigned int *count)
{
	unsigned long flags = 0;
	unsigned char *buf;
...
static __inline__ void release_buf_to_poll(unsigned char *pbuf,
					   ...
					   unsigned int *count)
{
	...
	*count = *count + 1;
	plist =
	    (struct list_head *)((unsigned int)pbuf - sizeof(struct list_head));
...
__MIPS16
    __IRAM_FWD static struct sk_buff *dev_alloc_skb_priv_eth(unsigned int size)
{
	struct sk_buff *skb;
	unsigned char *data;
	...
	if (eth_skb_free_num > 0) {
		data =
		    get_buf_from_poll(&eth_skbbuf_list,
				      (unsigned int *)&eth_skb_free_num);
		if (data == NULL) {
			...
			if (pvid != 0) {
				...
				rtlglue_printf
				    ("%s:%d:lrconfig[j].vid is %d,pvid is %d, j is %d,i is %d\n",
				     __FUNCTION__, __LINE__, vlanconfig[j].vid,
				     pvid, j, i);
#endif
...
static void rtl_unkownUnicastTimer(unsigned long data)
{
	...
	ret =
	    rtl865x_del_acl(&rule, RTL_DRV_LAN_NETIF_NAME,
			    RTL865X_ACL_IPV6_USED);
...
static int32 reinit_vlan_configure(struct rtl865x_vlanConfig new_vlanconfig[])
{
	...
	if (rtl_hw_vlan_enable) {
		...
		if ((hw_vlan_info[0].vlan_port_enabled)
			...
			rtl865x_setVlanFilterDatabase(hw_vlan_info
						      [0].vlan_port_vid, 0);
...
//              panic_printk("####%s:%d curLinkPortMask=%u\n",__FUNCTION__,__LINE__,curLinkPortMask);
	...
	if (cp
	    &&
	    ((cp->portmask & curLinkPortMask & ((1 << RTL8651_MAC_NUMBER) - 1))
	     != 0)) {
#if defined(CONFIG_AUTO_DHCP_CHECK) || defined(CONFIG_RTK_WLAN_EVENT_INDICATE)
...
#if defined(CONFIG_AUTO_DHCP_CHECK) || defined(CONFIG_RTK_WLAN_EVENT_INDICATE)
	len +=
	    sprintf(page + len, "%d %x", eth0_portLinkStatus, curLinkPortMask);
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		...
		if (cmd_addr
			...
			if (enable) {
			 ...
			 (cmd_addr, "by_ipv6_netif", strlen("by_ipv6_netif"))) {
			sscanf(strptr, "%x", &enable);
			//panic_printk("%s %d enable=%d \n", __FUNCTION__, __LINE__, enable);
			if (enable) {
				rtk_hwL3v6_enable = 1;
			...
			if (tmpbuf[0] == '1') {
				...
				printk
				    ("echo \"by_ipv6_route $enable\" >/proc/hwL3v6\n");
				//printk("echo \"by_ipv6_netif $enable\" >/proc/hwL3v6\n");
				printk("echo \"$enable\" >/proc/hwL3v6\n");
				printk
				    ("$enable means enable or disable hardware layer3 ipv6 support, valid value is 0/1\n");
				return len;
			}
		}
	}
					    ...
					    unsigned long len, void *data)
{
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		...
		num =
		    sscanf(tmpbuf, "%d %d %d %d %d", &vlan_tag, &vlan_host_pri,
			   &vlan_bridge_tag, &vlan_bridge_port,
			   &vlan_bridge_multicast_tag);
		if (num != 5) {
			printk
			    ("invalid rtk_vlan_wan_tag_support_write parameter!\n");
			return len;
		}
		...
		if (vlan_bridge_tag) {
			...
			vlanconfig[2].fid = 1;
			((struct dev_priv *)
			 NETDRV_PRIV(_rtl86xx_dev.dev[2]))->portmask =
			    lan_portmask | RTL_WANPORT_MASK;
		...
		if (vlan_bridge_tag) {
			...
			if (nicIgmpModuleIndex_2 == 0xFFFFFFFF) {
				ret =
				    rtl_registerIgmpSnoopingModule
				    (&nicIgmpModuleIndex_2);
#if defined (CONFIG_RTL_HARDWARE_MULTICAST)
				memset(&devInfo, 0,
...
#else
		len +=
		    sprintf(page + len, "Speed %s\n\n",
			    data0 ==
			    PortStatusLinkSpeed100M ? "100M" : (data0 ==
								PortStatusLinkSpeed1000M
								? "1G" : (data0
									  ==
									  PortStatusLinkSpeed10M
...
errout:
		printk
		    ("port status only support \"port\" as the first parameter\n");
		printk
		    ("format:	\"port port_mask 10_half/100_half/10_full/100_full/1000_full/auto\"\n");
	}
	return len;
}
...
int rtl819x_get_port_mibStats(int port, struct port_mibStatistics *port_stats)
{
	...
	port_stats->etherStatsPkts512to1023Octets =
	    rtl8651_returnAsicCounter(OFFSET_ETHERSTATSPKTS512TO1023OCTETS_P0 +
				      addrOffset_fromP0);
	port_stats->etherStatsPkts1024to1518Octets =
	    rtl8651_returnAsicCounter(OFFSET_ETHERSTATSPKTS1024TO1518OCTETS_P0 +
				      addrOffset_fromP0);
	...
	port_stats->dot3StatsMultipleCollisionFrames =
	    rtl8651_returnAsicCounter(OFFSET_DOT3STATSMULTIPLECOLLISIONFRAMES_P0
				      + addrOffset_fromP0);
	...
	port_stats->dot1dBasePortDelayExceededDiscards =
	    rtl8651_returnAsicCounter
	    (OFFSET_DOT1DBASEPORTDELAYEXCEEDEDDISCARDS_P0 + addrOffset_fromP0);
			      ...
			      char *page, int off)
{
	...
	/*here is in counters  definition */
	len +=
	    sprintf(page + len, "%s%u\n", "ifInOctets=",
		    port_stats->ifInOctets);
	len +=
	    sprintf(page + len, "%s%llu\n", "ifHCInOctets=",
...
#endif
				 &cp->vlan_setting.global_vlan,
				 &cp->vlan_setting.is_lan,
				 &cp->vlan_setting.vlan, &cp->vlan_setting.tag,
				 &cp->vlan_setting.id, &cp->vlan_setting.pri,
				 &cp->vlan_setting.cfi
#if defined(CONFIG_RTK_BRIDGE_VLAN_SUPPORT) || defined(CONFIG_RTL_HW_VLAN_SUPPORT)
...
#if 0
		printk
		    ("===%s(%d), cp->name(%s),global_vlan(%d),is_lan(%d),vlan(%d),tag(%d),id(%d),pri(%d),cfi(%d)",
		     __FUNCTION__, __LINE__, cp->dev->name,
		     cp->vlan_setting.global_vlan, cp->vlan_setting.is_lan,
		     cp->vlan_setting.vlan, cp->vlan_setting.tag,
		     cp->vlan_setting.id, cp->vlan_setting.pri,
	...
	//if((skb->data[0]&1) ||((skb->data[0]==0x33) &&(skb->data[1]==0x33) && (skb->data[2]!=0xFF)))
	{
		if (skb->tag.f.tpid == htons(ETH_P_8021Q)) {
			...
			for (i = 0; i < PORT_NUMBER; i++) {
				temp = (i == 0) ? i : (i - 1);
				if ((((struct dev_priv *)
				      NETDRV_PRIV(skb->dev))->portmask & (0x1 <<
									  temp))
...
static int32 rtl_hw_vlan_config(void)
{
	...
	if (rtl_hw_vlan_enable && (rtl865x_curOpMode == GATEWAY_MODE)) {
		...
		for (i = 0; i < PORT_NUMBER; i++) {
			...
			if (hw_vlan_info[i].vlan_port_enabled == 1
			    && hw_vlan_info[i].vlan_port_bridge == FW_NAT_VLAN)
				rtl_set_nat_vlan_info(hw_vlan_info
						      [i].vlan_port_vid,
						      hw_vlan_info
						      [i].vlan_port_tag);
		...
		rtl_update_lan_cp_vinfo((struct dev_priv *)
					NETDRV_PRIV(_rtl86xx_dev.dev[0]), 1,
					RTK_NAT_VLANID, FW_NAT_VLAN,
					RTK_NAT_WAN_TAGGED);
#endif
#ifdef CONFIG_RTL_HW_VLAN_SUPPORT_HW_NAT
	...
	if (rtl_hw_vlan_enable && (rtl865x_curOpMode == GATEWAY_MODE)) {
		...
		for (i = 0; i < vlan_num; i++) {
			...
			printk
			    ("cp i = %d , vid =%d, portmask=0x%x vlan_num=%d \n",
				       ...
				       unsigned long len, void *data)
{
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		...
		if (num != 20) {
			printk
			    ("invalid rtl_hw_vlan_support_write parameter!\n");
			return len;
		}
...
static int rtl865x_extendStormCtrlReadProc(struct seq_file *s, void *v)
{
	...
	for (i = 0; i < RTL8651_PORT_NUMBER; i++) {
		...
		if (i & 0x1) {
			...
			seq_printf(s,
				   "port%d, %s unknown unicast, counter %d\n",
				   i, regData & EUUSCS ? "enable" : "disable",
				   (regData & EPUUSC) >> EPUUSC_OFFSET);
#if 0
			seq_printf(s,
				   "port%d, %s unknown multicast, counter %d\n",
				   i, regData & EUMSCS ? "enable" : "disable",
		...
		if (!memcmp(cmd_addr, "portmask", 8)) {
			...
			for (j = 0; j < 5; j++) {
				if (portNum & (1 << j)) {
					...
					//add port to wan
					vlanconfig[1].memPort =
					    vlanconfig[1].memPort | (1 << j);
					vlanconfig[1].untagSet =
					    vlanconfig[1].untagSet | (1 << j);
				} else {
					//add port form lan
					vlanconfig[0].memPort =
					    vlanconfig[0].memPort | (1 << j);
					vlanconfig[0].untagSet =
					    vlanconfig[0].untagSet | (1 << j);
			...
			((struct dev_priv *)
			 NETDRV_PRIV(_rtl86xx_dev.dev[0]))->id =
			    vlanconfig[0].vid;
			((struct dev_priv *)NETDRV_PRIV(_rtl86xx_dev.dev[1]))->id = vlanconfig[1].vid;	//eth1
				...
				unsigned long len1, void *data)
{
	...
	if (buff && !copy_from_user(tmpbuf, buff, len1)) {
		...
		if (!memcmp(cmd_addr, "read", 4)) {
			...
			ret =
			    rtl8651_getAsicEthernetPHYReg(phyId, regId,
							  &regData);
			if (ret == SUCCESS) {
				printk
...
//                              goto errout;
		...
		else if (!memcmp(cmd_addr, "testdv", 6))	// differential voltage test
		{
			...
			printk
			    ("set PHY registers to level %d for differential voltage test.\n",
			     iNo);
		}
#endif
			...
			iNo = IOL_100_finish;
			if (!memcmp
			    (tokptr, iol_test_str[IOL_100_MDIX],
			     strlen(iol_test_str[IOL_100_MDIX])))
				iNo = IOL_100_MDIX;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_100_MDI],
				  strlen(iol_test_str[IOL_100_MDI])))
				iNo = IOL_100_MDI;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_100_finish],
				  strlen(iol_test_str[IOL_100_finish])))
				iNo = IOL_100_finish;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_10_MDIX],
				  strlen(iol_test_str[IOL_10_MDIX])))
				iNo = IOL_10_MDIX;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_10_MDI],
				  strlen(iol_test_str[IOL_10_MDI])))
				iNo = IOL_10_MDI;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_10_finish],
				  strlen(iol_test_str[IOL_10_finish])))
				iNo = IOL_10_finish;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_pktGen_allFF],
				  strlen(iol_test_str[IOL_pktGen_allFF])))
				iNo = IOL_pktGen_allFF;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_pktGen_random],
				  strlen(iol_test_str[IOL_pktGen_random])))
				iNo = IOL_pktGen_random;
			else if (!memcmp
				 (tokptr, iol_test_str[IOL_pktGen_disable],
				  strlen(iol_test_str[IOL_pktGen_disable])))
			...
			if (iNo == 1)	//test mode 1
			{
				...
				for (i = 0; i < 5; i++) {
					port =
					    rtl8651AsicEthernetTable[i].phyId;
				...
				for (i = 0; i < 5; i++)
					REG32(PCRP0 + i * 4) &= ~(EnForceMode);
				printk
				    ("Please reset the target after leaving Test Mode\n");
				ret = SUCCESS;
			}
#if 0
			...
			} else if (iNo == 3)	//test mode 3
			{
				...
				printk
				    ("PHY Test 3 Mode: No  Port{0~4} Channel{A,B,C,D}\n");
				tokptr = strsep(&strptr, " ");
				if (tokptr == NULL) {
					goto errout;
				}
					...
					int count, int *eof, void *data)
{
	...
	for (port = 0; port < RTL8651_PHY_NUMBER; port++) {
		...
		if (regData & POWER_DOWN) {
			...
			len +=
			    sprintf(page + len, "port[%d] phy is power on\n",
				    port);
		}
	}
				  ...
				  int count, int *eof, void *data)
{
	...
	for (port = PHY0; port < PHY5; port++) {
		...
		data0 = regData & PortStatusRXPAUSE;
		len +=
		    sprintf(page + len, "RXPause:%s|",
			    data0 ? "Enable" : "Disable");
		data0 = regData & PortStatusTXPAUSE;
		len +=
		    sprintf(page + len, "TXPause:%s|",
			    data0 ? "Enable" : "Disable");
		data0 = regData & PortStatusDuplex;
		len +=
		    sprintf(page + len, "Duplex:%s|",
...
static inline int rtl865x_decideMcDevice(int pid, rtl_nicRx_info * info)
{
	...
	for (i = 0; i < ETH_INTF_NUM; i++) {
		...
		if (_rtl86xx_dev.dev[i] && cp && cp->opened
		    && (cp->portmask & (1 << pid))) {
			if (strncmp
			    (cp->dev->name, igmp_proxy_wan_dev,
			     MAX_IFNAMESIZE) == 0) {
				info->priv = cp;
				return SUCCESS;
			}
...
static int rtl865x_delMultiCastNetif(void)
{
...
#if defined(CONFIG_RTK_VLAN_SUPPORT)
	{
		...
		rule.actionType_ = RTL865X_ACL_PERMIT;
		ret =
		    rtl865x_del_acl(&rule, multiCastNetIf,
...
static int rtl865x_addMultiCastNetif(void)
{
...
#if defined(CONFIG_RTL_MAC_BASED_NETIF)
	ret =
	    rtl865x_addVlanPortMember(MULTICAST_NETIF_VLAN_ID,
				      RTL_WANPORT_MASK);
	ret =
	    rtl865x_setVlanFilterDatabase(MULTICAST_NETIF_VLAN_ID, RTL_WAN_FID);
#else
	ret =
	    rtl865x_addVlanPortMember(MULTICAST_NETIF_VLAN_ID,
				      rtl_multiWan_config.memPort);
	ret =
	    rtl865x_setVlanFilterDatabase(MULTICAST_NETIF_VLAN_ID,
					  rtl_multiWan_config.fid);
#endif
	if (_rtl865x_getNetifByName(multiCastNetIf) != NULL) {
		return SUCCESS;
...
#if 1				//defined(CONFIG_RTK_VLAN_SUPPORT)
	{
		...
		rule.actionType_ = RTL865X_ACL_PERMIT;
		ret =
		    rtl865x_add_acl(&rule, multiCastNetIf,
				    RTL865X_ACL_SYSTEM_USED);
	}
#endif
					...
					int count, int *eof, void *data)
{
	...
	len +=
	    sprintf(page + len, "Igmp proxy wan dev name is %s.\n",
		    igmp_proxy_wan_dev);
...
static int rtl_check_swCore_tx_hang_read_proc(struct seq_file *s, void *v)
{
	seq_printf(s,
		   ...
		   rtl_reinit_swCore_threshold, rtl_reinit_swCore_counter);
					       ...
					       unsigned long count, void *data)
{
	...
	if (buffer && !copy_from_user(tmpBuf, buffer, count)) {
		int num =
		    sscanf(tmpBuf, "%d %d", &rtl_check_swCore_tx_hang_interval,
				  ...
				  unsigned change, unsigned int status)
{
	...
	err =
	    ethernet_rtnl_fill_ifinfo(skb, dev, type, 0, 0, change, 0, status);
	if (err < 0) {
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		...
		if (!memcmp(cmd_addr, "port", 4)) {
			...
			if (!memcmp(tokptr, "10H", 3)) {
				...
				mode =
				    NwayAbility10MH | NwayAbility10MF |
...
static int tr181_eth_link_read(struct seq_file *s, void *v)
{
	...
	for (i = 0; i < NUMOFLINKENTRY; i++) {
		...
		if (((struct dev_priv *)
		     NETDRV_PRIV(_rtl86xx_dev.dev[i]))->opened)
			       ...
			       int *eof, void *data)
{
	...
	for (i = 0; i < NUMOFLINKENTRY; i++) {
		...
		if (((struct dev_priv *)
		     NETDRV_PRIV(_rtl86xx_dev.dev[i]))->opened)
			len +=
			    sprintf(page + len, "eth%d: %s %s ", i, "true",
				    "Up");
		else
			len +=
			    sprintf(page + len, "eth%d: %s %s ", i, "false",
				    "Down");

		len +=
		    sprintf(page + len, "%s %d ", _rtl86xx_dev.dev[i]->name,
			    get_uptime_by_sec() - if_change_time[i]);

		for (j = 0; j < 5; j++)
			len +=
			    sprintf(page + len, "%02x:",
				    _rtl86xx_dev.dev[i]->dev_addr[j]);
...
static int tr181_eth_if_read(struct seq_file *s, void *v)
{
	...
	for (i = 0; i < (NUMOFIFENTRY + 3); i++) {
		...
		seq_printf(s, "%d ",
			   (speed ==
			    PortStatusLinkSpeed1000M) ? 1000 : (speed ==
								PortStatusLinkSpeed100M)
			   ? 100 : 10);
		seq_printf(s, "%s\n", (duplex) ? "Full" : "Half");
	}
#else
			     ...
			     int *eof, void *data)
{
	...
	for (i = 0; i < (NUMOFIFENTRY + 3); i++) {
		...
		if (status == 0)
			len +=
			    sprintf(page + len, "port%d: %s %s ", i, "false",
				    "Down");
		else
			len +=
			    sprintf(page + len, "port%d: %s %s ", i, "true",
				    "Up");
...
static int tr181_eth_stats_read(struct seq_file *s, void *v)
{
	...
	if ((_rtl86xx_dev.dev[0]) && NETDRV_PRIV(_rtl86xx_dev.dev[0]))
		eth0_portmask = ((struct dev_priv *)
				 NETDRV_PRIV(_rtl86xx_dev.dev[0]))->portmask;

	if ((_rtl86xx_dev.dev[1]) && NETDRV_PRIV(_rtl86xx_dev.dev[1]))
		eth1_portmask = ((struct dev_priv *)
				 NETDRV_PRIV(_rtl86xx_dev.dev[1]))->portmask;
				...
				int *eof, void *data)
{
	...
	// refer to net/core/dev.c dev_seq_show() and dev_seq_printf_stats()
	len +=
	    sprintf(page + len, "%s%s",
		    "Inter-|   Receive                            ",
		    "                    |  Transmit\n");
	len +=
	    sprintf(page + len, "%s%s%s",
		    " face |bytes    packets errs drop fifo frame ",
		    "compressed multicast|bytes    packets errs ",
		    "drop fifo colls carrier compressed");

	len +=
	    sprintf(page + len, "%s", "  rx_uc  rx_bc  tx_uc  tx_mc  tx_bc\n");
...
#endif
	{
		...
		len +=
		    sprintf(page + len, "port%d: %llu %u %u %u  0  0  0  %u  ",
			    i, port_cntrs.ifInOctets,
			    port_cntrs.ifInUcastPkts +
			    port_cntrs.etherStatsMcastPkts +
			    port_cntrs.etherStatsBcastPkts,
			    port_cntrs.dot3StatsFCSErrors +
...
int tr181_get_eth_if(int if_link_num, tr181_eth_interface * pIf)
{
...
#if defined(CONFIG_RTL_8367R_SUPPORT)
	{
		...
		if ((rtk_port_phyStatus_get
		     (if_link_num, &status, &speed, &duplex)) == 0) {
...
int tr181_get_eth_if_stats(int if_link_num, tr181_eth_if_stats * pStats)
{
	...
	pStats->ErrorsReceived =
	    port_cntrs.dot3StatsFCSErrors + port_cntrs.dot3StatsSymbolErrors;
	...
	pStats->PacketsReceived =
	    pStats->UnicastPacketsReceived + pStats->MulticastPacketsReceived +
...
int tr181_get_eth_link(int if_link_num, tr181_eth_link * pLink)
{
	...
	pLink->Enable = ((struct dev_priv *)
			 NETDRV_PRIV(_rtl86xx_dev.dev[if_link_num]))->opened;
...
int tr181_get_eth_link_stats(int if_link_num, tr181_eth_if_stats * pStats)
{
	...
	portmask = ((struct dev_priv *)
		    NETDRV_PRIV(_rtl86xx_dev.dev[if_link_num]))->portmask;
	...
	for (i = 0; i < 5; i++) {
		...
		if (portmask & (1 << i)) {
			...
			pStats->MulticastPacketsSent +=
			    rtl8651_returnAsicCounter
			    (OFFSET_IFOUTMULTICASTPKTS_P0 + addrOffset_fromP0);
			pStats->MulticastPacketsReceived +=
			    rtl8651_returnAsicCounter
			...
			pStats->BroadcastPacketsSent +=
			    rtl8651_returnAsicCounter
			    (OFFSET_IFOUTBROADCASTPKTS_P0 + addrOffset_fromP0);
			pStats->BroadcastPacketsReceived +=
			    rtl8651_returnAsicCounter
			       ...
			       int *eof, void *data)
{
	int len;
	len =
	    sprintf(page, "Inband Control Ethternet Type : 0x%x\n",
		    inband_ctl_acl_ethernet_type);
	return len;
}
#endif
...
int rtk_dev_name_netif_mapping(char *br_name, char *br_port_name, int flag)
{
	...
	case 2:
		for (i = 0; i < NETIF_NUMBER; i++) {
			//find it, clear 
			if (!memcmp
			    (netif_name_mapping[i].netif_Name, br_port_name,
			     MAX_IFNAMESIZE)) {
...
int rtk_get_devname_by_netifname(char *dev_name, char *netif_name)
{
	...
	for (i = 0; i < NETIF_NUMBER; i++) {
		if ((!memcmp
		     (netif_name_mapping[i].netif_Name, netif_name,
		      MAX_IFNAMESIZE))) {
...
int rtk_get_netif_name_by_devname(char *dev_name, char *netif_name)
{
	...
	for (i = 0; i < NETIF_NUMBER; i++) {
		if ((!memcmp
		     (netif_name_mapping[i].dev_name, dev_name,
		      MAX_IFNAMESIZE))) {
...
uint32 inline rtk_get_vlan_tagmask(uint16 vid)
{
	...
	mask =
	    (vlan_ctl_p->group[vid].memberMask) & (vlan_ctl_p->
						   group[vid].tagMemberMask);
	return mask;
}
	...
	*pskb1 = NULL;
					...
					if (!
						...
						*pskb1 =
						...
						rtk_insert_vlan_tag(pvid,
								    *pskb1);
						*(uint16
						  *) ((*pskb1)->linux_vlan_src_tag)
						    =
						    __constant_htons
						    (ETH_P_8021Q);
						*(uint16
						  *) ((*pskb1)->linux_vlan_src_tag + 2) = __constant_htons(pvid);
	...
	if (rtl865x_curOpMode == GATEWAY_MODE) {
		...
		*(uint16 *) (skb->linux_vlan_src_tag) =
		    __constant_htons(ETH_P_8021Q);
		*(uint16 *) (skb->linux_vlan_src_tag + 2) =
		    __constant_htons(vid);
	}
...
static void rtk_update_netif_vlan(int netif_idx, uint16 vid, uint32 portmask)
{
	...
	((struct dev_priv *)NETDRV_PRIV(_rtl86xx_dev.dev[netif_idx]))->portmask
	    = portmask;
	...
	if (rtl865x_curOpMode == GATEWAY_MODE) {
		...
		if ((portmask & RTK_WAN_PORT_MASK) == RTK_WAN_PORT_MASK) {
			...
			if (vid == rtk_vlan_wan_vid)	// if it is nat wan vlan , need to update netif table ,mark_vc
			{
				...
				if (portmask &
				    (~(RTK_WAN_PORT_MASK | RTK_CPU_PORT_MASK)))
				{
				...
				unsigned long len, void *data)
{
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		num =
		    sscanf(tmpbuf, "%d %d %x %x", &index, &vid, &mask,
			   &tagMask);
...
#endif
{
...
#if 0
	printk
	    ("%s:%d,srcPort is %d,srcVlanId is %d,srcIpAddr is 0x%x,destIpAddr is 0x%x\n",
	...
	ret =
	    rtl_getMulticastDataFwdInfo(nicIgmpModuleIndex, &multicastDataInfo,
					&multicastFwdInfo);
...
static struct rtl819x_mib_counter rtl819x_mib_counters[] = {
	...
	{0, OFFSET_ETHERSTATSPKTS65TO127OCTETS_P0, 4,
	 STAT_EtherStatsPkts65to127Octets, "EtherStatsPkts65to127Octets"},
	{0, OFFSET_ETHERSTATSPKTS128TO255OCTETS_P0, 4,
	 STAT_EtherStatsPkts128to255Octets, "EtherStatsPkts128to255Octets"},
	{0, OFFSET_ETHERSTATSPKTS256TO511OCTETS_P0, 4,
	 STAT_EtherStatsPkts256to511Octets, "EtherStatsPkts256to511Octets"},
	{0, OFFSET_ETHERSTATSPKTS512TO1023OCTETS_P0, 4,
	 STAT_EtherStatsPkts512to1023Octets, "EtherStatsPkts512to1023Octets"},
	{0, OFFSET_ETHERSTATSPKTS1024TO1518OCTETS_P0, 4,
	 STAT_EtherStatsPkts1024to1518Octets, "EtherStatsPkts1024to1518Octets"},
	...
	{0, OFFSET_DOT3CONTROLINUNKNOWNOPCODES_P0, 4,
	 STAT_Dot3ControlInUnknownOpcodes, "Dot3ControlInUnknownOpcodes"},
	//out
	{0, OFFSET_IFOUTOCTETS_P0, 8, STAT_IfOutOctets, "IfOutOctets"},
	{0, OFFSET_DOT3STATSSINGLECOLLISIONFRAMES_P0, 4,
	 STAT_Dot3StatsSingleCollisionFrames, "Dot3StatsSingleCollisionFrames"},
	...
	{0, OFFSET_DOT3STATSDEFERREDTRANSMISSIONS_P0, 4,
	 STAT_Dot3StatsDeferredTransmissions, "Dot3sDeferredTransmissions"},
...
static inline unsigned int to_swconfig_portmask(unsigned int portmask)
{
	...
	if ((portmask & BIT(RTL819X_HW_PORT_NUM_CPU)) ==
		...
		mask =
		    ((mask) & (~(BIT(RTL819X_HW_PORT_NUM_CPU)))) |
...
static int32 rtl_process_hw_netif(uint16 vid)
{
	...
	if (vid == hw_nat_lan_vid) {
		...
		if (rtl865x_getNetifVid(RTL_DRV_LAN_NETIF_NAME, &netif_vid) ==
		    SUCCESS) {
		...
		for (i = 0; vlanconfig[i].vid != 0; i++) {
			...
			if (strncmp(vlanconfig[i].ifname, "ppp", 3)) {
				...
				memcpy(netif.name, vlanconfig[i].ifname,
				       MAX_IFNAMESIZE);
				memcpy(netif.macAddr.octet,
				       vlanconfig[i].mac.octet, ETHER_ADDR_LEN);
			}
...
int rtl_get_bind_port_mask_by_dev_name(char *name)
{
	...
	for (i = 0; i < LAN_DEV_NUM_MAX; i++) {
		if (strncmp
		    (name, lan_dev_bind_mask_mapping_drv[i].ifname,
		     IFNAMSIZ) == 0) {
...
static int _rtl_update_vlan_table(int vlan_id)
{
	...
	if (_the_num_of_this_vid_WAN > 0) {
		...
		if (ret == SUCCESS) {
			...
			if (rtl865x_setVlanFilterDatabase(vlan_id, RTL_WAN_FID)
			    != SUCCESS) {
				printk("Leave %s @ %d \n", __FUNCTION__,
				       __LINE__);
				return FAILED;
		...
		if (rtl865x_modVlanPortMember(vlan_id, memPort, untagSet) !=
		    SUCCESS) {
			printk("Leave %s @ %d \n", __FUNCTION__, __LINE__);
			return FAILED;
		}
...
int rtl_set_wanport_vlanconfig(char *ifname, int proto, int vid, int napt)
{
	...
	if ((proto == SMUX_PROTO_BRIDGE) && (vid != -1)) {
		...
		if (rtl865x_add_acl
		    (&rule, netif.name, RTL865X_ACL_ICBUG_PATCH, 1,
		     1) != SUCCESS) {
			//printk("Leave %s @ %d \n", __FUNCTION__, __LINE__);
			return FAILED;
		}
				...
				int count, int *eof, void *data)
{
	...
	len =
	    sprintf(page, "vlan=%d, tag=%d, vid=%d, priority=%d, cfi=%d\n",
...
#if 0
		printk
		    ("===%s(%d), global_vlan(%d),is_lan(%d),vlan(%d),tag(%d),id(%d),pri(%d),cfi(%d)",
		     __FUNCTION__, __LINE__, PPPOE_vlanInfo.global_vlan,
		     PPPOE_vlanInfo.is_lan, PPPOE_vlanInfo.vlan,
		     PPPOE_vlanInfo.tag, PPPOE_vlanInfo.id, PPPOE_vlanInfo.pri,
		     PPPOE_vlanInfo.cfi);
#endif
	}
			    ...
			    int32 hash_sel)
{
	...
	if (src_mac) {
		...
		sid0h =
		    ((src_mac[5] >> 7) ^ (src_mac[5] >> 5) ^ (src_mac[5] >> 3) ^
		     (src_mac[5] >> 1) ^ (src_mac[4] >> 7) ^ (src_mac[4] >> 5) ^
		     (src_mac[4] >> 3) ^ (src_mac[4] >> 1) ^ (src_mac[3] >> 7) ^
		     (src_mac[3] >> 5) ^ (src_mac[3] >> 3) ^ (src_mac[3] >> 1) ^
		     (src_mac[2] >> 7) ^ (src_mac[2] >> 5) ^ (src_mac[2] >> 3) ^
		     (src_mac[2] >> 1) ^ (src_mac[1] >> 7) ^ (src_mac[1] >> 5) ^
		     (src_mac[1] >> 3) ^ (src_mac[1] >> 1) ^ (src_mac[0] >> 7) ^
		     (src_mac[0] >> 5) ^ (src_mac[0] >> 3) ^ (src_mac[0] >> 1)
		    ) & 0x01;
		sid1h =
		    ((src_mac[5] >> 6) ^ (src_mac[5] >> 4) ^ (src_mac[5] >> 2) ^
		     (src_mac[5]) ^ (src_mac[4] >> 6) ^ (src_mac[4] >> 4) ^
		     (src_mac[4] >> 2) ^ (src_mac[4]) ^ (src_mac[3] >> 6) ^
		     (src_mac[3] >> 4) ^ (src_mac[3] >> 2) ^ (src_mac[3]) ^
		     (src_mac[2] >> 6) ^ (src_mac[2] >> 4) ^ (src_mac[2] >> 2) ^
		     (src_mac[2]) ^ (src_mac[1] >> 6) ^ (src_mac[1] >> 4) ^
		     (src_mac[1] >> 2) ^ (src_mac[1]) ^ (src_mac[0] >> 6) ^
		     (src_mac[0] >> 4) ^ (src_mac[0] >> 2) ^ (src_mac[0])
		    ) & 0x01;
		sidmah =
		    ((src_mac[5] >> 4) ^ (src_mac[5] >> 3) ^ (src_mac[5] >> 2) ^
	...
	if (dst_mac) {
		...
		did0h =
		    ((dst_mac[5] >> 7) ^ (dst_mac[5] >> 5) ^ (dst_mac[5] >> 3) ^
		     (dst_mac[5] >> 1) ^ (dst_mac[4] >> 7) ^ (dst_mac[4] >> 5) ^
		     (dst_mac[4] >> 3) ^ (dst_mac[4] >> 1) ^ (dst_mac[3] >> 7) ^
		     (dst_mac[3] >> 5) ^ (dst_mac[3] >> 3) ^ (dst_mac[3] >> 1) ^
		     (dst_mac[2] >> 7) ^ (dst_mac[2] >> 5) ^ (dst_mac[2] >> 3) ^
		     (dst_mac[2] >> 1) ^ (dst_mac[1] >> 7) ^ (dst_mac[1] >> 5) ^
		     (dst_mac[1] >> 3) ^ (dst_mac[1] >> 1) ^ (dst_mac[0] >> 7) ^
		     (dst_mac[0] >> 5) ^ (dst_mac[0] >> 3) ^ (dst_mac[0] >> 1)
		    ) & 0x01;

		did1h =
		    ((dst_mac[5] >> 6) ^ (dst_mac[5] >> 4) ^ (dst_mac[5] >> 2) ^
		     (dst_mac[5]) ^ (dst_mac[4] >> 6) ^ (dst_mac[4] >> 4) ^
		     (dst_mac[4] >> 2) ^ (dst_mac[4]) ^ (dst_mac[3] >> 6) ^
		     (dst_mac[3] >> 4) ^ (dst_mac[3] >> 2) ^ (dst_mac[3]) ^
		     (dst_mac[2] >> 6) ^ (dst_mac[2] >> 4) ^ (dst_mac[2] >> 2) ^
		     (dst_mac[2]) ^ (dst_mac[1] >> 6) ^ (dst_mac[1] >> 4) ^
		     (dst_mac[1] >> 2) ^ (dst_mac[1]) ^ (dst_mac[0] >> 6) ^
		     (dst_mac[0] >> 4) ^ (dst_mac[0] >> 2) ^ (dst_mac[0])
		    ) & 0x01;
		didmah =
		    ((dst_mac[5] >> 4) ^ (dst_mac[5] >> 3) ^ (dst_mac[5] >> 2) ^
		...
		didmbh =
		    ((dst_mac[5] >> 7) ^ (dst_mac[5] >> 6) ^ (dst_mac[5] >> 5) ^
		...
		if (hash_sel == LINK_TRUNK_HASH_TYPE_SA) {
			...
			for (i = 0; i < ETH_INTF_NUM; i++) {
				...
				if (_rtl86xx_dev.dev[i] && cp && cp->opened
				    &&
				    !(memcmp
				      (cp->dev->name, RTL_DRV_WAN0_NETIF_NAME,
				       strlen(RTL_DRV_WAN0_NETIF_NAME)))) {
					ret =
					    rtl_lag_hash_function(cp->
								  dev->dev_addr,
								  NULL, &hash1,
								  hash_sel);
					if (ret == SUCCESS) {
...
#endif
{
	...
	len +=
	    sprintf(page + len, "Port mask for the aggregator: 0x%x \n",
		    trunk_mask);
	if (hash_sel == LINK_TRUNK_HASH_TYPE_DA_SA)
		len +=
		    sprintf(page + len,
		...
		len +=
		    sprintf(page + len, "Trunk Hash algorithm selection: DA\n");
	else if (hash_sel == LINK_TRUNK_HASH_TYPE_SA)
		len +=
		    sprintf(page + len, "Trunk Hash algorithm selection: SA\n");
	else
		len +=
		    sprintf(page + len,
	...
	for (i = 0; i <= LINK_TRUNK_HASH_MAX_INDEX; i++) {
		...
		rtl8651_getLAHashIndexToPortMapping(i, &port_num);
		len +=
		    sprintf(page + len, "Hash Index %d Physical port %u\n", i,
			    port_num);
	}
				    ...
				    unsigned long len, void *data)
{
	...
	if (buff && !copy_from_user(tmpbuf, buff, len)) {
		...
		if (!memcmp(cmd_addr, "trunkmask", strlen("trunkmask"))) {
		    ...
		    if (!memcmp(cmd_addr, "hashselect", strlen("hashselect"))) {
		    ...
		    if (!memcmp(cmd_addr, "hashmapping", strlen("hashmapping")))
		{
		    ...
		    if (!memcmp
			(cmd_addr, "hashcalculate", strlen("hashcalculate"))) {
			tokptr = strsep(&strptr, " ");
			if (tokptr == NULL) {
				goto errout;
			}
...
errout:
		...
		printk
		    ("echo \"hashcalculate $hash_type $sa/$da/$sa $da\" >/proc/link_aggregation\n");
		printk
		    ("$trunk_mask and $hash_sel are specified in hexadecimal format pattern\n");
		printk
		    ("$hash_index and $phy_port are specified in decimal format pattern\n");
	}
...
inline void rtl865x_disableRunoutIrq(void)
{
	...
	REG32(CPUIIMR) =
	    REG32(CPUIIMR) &
	    (~(PKTHDR_DESC_RUNOUT_IP_ALL | MBUF_DESC_RUNOUT_IP_ALL));
	return;
}
