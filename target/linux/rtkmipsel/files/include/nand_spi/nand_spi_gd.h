...
void gd_pio_read_data(void *ram_addr, u32_t wr_bytes, u32_t blk_pge_addr,
		       u32_t col_addr);
void gd_pio_write_data(void *ram_addr, u32_t wr_bytes, u32_t blk_pge_addr,
			u32_t col_addr);
...
void gd_2KB_chunk_write_with_ecc_encode(void *dma_addr, u32_t blk_pge_addr,
					void *p_eccbuf);
int gd_2KB_chunk_read_with_ecc_decode(void *dma_addr, u32_t blk_pge_addr,
				       void *p_eccbuf);
