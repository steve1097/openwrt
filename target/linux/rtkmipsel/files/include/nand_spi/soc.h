...
typedef int (nor_spi_write) (u32_t cid, u32_t offset, u32_t len,
			     const void *buf);
...
typedef void (nand_spi_dma_read_write_t) (void *dma_addr, u32_t dma_len,
					  u32_t blk_pge_addr);
typedef void (nand_spi_pio_write_read_t) (void *addr, u32_t wr_bytes,
					  u32_t blk_pge_addr, u32_t col_addr);
typedef int (nand_spi_chunk_read_ecc_t) (void *dma_addr, u32_t blk_pge_addr,
					 void *p_eccbuf);
typedef void (nand_spi_chunk_write_ecc_t) (void *dma_addr, u32_t blk_pge_addr,
					   void *p_eccbuf);
...
const symbol_table_entry_t *symb_retrive(u32_t key,
