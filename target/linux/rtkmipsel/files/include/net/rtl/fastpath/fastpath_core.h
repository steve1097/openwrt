...
unsigned long get_pppoe_last_rx_tx(char *ppp_dev, char *wan_dev,
...
#endif
enum LR_RESULT rtk_addArp(ipaddr_t ip, ether_addr_t * mac,
...
void rtl_skb_policy_route_mark_set(struct sk_buff *skb,
				   unsigned int policy_route_mark,
				   unsigned int *mark_bak);
