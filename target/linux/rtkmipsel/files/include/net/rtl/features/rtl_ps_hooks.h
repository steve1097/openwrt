...
#endif	/*  */
    int32 rtl_fn_hash_replace_hooks(struct fib_table *tb,
...
#endif	/*  */
    int32 rtl_dev_queue_xmit_hooks(struct sk_buff *skb,
				    struct net_device *dev);
int32 rtl_dev_hard_start_xmit_hooks(struct sk_buff *skb, struct net_device *dev,
...
int32 rtl_neigh_flush_dev_hooks(struct neigh_table *tbl, struct net_device *dev,
				struct neighbour *n);
...
int32 rtl_neigh_update_post_hooks(struct neighbour *n, const u8 * lladdr,
				  uint8 old);
