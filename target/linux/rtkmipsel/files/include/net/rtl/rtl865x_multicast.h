...
typedef MC_LIST_HEAD(mcast_fwd_descriptor_head_s,
		     rtl865x_mcast_fwd_descriptor_s)
    mcast_fwd_descriptor_head_t;
...
struct rtl865x_multicastTable {
	...
	struct freeList_s {
		...
		TAILQ_HEAD(_FreeMultiCastEntry,
			   rtl865x_tblDrv_mCast_s) freeMultiCast;
	} freeList;
...
rtl865x_tblDrv_mCast_t *rtl865x_findMCastEntry(unsigned int mAddr,
					       unsigned int sip,
					       unsigned short svid,
					       unsigned short sport);
#if defined CONFIG_RTL_MULTICAST_PORT_MAPPING
int rtl865x_addMulticastEntry(unsigned int mAddr, unsigned int sip,
			      unsigned short svid, unsigned short sport,
			      rtl865x_mcast_fwd_descriptor_t * newFwdDescChain,
			      int flushOldChain, unsigned int extIp,
			      char cpuHold, unsigned char flag,
...
#if defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8197F)
typedef MC_LIST_HEAD(mcast_fwd_descriptor_head6_s,
		     rtl8198c_mcast_fwd_descriptor6_s)
    mcast_fwd_descriptor_head6_t;
...
struct rtl8198c_multicastv6Table {
	struct freeList6_s {
		...
		TAILQ_HEAD(_FreeMultiCastEntry6,
			   rtl8198c_tblDrv_mCastv6_s) freeMultiCast;
	} freeList;
...
int rtl8198C_addMulticastv6Entry(inv6_addr_t dip, inv6_addr_t sip,
				 unsigned short svid, unsigned short sport,
				 rtl8198c_mcast_fwd_descriptor6_t *
				 newFwdDescChain, int flushOldChain,
				 unsigned int extIp, char cpuHold,
				 unsigned char flag, unsigned int mapPortMask);
#else
int rtl8198C_addMulticastv6Entry(inv6_addr_t dip, inv6_addr_t sip,
				 unsigned short svid, unsigned short sport,
				 rtl8198c_mcast_fwd_descriptor6_t *
